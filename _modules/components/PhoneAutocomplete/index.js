...
var PhoneAutocompleteUI = function PhoneAutocompleteUI(props) {
  var _userState$result, _userState$result2, _userState$result3, _userState$result4;
  ...
  }, /*#__PURE__*/_react.default.createElement(_styles.UserEdit, null, (userState === null || userState === void 0 ? void 0 : (_userState$result = userState.result) === null || _userState$result === void 0 ? void 0 : _userState$result.id) && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_UserDetails.UserDetails, {
    userData: (user === null || user === void 0 ? void 0 : user.id) === (userState === null || userState === void 0 ? void 0 : (_userState$result2 = userState.result) === null || _userState$result2 === void 0 ? void 0 : _userState$result2.id) ? user : userState === null || userState === void 0 ? void 0 : userState.result,
    externalLoading: userState === null || userState === void 0 ? void 0 : userState.loading,
    userId: parseInt(userState === null || userState === void 0 ? void 0 : (_userState$result3 = userState.result) === null || _userState$result3 === void 0 ? void 0 : _userState$result3.id)
  }), !(userState !== null && userState !== void 0 && userState.loading) && /*#__PURE__*/_react.default.createElement(_AddressList.AddressList, {
    userId: userState === null || userState === void 0 ? void 0 : (_userState$result4 = userState.result) === null || _userState$result4 === void 0 ? void 0 : _userState$result4.id,
    isModal: true
