...
var SidebarMenu = function SidebarMenu(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.Container, {
    ...
    onClick: function onClick() {
      ...
      return handleGoToPage({
        page: (options === null || options === void 0 ? void 0 : (_options$address = options.address) === null || _options$address === void 0 ? void 0 : _options$address.location) ? 'search' : 'home'
      });
    }
  ...
  }, (options === null || options === void 0 ? void 0 : (_options$address2 = options.address) === null || _options$address2 === void 0 ? void 0 : _options$address2.location) ? /*#__PURE__*/_react.default.createElement(_BiStore.default, null) : /*#__PURE__*/_react.default.createElement(_AiOutlineHome.default, null)), /*#__PURE__*/_react.default.createElement(_styles.MenuLinkText, null, /*#__PURE__*/_react.default.createElement(_styles.TextInfo, {
    isHome: isHome,
    active: window.location.pathname === '/' || window.location.pathname === '/home' || window.location.pathname === '/search'
  }, (options === null || options === void 0 ? void 0 : (_options$address3 = options.address) === null || _options$address3 === void 0 ? void 0 : _options$address3.location) ? t('BUSINESSES', 'Businesses') : t('HOME', 'Home'))), /*#__PURE__*/_react.default.createElement(_styles.MenuLinkSeparator, null, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("hr", null))))), auth && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles.MenuLink, {
    isHome: isHome,
    onClick: function onClick() {
      return handleGoToPage({
        page: 'profile'
    ...
    isHome: isHome,
    active: window.location.pathname === '/signin' || window.location.pathname === '/login'
  }, t('SIGNIN', 'Sign in'))), /*#__PURE__*/_react.default.createElement(_styles.MenuLinkSeparator, null, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("hr", null))))), /*#__PURE__*/_react.default.createElement(_styles.MenuLink, {
    isHome: isHome,
    onClick: function onClick() {
      return handleGoToPage({
        page: 'signup'
    ...
    isHome: isHome,
    active: window.location.pathname === '/signup'
  }, t('SIGNUP', 'Sign up'))), /*#__PURE__*/_react.default.createElement(_styles.MenuLinkSeparator, null, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("hr", null))))))));
};
