...
var Container = _styledComponents.default.div(_templateObject(), function (_ref) {
  var auth = _ref.auth;
  return auth && (0, _styledComponents.css)(_templateObject2());
}, function (_ref2) {
  var auth = _ref2.auth;
  return !auth && (0, _styledComponents.css)(_templateObject3());
});

exports.Container = Container;

var IconContent = _styledComponents.default.button(_templateObject4(), function (_ref3) {
...
var MenuClose = _styledComponents.default.button(_templateObject8(), function (_ref8) {
...
var WrappContent = _styledComponents.default.div(_templateObject10());

exports.WrappContent = WrappContent;

var MenuLinkIcon = _styledComponents.default.div(_templateObject11(), function (_ref12) {
...
var MenuLinkText = _styledComponents.default.div(_templateObject12());

exports.MenuLinkText = MenuLinkText;

var TextInfo = _styledComponents.default.span(_templateObject13(), function (_ref13) {
  ...
  return ((_props$theme2 = props.theme) === null || _props$theme2 === void 0 ? void 0 : _props$theme2.rtl) && (0, _styledComponents.css)(_templateObject14());
});
