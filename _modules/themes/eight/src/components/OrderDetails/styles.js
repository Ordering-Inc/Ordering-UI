...
var WrapRightContainer = exports.WrapRightContainer = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  padding: 30px 20px;\n  box-sizing: border-box;\n\n  @media (min-width: 1024px) {\n    padding: 30px 0px;\n    width: 50%;\n  }\n"])), function (props) {
  return props.theme.colors.secundaryLight;
});
var Header = exports.Header = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 100%;\n  position: relative;\n  margin-bottom: 40px;\n  margin-top: 10px;\n\n  > button {\n    background: transparent;\n  }\n"])));
var HeaderText = exports.HeaderText = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  color: ", ";\n\n  ", ";\n  ", ";\n\n  h1 {\n    margin: 0;\n    font-size: 24px;\n  }\n\n  p {\n    font-size: 14px;\n  }\n\n  @media (min-width: 768px) {\n    p {\n      font-size: 18px;\n    }\n\n    h1 {\n      font-size: 32px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.grayDark;
}, function (_ref) {
  ...
  return !column && (0, _styledComponents.css)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n    justify-content: space-between;\n    align-items: center;\n  "])));
});
var OrderBusiness = exports.OrderBusiness = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  opacity: 1;\n  margin-bottom: 20px;\n  padding-bottom: 35px;\n  border-bottom: 8px solid #F8F9FA;\n"])));
var BusinessWrapper = exports.BusinessWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  width: 90%;\n  display: flex;\n"])));
...
var SectionTitle = exports.SectionTitle = _styledComponents.default.h1(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  margin: 0px;\n  font-size: 20px;\n  font-weight: 500;\n  color: ", ";\n  text-transform: capitalize;\n"])), function (props) {
  return props.theme.colors.grayDark;
});
var OrderCustomer = exports.OrderCustomer = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  display: flex;\n  margin: 0px 0px 20px;\n  width: 100%;\n  padding-bottom: 35px;\n  border-bottom: 8px solid #F8F9FA;\n"])));
...
var WrapDriverInfo = exports.WrapDriverInfo = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  border-top: 8px solid ", ";\n  padding-top: 20px;\n"])), function (props) {
  return props.theme.colors.gray;
});
var OrderDriver = exports.OrderDriver = (0, _styledComponents.default)(OrderCustomer)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  justify-content: space-between;\n  align-items: center;\n  border-bottom: none;\n  padding-bottom: 0px;\n"])));
...
var OrderProducts = exports.OrderProducts = (0, _styledComponents.default)(OrderCustomer)(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  flex-direction: column;\n  border-bottom: none;\n  padding-bottom: 0px;\n  > div {\n    background: transparent;\n    border-bottom: none;\n  }\n"])));
var OrderBill = exports.OrderBill = _styledComponents.default.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  border-top: 1px solid ", ";\n  padding-top: 5px;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  table {\n    width: 100%;\n    font-size: 12px;\n    color: ", ";\n    td span {\n      unicode-bidi: bidi-override;\n    }\n    tr td:nth-child(2) {\n      text-align: right;\n      ", "\n    }\n  }\n\n  table.total {\n    border-top: 1px solid ", ";\n    margin-top: 15px;\n    tr {\n      font-size: 20px;\n      td:nth-child(1) {\n        font-weight: bold;\n        padding-top: 10px;\n      }\n      td:nth-child(2) {\n        font-weight: bold;\n        padding-top: 10px;\n      }\n    }\n  }\n\n  @media (min-width: 678px) {\n    table {\n      font-size: 18px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.gray;
}, function (props) {
  return props.theme.colors.grayDark;
}, function (props) {
...
var ReviewsAction = exports.ReviewsAction = _styledComponents.default.div(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  width: fit-content;\n  margin: 5px 0px;\n  cursor: pointer;\n  color: ", ";\n  opacity: 0.6;\n  text-decoration: underline;\n\n  &:hover {\n    opacity: 1;\n  }\n"])), function (props) {
  return props.theme.colors.dark;
});
var ShareOrder = exports.ShareOrder = _styledComponents.default.div(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["\n  display: flex;\n  margin: 0px;\n  justify-content: space-between;\n  z-index: 1;\n  padding-bottom: 35px;\n\n  h1 {\n    font-size: 20px;\n    margin: 0px;\n    color: ", ";\n    font-weight: 500;\n  }\n\n  p {\n    font-size: 13px;\n    margin: 0px;\n  }\n\n  button {\n    display: flex;\n    justify-content: center;\n    position: relative;\n    font-size: 14px;\n    align-items: center;\n    background: ", ";\n\n    svg {\n      left: 0;\n      margin-right: 6px;\n      color: ", ";\n    }\n\n    &:hover {\n      svg {\n        color: #FFFFFF;\n      }\n    }\n  }\n\n  div.text {\n    width: 60%;\n  }\n\n  div.wrap {\n    z-index: 1;\n    display: flex;\n    align-items: center;\n\n    & > div:first-child {\n      width: 100%;\n      position: relative;\n      div {\n        right: 0px;\n        left: initial;\n        top: 35px;\n      }\n    }\n  }\n\n  @media (min-width: 1201px) {\n    div.wrap {\n      & > div:first-child {\n        left: 0;\n      }\n    }\n  }\n\n  @media (min-width: 768px) {\n    div.wrap {\n      width: 30%;\n    }\n\n    h1 {\n      font-size: 20px;\n    }\n\n    p {\n      font-size: 18px;\n    }\n\n    button {\n      font-size: 18px;\n      width: 100%;\n      svg {\n        position: absolute;\n        margin-left: 10px;\n      }\n    }\n  }\n\n  @media (min-width: 425px) {\n    div.text {\n      width: 70%;\n    }\n\n    h1 {\n      font-size: 18px;\n    }\n\n    p {\n      font-size: 15px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.grayDark;
}, function (props) {
...
var MessagesIcon = exports.MessagesIcon = _styledComponents.default.span(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral(["\n  position: relative;\n  cursor: pointer;\n"])));
var ExclamationWrapper = exports.ExclamationWrapper = _styledComponents.default.div(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["\n  position: absolute;\n  transform: translate(75%, -25%);\n  svg{\n    font-size: 16px;\n    color: ", "\n  }\n"])), function (props) {
  var _props$theme6;
