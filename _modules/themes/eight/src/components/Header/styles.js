...
var InnerHeader = exports.InnerHeader = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  justify-content: space-between;\n  width: 98%;\n  margin: 12px auto;\n"])));
...
var VerticalBorderLine = exports.VerticalBorderLine = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  width: 1px;\n  height: 30px;\n  background-color: ", ";\n"])), function (props) {
  return props.theme.colors.grayMedium;
});
var MomentItem = exports.MomentItem = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  color: ", ";\n  font-size: 14px;\n  \n  svg {\n    font-size: 14px;\n    margin-right: 5px;\n    ", " \n  }\n"])), function (props) {
