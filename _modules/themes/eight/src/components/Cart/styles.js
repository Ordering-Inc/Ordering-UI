...
var CustomCartBottom = exports.CustomCartBottom = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  position: fixed;\n  bottom: 0px;\n  background: #FFF;\n  box-shadow: 0px -1px 4px rgba(0, 0, 0, 0.1);\n  width: 100%;\n  padding: 25px 20px;\n  z-index: 1000;\n  box-sizing: border-box;\n\n  ", "\n"])), function (props) {
  var _props$theme2;
...
var CartActionsGroupContainer = exports.CartActionsGroupContainer = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  max-width: 800px;\n  margin: auto;\n  display: flex;\n  justify-content: space-between;\n"])));