...
var BusinessName = exports.BusinessName = _styledComponents.default.h6(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  font-size: 24px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  font-weight: 500;\n  margin-block-start: 0;\n  margin-block-end: 0;\n  color: ", ";\n\n  ", "\n"])), function (props) {
...
var BusinessActions = exports.BusinessActions = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  ", "\n\n"])), function (_ref8) {
  var isStore = _ref8.isStore;
  return isStore ? (0, _styledComponents.css)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n    justify-content: flex-end;\n    display: flex;\n    align-items: center;\n    width: 50%;\n  "]))) : (0, _styledComponents.css)(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n    margin-top: 10px;\n    ", "\n  "])), function (props) {
    var _props$theme4;
...
var BusinessAddress = exports.BusinessAddress = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  font-size: 14px;\n  font-weight: 500;\n  color: ", ";\n  margin-bottom: 10px;\n"])), function (props) {
  return props.theme.colors.grayDark;
});
var GreenDataItem = exports.GreenDataItem = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  color: ", ";\n  font-size: 14px;\n  font-weight: 500;\n"])), function (props) {
  return props.theme.colors.green;
});
var BusinessClosed = exports.BusinessClosed = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  color: ", ";\n  font-size: 14px;\n  font-weight: 500;\n"])), function (props) {
