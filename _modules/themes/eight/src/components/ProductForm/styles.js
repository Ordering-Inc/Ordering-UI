...
var ProductInnerContainer = exports.ProductInnerContainer = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  max-width: 700px;\n  margin: 0 auto;\n"])));
var ProductCartTotalPrice = exports.ProductCartTotalPrice = (0, _styledComponents.default)(ProductInnerContainer)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  justify-content: flex-end;\n  margin: 0px;\n  ", "\n  color: ", ";\n  font-weight: 500;\n  font-size: 16px;\n\n  ", "\n\n  span:first-child {\n    margin: 0 5px;\n  }\n\n  @media (min-width: 681px) {\n    ", "\n  }\n"])), function (_ref2) {
  var isMobile = _ref2.isMobile;
  return !isMobile && (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n    width: 100%;\n    padding: 40px 0 20px 0;\n    margin: 0 auto;\n  "])));
}, function (props) {
  return props.theme.colors.grayDark;
}, function (_ref3) {
  var isMobile = _ref3.isMobile;
  return !isMobile && (0, _styledComponents.css)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n    display: none;\n  "])));
}, function (_ref4) {
...
var SkuContent = exports.SkuContent = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  h2 {\n    font-size: 16px;\n    font-weight: 500;\n    margin-bottom: 0px;\n  }\n\n  p {\n    font-size: 14px;\n  }\n"])));
...
var IncDecActions = exports.IncDecActions = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  box-shadow: 0px 4px 10px rgb(0 0 0 / 12%);\n  border-radius: 30px;\n  button {\n    cursor: pointer;\n    outline: none;\n    height: 42px;\n    border: none;\n    font-size: 24px;\n    background: #FFF;\n    transition: all .3s ease-in-out;\n    padding: 0 20px;\n\n    &:active {\n      background: ", ";\n    }\n\n    &:disabled {\n      opacity: 0.5;\n      cursor: not-allowed;\n    }\n  }\n\n  button.decrease {\n    color: ", ";\n    ", "    \n  }\n  \n  button.increase {\n    color: ", ";\n    ", "\n  }\n\n  span {\n    min-width: 50px;\n    height: 42px;\n    color: ", ";\n    font-weight: 500;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  @media (min-width: 769px) {\n    ", "\n  }\n"])), function () {
...
var ProductActionHeaderContainer = exports.ProductActionHeaderContainer = _styledComponents.default.div(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 90%;\n  margin: 10px 0;\n\n  @media (min-width: 681px) {\n    margin: 0px;\n    width: initial;\n  }\n"])));
var ProductTabContainer = exports.ProductTabContainer = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  position: sticky;\n  top: 0px;\n  background: white;\n  z-index: 900;\n  padding-top: 15px;\n  border-bottom: 1px solid #E9ECEF;\n\n  > div {\n    max-width: 700px;\n    margin: 0 auto;\n  }\n\n  @media (min-width: 769px) {\n    top: 0;\n  }\n"])));
var ProductTagsListContainer = exports.ProductTagsListContainer = _styledComponents.default.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n"])));
var ProductTagWrapper = exports.ProductTagWrapper = _styledComponents.default.div(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin: 5px 0;\n\n  img {\n    width: 32px;\n    height: 32px;\n    border-radius: 8px;\n    box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n  }\n\n  span {\n    font-size: 14px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme5;
