...
exports.WrapperSubOption = exports.WrapperIngredients = exports.WrapperImage = exports.SkuContent = exports.SkeletonBlock = exports.SectionTitle = exports.ProductOptionInfo = exports.ProductInnerContainer = exports.ProductInfo = exports.ProductImage = exports.ProductFormTitle = exports.ProductEdition = exports.ProductContainer = exports.ProductComment = exports.ProductCartTotalPrice = exports.ProductActions = exports.IncDecActions = void 0;
...
var SectionTitle = _styledComponents.default.h3(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  text-transform: capitalize;\n  font-size: 18px;\n  padding-bottom: 15px;\n  margin: 0px;\n  font-weight: 500;\n  color: ", ";\n"])), function (props) {
  return props.theme.colors.grayDark;
});
...
var IncDecActions = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  box-shadow: 0px 4px 10px rgb(0 0 0 / 12%);\n  border-radius: 30px;\n  button {\n    cursor: pointer;\n    outline: none;\n    height: 42px;\n    border: none;\n    font-size: 24px;\n    background: #FFF;\n    transition: all .3s ease-in-out;\n    padding: 0 20px;\n\n    &:active {\n      background: ", ";\n    }\n\n    &:disabled {\n      opacity: 0.5;\n      cursor: not-allowed;\n    }\n  }\n\n  button.decrease {\n    color: ", ";\n    ", "    \n  }\n  \n  button.increase {\n    color: ", ";\n    ", "\n  }\n\n  span {\n    min-width: 50px;\n    height: 42px;\n    color: ", ";\n    font-weight: 500;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  @media (min-width: 769px) {\n    ", "\n  }\n"])), function () {
