...
var ProductOptionInfo = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  margin: 50px 0 30px 0;\n  background-color: ", ";\n  padding: 20px 0 40px 0;\n"])), function (props) {
  return props.theme.colors.third;
});

exports.ProductOptionInfo = ProductOptionInfo;

var ProductInnerContainer = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  max-width: 700px;\n  margin: 0 auto;\n"])));

exports.ProductInnerContainer = ProductInnerContainer;
var ProductCartTotalPrice = (0, _styledComponents.default)(ProductInnerContainer)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  justify-content: flex-end;\n  margin: 0px;\n  ", "\n  color: ", ";\n  font-weight: 500;\n  font-size: 16px;\n\n  ", "\n\n  span:first-child {\n    margin: 0 5px;\n  }\n\n  @media (min-width: 681px) {\n    ", "\n  }\n"])), function (_ref) {
...
var SectionTitle = _styledComponents.default.h3(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  text-transform: capitalize;\n  font-size: 18px;\n  padding-bottom: 15px;\n  margin: 0px;\n  font-weight: 500;\n  color: ", ";\n"])), function (props) {
  return props.theme.colors.grayDark;
});

exports.SectionTitle = SectionTitle;

var ProductComment = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  p {\n    font-weight: 300;\n    margin-bottom: 5px;\n  }\n"])));
...
var WrapperSubOption = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  border-radius: 10px;\n  &.error {\n    background-color: ", ";\n  }\n  &.soldout {\n    pointer-events: none;\n    background-color: hsl(0, 0%, 72%);\n  }\n"])), (0, _polished.lighten)(0.58, '#A52121'));

exports.WrapperSubOption = WrapperSubOption;

var SkuContent = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  h2 {\n    font-size: 16px;\n    font-weight: 500;\n    margin-bottom: 0px;\n  }\n\n  p {\n    font-size: 14px;\n  }\n"])));

exports.SkuContent = SkuContent;

var WrapperIngredients = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  ", "\n"])), function (_ref5) {
  var isProductSoldout = _ref5.isProductSoldout;
  return isProductSoldout && (0, _styledComponents.css)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n    border-radius: 10px;\n    pointer-events: none;\n    background: hsl(0, 0%, 72%);\n  "])));
});

exports.WrapperIngredients = WrapperIngredients;

var IncDecActions = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  box-shadow: 0px 4px 10px rgb(0 0 0 / 12%);\n  border-radius: 30px;\n  button {\n    cursor: pointer;\n    outline: none;\n    height: 42px;\n    border: none;\n    font-size: 24px;\n    background: #FFF;\n    transition: all .3s ease-in-out;\n    padding: 0 20px;\n\n    &:active {\n      background: ", ";\n    }\n\n    &:disabled {\n      opacity: 0.5;\n      cursor: not-allowed;\n    }\n  }\n\n  button.decrease {\n    color: ", ";\n    ", "    \n  }\n  \n  button.increase {\n    color: ", ";\n    ", "\n  }\n\n  span {\n    min-width: 50px;\n    height: 42px;\n    color: ", ";\n    font-weight: 500;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  @media (min-width: 769px) {\n    ", "\n  }\n"])), function () {
  ...
  return (_props$theme3 = props.theme) !== null && _props$theme3 !== void 0 && _props$theme3.rtl ? (0, _styledComponents.css)(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n      border-radius: 30px 0 0 30px;\n      border-right: 1px solid ", ";\n    "])), function (props) {
    return props.theme.colors.gray;
...
var ProductActionHeaderContainer = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 90%;\n  margin: 10px 0;\n\n  @media (min-width: 681px) {\n    margin: 0px;\n    width: initial;\n  }\n"])));
