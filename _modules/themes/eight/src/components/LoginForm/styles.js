...
var DottedBorderBound = exports.DottedBorderBound = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  border-bottom: 6px dotted ", ";\n  width: 80%;\n  ", "\n"])), function (props) {
  return props.theme.colors.grayMedium;
}, function (_ref11) {
  var bottom = _ref11.bottom;
  return bottom ? (0, _styledComponents.css)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n    margin: 45px 0 10px 0;\n  "]))) : (0, _styledComponents.css)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n    margin: 20px 0 35px 0;\n  "])));
});