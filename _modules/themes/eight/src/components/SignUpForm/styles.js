...
var Description = exports.Description = _styledComponents.default.p(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  color: ", ";\n  width: 80%;\n  font-size: 14px;\n  margin: 0px;\n  max-width: 700px;\n  text-align: center;\n\n  @media (min-width: 768px) {\n    font-size: 18px;\n  }\n\n  @media (min-width: 992px) {\n    font-size: 20px;\n  }\n\n  @media (min-width: 1200px) {\n    font-size: 24px;\n  }\n"])), function (props) {
...
var SkeletonSocialWrapper = exports.SkeletonSocialWrapper = (0, _styledComponents.default)(SkeletonWrapper)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  width: ", ";\n  margin: 80px 0 60px;\n\n  display: flex;\n  flex-direction: column;\n\n  span {\n    margin: 10px;\n    width: 100%;\n  }\n\n  @media (min-width: 1300px) {\n    flex-direction: row;\n  }\n"])), function (_ref13) {
