...
var Item = exports.Item = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  min-width: 150px;\n  padding: 20px 15px 30px 15px;\n  margin: 15px;\n  text-align: center;\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n  border-radius: 20px;\n  box-sizing: border-box;\n  user-select: none;\n  ", "\n\n  @media (min-width: 768px) {\n    ", "\n  }\n\n  @media (min-width: 1200px) {\n    ", "\n  }\n"])), function (_ref3) {
  ...
  return !isCustomMode && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n      width: calc(33% - 30px);\n    "])));
});
var Image = exports.Image = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 80px;\n  position: relative;\n  display: flex;\n  justify-content: center;\n  align-items: flex-end;\n  img{\n    width: 100%;\n    height: auto;\n    border-radius: 7.6px;\n    aspect-ratio: attr(width) / attr(height)\n  }\n  > button {\n    position: absolute;\n    font-size: 12px;\n    padding: 0px 15px;\n    bottom: -15px;\n  }\n"])));
var Details = exports.Details = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  font-size: 16px;\n  width: calc(100% - 95px);\n  div {\n    width: 100%;\n     h3 {\n      margin-block-start: 0.1em;\n      margin-block-end: 0.1em;\n      overflow: hidden;\n      white-space: nowrap;\n      text-overflow: ellipsis;\n      font-size: 14px;\n      color: ", ";\n      text-align: initial;\n    }\n  }\n  p {\n    color: ", ";\n    font-weight: 500;\n    margin: 0;\n    text-align: initial;\n  }\n  button {\n    width: auto;\n    margin: 8px auto 0;\n    padding: 0 20px;\n    font-size: 1em;\n    line-height: 22px;\n\n  }\n\n  @media (min-width: 480px){\n    div{\n      h3{\n        font-size: 16px;\n      }\n    }\n  }\n\n"])), function (props) {
  return props.theme.colors.secundary;
}, function (props) {
  return props.theme.colors.grayDark;
});
var CloseUpselling = exports.CloseUpselling = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 100%;\n  text-align: center;\n  margin-top: 20px;\n\n  button{\n    width: 90%;\n    font-size: 1.4em;\n    padding: 10px 0;\n  }\n\n  @media (min-width: 720px){\n    button{\n      width: 40%;\n      padding: 2px;\n      font-size: 1em;\n    }\n  }\n"])));
