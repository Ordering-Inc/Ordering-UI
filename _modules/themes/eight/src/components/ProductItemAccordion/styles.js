...
var AccordionText = exports.AccordionText = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  font-weight: 400;\n  font-size: 14px;\n  padding: 18px;\n"])));
var ProductComment = exports.ProductComment = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  ", "\n  p {\n    margin: 0px;\n    font-weight: 400;\n    font-size: 12px;\n    color: ", ";\n  }\n\n  h3 {\n    font-size: 12px;\n    font-weight: 400;\n    text-transform: capitalize;\n    margin: 0px 20px;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    overflow: hidden;\n    color: ", ";\n  }\n\n  @media (min-width: 681px) {\n    p, h3 {\n      font-size: 14px;\n    }\n  }\n"])), function (_ref4) {
...
var ProductInfo = exports.ProductInfo = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: 70%;\n\n  h1,\n  h3 {\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  }\n\n  p {\n    font-size: 20px;\n    margin: 0px 5px;\n  }\n"])));
var ProductError = exports.ProductError = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n\n  span {\n    font-size: 18px;\n    text-align: center;\n  }\n\n  @media (min-width: 411px){\n    width: 35%;\n\n    span{\n      text-align: right;\n    }\n  }\n"])));
var ProductActions = exports.ProductActions = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: flex-end;\n  width: 100%;\n"])));
var ProductActionsEdit = exports.ProductActionsEdit = _styledComponents.default.span(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  svg {\n    font-size: 20px;\n    margin-right: 5px;\n    cursor: pointer;\n    ", "\n  }\n"])), function (props) {
  var _props$theme9;
...
var ProductActionsDelete = exports.ProductActionsDelete = (0, _styledComponents.default)(ProductActionsEdit)(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  svg {\n    margin-right: 0px;\n  }\n"])));
var ProductPriceSection = exports.ProductPriceSection = _styledComponents.default.div(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  width: 28%;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n"])));
var ProductPrice = exports.ProductPrice = _styledComponents.default.div(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: flex-end;\n  margin-bottom: 10px;\n\n  p,\n  span {\n    font-size: 14px;\n  }\n\n  span {\n    color: ", ";\n  }\n\n  p {\n    margin-top: 0px;\n    margin-bottom: 0px;\n    ", "\n  }\n\n  svg {\n    cursor: pointer;\n  }\n\n  @media (min-width: 512px) {\n    span,\n    p {\n      font-size: 18px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.grayDark;
}, function (props) {
  var _props$theme10;
...
var ProductNotAvailable = exports.ProductNotAvailable = _styledComponents.default.span(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n  color: #D81212;\n"])));
var ProductOptionsList = exports.ProductOptionsList = _styledComponents.default.ul(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["\n  list-style-type: none;\n  color: ", ";\n  font-size: 12px;\n\n  ", "\n\n  .suboption {\n    margin-left: -25px;\n    ", "\n  }\n\n  p:nth-child(1) {\n    margin-bottom: 0;\n  }\n\n  p {\n    font-weight: 400;\n    margin: 0px;\n    color: ", ";\n  }\n\n  li span {\n    font-weight: 400;\n    color: ", ";\n  }\n\n  li.ingredient {\n    padding-left: 15px;\n    ", "\n  }\n\n  @media (min-width: 681px) {\n    font-size: 14px;\n  }\n"])), function (props) {
  return props.theme.colors.grayDark;
}, function (_ref5) {
...
var ProductQuantity = exports.ProductQuantity = _styledComponents.default.span(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["\n  margin-left: 5px;\n  ", "\n"])), function (props) {
  var _props$theme14;
...
var ProductCardContainer = exports.ProductCardContainer = _styledComponents.default.div(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral(["\n  padding: 20px;\n  display: flex;\n  justify-content: space-between;\n  border-bottom: 1px dashed #ACB2B6;\n\n  @media (min-width: 681px) {\n    padding: 20px 30px 30px 30px;\n    border-bottom: none;\n    box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n    border-radius: 20px;\n    margin-bottom: 40px;\n  }\n"])));
var ProductInfoContainer = exports.ProductInfoContainer = _styledComponents.default.div(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  width: calc(100% - 75px);\n  flex-direction: row;\n\n  > div:last-child {\n    flex-direction: column;\n    width: 100%;\n    align-items: center;\n\n    > div {\n      span {\n        font-size: 14px;\n        margin: 0 5px;\n      }\n    }\n  }\n\n  @media (min-width: 361px) {\n    width: calc(100% - 85px);\n  }\n\n  @media (min-width: 411px) {\n    width: calc(100% - 95px);\n  }\n\n  @media (min-width: 768px) {\n    width: calc(100% - 140px);\n    flex-direction: row;\n\n    > div:last-child {\n      width: 25%;\n      align-items: flex-end;\n      > div {\n        span {\n          font-size: 16px;\n        }\n      }\n    }\n  }\n"])));
var ProductInfoContent = exports.ProductInfoContent = _styledComponents.default.div(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n  width: 60%;\n  h1 {\n    color: ", ";\n    font-weight: 500;\n    font-size: 16px;\n    margin: 0px;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  }\n\n  @media (min-width: 768px) {\n    width: calc(75% - 20px);\n    h1 {\n      font-size: 20px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.secundary;
});
var IncDecActions = exports.IncDecActions = _styledComponents.default.div(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  box-shadow: 0px 4px 10px rgb(0 0 0 / 12%);\n  border-radius: 30px;\n  position: absolute;\n  bottom: -10px;\n  background-color: #FFF;\n  button {\n    cursor: pointer;\n    outline: none;\n    height: 24px;\n    border: none;\n    font-size: 20px;\n    background: #FFF;\n    transition: all .3s ease-in-out;\n    padding: 0 5px;\n    display: flex;\n    align-items: center;\n    &:active {\n      background: ", ";\n    }\n\n    &:disabled {\n      opacity: 0.5;\n      cursor: not-allowed;\n    }\n  }\n\n  button.decrease {\n    color: ", ";\n    ", "    \n  }\n  \n  button.increase {\n    color: ", ";\n    ", "\n  }\n\n  span {\n    min-width: 30px;\n    height: 24px;\n    color: ", ";\n    font-weight: 500;\n    font-size: 14px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  @media (min-width: 681px) {\n    button {\n      padding: 0 10px;\n    }\n  }\n"])), function () {
