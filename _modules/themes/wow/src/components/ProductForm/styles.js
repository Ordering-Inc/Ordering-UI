...
var ProductActionHeader = exports.ProductActionHeader = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 10px;\n  color: ", ";\n  h1 {\n    margin: 0px;\n    display: flex;\n    align-items: center;\n    > span {\n      font-size: 20px;\n      font-weight: 500;\n    }\n\n    > p {\n      margin: 0px 15px;\n      span {\n        font-size: 14px;\n        font-weight: 300;\n        &:last-child {\n          margin: 5px;\n        }\n      }\n    }\n  }\n\n  > span {\n    font-size: 20px;\n    font-weight: 500;\n  }\n\n  @media (max-width: 576px) {\n    width: 90%;\n    margin: 0 auto 10px auto;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
var ProductActionContent = exports.ProductActionContent = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  div.incdec-control {\n    width: fit-content;\n    display: flex;\n    align-items: center;\n    justiy-content: space-around;\n\n    svg {\n      width: 35px;\n      height: 35px;\n      cursor: pointer;\n      color: ", ";\n    }\n\n    span {\n      color: ", ";\n      font-weight: 500;\n      margin: 0 20px;\n    }\n  }\n  div:last-child {\n    width: 100%;\n    display: flex;\n    align-items: center;\n  }\n\n  button:disabled,\n  button.disabled,\n  svg.disabled {\n    opacity: 0.5;\n  }\n\n  svg.disabled {\n    pointer-events: none;\n  }\n\n  button.add {\n    width: 90%;\n    padding: 5px 10px;\n    margin: 10px 0px 0px;\n    position: relative;\n\n    &.soldout {\n      width: 100%;\n      pointer-events: none;\n    }\n  }\n\n  @media (min-width: 577px) {\n    justify-content: space-between;\n    flex-direction: row;\n\n    div:last-child {\n      width: 75%;\n    }\n    button.add {\n      width: 75%;\n      margin: 0 10px;\n    }\n\n    div.incdec-control {\n      ", "\n    }\n  }\n\n  @media (min-width: 769px) {\n    button.add {\n      width: 100%;\n      margin: 0px;\n    }\n  }\n\n  @media (min-width: 1201px) {\n    div.incdec-control {\n      span {\n        margin: 0 30px;\n      }\n      ", "\n    }\n    div:last-child {\n      width: 70%;\n      button {\n        width: 100%;\n      }\n    }\n    button.add {\n      width: 68%;\n    }\n  }\n\n  @media (max-width: 576px) {\n    div.incdec-control {\n      justify-content: space-around;\n      width: 90%;\n    }\n  }\n"])), function (props) {
...
var SkeletonBlock = exports.SkeletonBlock = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  width: ", ";\n  border-radius: 16px;\n  margin: auto;\n\n  span {\n    margin-bottom: 10px;\n  }\n"])), function (_ref2) {
  var width = _ref2.width;
  return width && "".concat(width, "%");
});
var WrapperSubOption = exports.WrapperSubOption = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  border-radius: 10px;\n  &.error {\n    background-color: ", ";\n  }\n  &.soldout {\n    pointer-events: none;\n    background-color: hsl(0, 0%, 72%);\n  }\n\n  > div:last-child {\n    border-bottom: none;\n  }\n"])), (0, _polished.lighten)(0.58, '#A52121'));
var ProductInfoInnerContainer = exports.ProductInfoInnerContainer = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  padding: 10px;\n  border-top-left-radius: 15px;\n  border-top-right-radius: 15px;\n  @media (min-width: 1201px) {\n    padding: 10px 20px;\n  }\n"])));
var WrapperIngredients = exports.WrapperIngredients = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  ", "\n\n  > div:last-child {\n    border-bottom: none;\n  }\n"])), function (_ref3) {
