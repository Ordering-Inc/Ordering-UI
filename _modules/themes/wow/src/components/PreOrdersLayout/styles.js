...
var DeliveryTime = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  color: ", ";\n  max-width: calc(100% - 110px);\n  p {\n    margin: 0px;\n    font-weight: 600;\n    font-size: 16px;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n\n    ", "\n  }\n"])), function (props) {
...
var OrderContent = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  display: flex;\n  flex: 1;\n  max-width: calc(100% - 120px);\n"])));

exports.OrderContent = OrderContent;

var BusinessInformation = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  width: calc(100% - 85px);\n  ", "\n\n  h2 {\n    font-size: 18px;\n    font-weight: 600;\n    color: ", ";\n    margin: 0px;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  }\n\n  p {\n    margin: 5px 0 0 0;\n    font-size: 12px;\n    color: ", ";\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  }\n"])), function (props) {
  var _props$theme2;
...
var ActionContent = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: flex-end;\n  color: ", ";\n\n  p {\n    margin: 0px;\n    font-size: 18px;\n    font-weight: 600;\n  }\n\n  span {\n    cursor: pointer;\n    font-size: 14px;\n    text-decoration: underline;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
...
var ReviewContainer = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  h2 {\n    color: ", ";\n    margin: 0px;\n    font-weight: 400;\n    font-size: 14px;\n  }\n"])), function (props) {
