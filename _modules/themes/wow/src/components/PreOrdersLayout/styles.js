...
var ActionContent = exports.ActionContent = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: flex-end;\n  color: ", ";\n\n  p {\n    margin: 0px;\n    font-size: 18px;\n    font-weight: 600;\n  }\n\n  span {\n    cursor: pointer;\n    font-size: 14px;\n    text-decoration: underline;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
var LoadMoreButtonWrap = exports.LoadMoreButtonWrap = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  margin: 20px auto;\n\n  @media (min-width: 768px) {\n    width: 80%;\n  }\n\n  button {\n    width: 100%;\n    padding: 7px 0;\n  }\n"])));
var ReviewContainer = exports.ReviewContainer = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  h2 {\n    color: ", ";\n    margin: 0px;\n    font-weight: 400;\n    font-size: 14px;\n  }\n"])), function (props) {
