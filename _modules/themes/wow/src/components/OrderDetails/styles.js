...
var BusinessAction = exports.BusinessAction = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  > span {\n    cursor: pointer;\n  }\n  svg {\n    font-size: 24px;\n    color: #FFF;\n\n    &:first-child {\n      ", "\n    }\n  }\n"])), function (props) {
  var _props$theme;
...
var MessagesIcon = exports.MessagesIcon = _styledComponents.default.span(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  position: relative;\n  cursor: pointer;\n\n  ", "\n"])), function (props) {
  var _props$theme2;
...
var ExclamationWrapper = exports.ExclamationWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  position: absolute;\n  transform: translate(0%, -25%);\n  svg{\n    font-size: 16px;\n    color: ", "\n  }\n"])), function (props) {
  var _props$theme3;
...
var OrderStatus = exports.OrderStatus = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n"])));
var StatusItem = exports.StatusItem = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  color: ", ";\n\n  ", "\n\n  display: flex;\n  align-items: center;\n\n  span {\n    font-weight: 600;\n\n    ", "\n  }\n\n  svg {\n    font-size: 20px;\n  }\n"])), function (props) {
...
var Line = exports.Line = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  width: 1px;\n  height: 20px;\n  margin: 0px 9px;\n  background: #CCC;\n"])));
var EstimatedTime = exports.EstimatedTime = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  p {\n    &:first-child {\n      color: ", ";\n      margin: 0px;\n    }\n\n    &:last-child {\n      color: ", ";\n      font-size: 24px;\n      margin: 10px 0;\n    }\n  }\n"])), function (props) {
...
var OrderProgressBar = exports.OrderProgressBar = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  padding: 15px 0;\n"])));
var ProgressItem = exports.ProgressItem = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border-radius: 15px;\n  height: 8px;\n  width: calc(33% - 10px);\n  ", "\n"])), function (props) {
...
var BusinessGeneralInfo = exports.BusinessGeneralInfo = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: calc(100% - 85px);\n"])));
var OrderDeliveryTimeContainer = exports.OrderDeliveryTimeContainer = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid #CCC;\n  padding: 10px 0;\n\n  p {\n    margin: 0px;\n    color: ", ";\n  }\n"])), function (props) {
...
var CustomerInfo = exports.CustomerInfo = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  h2 {\n    color: ", ";\n    font-size: 18px;\n  }\n\n  p {\n    color: ", ";\n  }\n\n  border-bottom: 1px solid #CCC;\n"])), function (props) {
  return props.theme.colors.primary;
}, function (props) {
...
var OrderPaymentMethod = exports.OrderPaymentMethod = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  h2 {\n    color: ", ";\n    font-size: 18px;\n  }\n\n  > div {\n    border-radius: 10px;\n    padding: 10px 15px;\n    box-shadow: 0px 6px 10px rgba(128, 128, 128, 0.05), 0px 1px 18px rgba(128, 128, 128, 0.05), 0px 3px 5px rgba(128, 128, 128, 0.05);\n    display: flex;\n    align-items: center;\n    margin-bottom: 20px;\n\n    span {\n      color: ", ";\n      margin: 0 10px;\n    }\n\n    svg {\n      font-size: 24px;\n      color: ", ";\n    }\n  }\n"])), function (props) {
  return props.theme.colors.primary;
}, function (props) {
