...
var RegisterMethodsContainer = exports.RegisterMethodsContainer = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n"])));
var RegisterMethodsInnerContainer = exports.RegisterMethodsInnerContainer = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  width: 80%;\n  > * {\n    width: 100%;\n    margin: 10px 0;\n  }\n\n  button {\n    padding: 5px;\n  }\n"])));
var BackButton = exports.BackButton = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  position: absolute;\n  color: ", ";\n  font-weight: 600;\n  font-size: 18px;\n  top: 25px;\n  ", "\n  display: flex;\n  align-items: center;\n\n  span {\n    padding: 0 10px;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
}, function (props) {
  var _props$theme3;
