...
var BusinessGeneralInfo = exports.BusinessGeneralInfo = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  min-width: 300px;\n"])));
var BusinessLocation = exports.BusinessLocation = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin: 10px 0;\n  svg {\n    color: ", ";\n  }\n  span {\n    color: ", ";\n    margin: 0 10px;\n    font-size: 14px;\n  }\n\n  h5 {\n    cursor: pointer;\n    color: ", ";\n    font-weight: 600;\n    font-size: 14px;\n    margin: 0px;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
}, function (props) {
