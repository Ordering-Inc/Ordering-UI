...
var ActionContent = exports.ActionContent = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: flex-end;\n  color: ", ";\n\n  p {\n    margin: 0px;\n    font-size: 18px;\n    font-weight: 600;\n  }\n\n  span {\n    cursor: pointer;\n    font-size: 14px;\n    text-decoration: underline;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
var LoadMoreButtonWrap = exports.LoadMoreButtonWrap = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  margin: 20px auto;\n\n  @media (min-width: 768px) {\n    width: 80%;\n  }\n\n  button {\n    width: 100%;\n    padding: 7px 0;\n  }\n"])));
var ReviewContainer = exports.ReviewContainer = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  h2 {\n    color: ", ";\n    margin: 0px;\n    font-weight: 400;\n    font-size: 14px;\n  }\n"])), function (props) {
  var _props$theme$colors;
  return (_props$theme$colors = props.theme.colors) === null || _props$theme$colors === void 0 ? void 0 : _props$theme$colors.grayColor;
});
var StarRating = exports.StarRating = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  unicode-bidi: bidi-override;\n  color: #B3B3B3;\n  font-size: 25px;\n  height: 25px;\n  margin: 0 auto;\n  position: relative;\n  padding: 0;\n\n  span {\n    margin-right: 5px;\n  }\n"])));
var StarRatingUpper = exports.StarRatingUpper = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  color: #FFD605;\n  padding: 0;\n  position: absolute;\n  z-index: 1;\n  display: flex;\n  top: 0;\n  left: 0;\n  overflow: hidden;\n"])));
var StarRatingLower = exports.StarRatingLower = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  padding: 0;\n  display: flex;\n  z-index: 0;\n"])));