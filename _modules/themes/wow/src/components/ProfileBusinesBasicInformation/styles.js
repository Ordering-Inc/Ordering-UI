...
var BusinessMainInfo = exports.BusinessMainInfo = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  max-width: calc(100% - 70px);\n"])));
var MetaInfo = exports.MetaInfo = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  max-width: calc(100% - 80px);\n\n  h1,\n  p {\n    margin: 0px;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  }\n\n  h1 {\n    font-size: 16px;\n  }\n\n  p {\n    margin: 0 5px;\n  }\n\n  .primary {\n    color: ", ";\n  }\n  .star {\n    color: #FFD605;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});