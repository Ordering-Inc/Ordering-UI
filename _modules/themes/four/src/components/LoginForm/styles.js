...
var LoginWithButton = exports.LoginWithButton = (0, _styledComponents.default)(_Buttons.Button)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  width: 100%;\n  background-color: #EFEFEF;\n  border-color: #EFEFEF;\n  font-size: 16px;\n  font-weight: 400;\n  text-align: center;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  /* margin-bottom: 10px; */\n  padding: 5px 30px;\n  svg {\n    font-size: 28px;\n    color: #000;\n  }\n\n  div {\n    margin: 0 auto;\n    color: #000;\n    line-height: 30px;\n    font-size: 16px;\n  }\n\n  &:hover {\n    svg,\n    div {\n      color: ", ";\n    }\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
var Slogan = exports.Slogan = _styledComponents.default.p(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  color: ", ";\n  margin-top: 0px;\n"])), function (props) {
...
var OrContainer = exports.OrContainer = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: 100%;\n  margin: 20px 0;\n\n  span {\n    padding: 0 10px;\n    color: ", ";\n    font-weight: 500;\n  }\n"])), function (props) {
...
var Line = exports.Line = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n  flex: 1;\n"])), function (props) {
