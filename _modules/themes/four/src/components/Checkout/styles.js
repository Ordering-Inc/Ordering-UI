...
var UserDetailsContainer = exports.UserDetailsContainer = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  flex-wrap: wrap;\n"])));
var BusinessDetailsContainer = exports.BusinessDetailsContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  padding: 0 20px;\n  border-bottom: 1px solid #CCC;\n"])));
var Accordion = exports.Accordion = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  cursor: pointer;\n  transition: background-color 0.6s ease;\n  position: relative;\n  padding: 20px 0;\n\n  .rotate {\n    transform: rotate(180deg);\n  }\n\n  .accordion__icon {\n    transition: transform 0.6s ease;\n  }\n\n  svg {\n    color: ", ";\n    font-size: 20px;\n  }\n\n  h1 {\n    margin: 0px;\n    font-size: 20px;\n    display: flex;\n    align-items: center;\n\n    svg {\n      ", "\n    }\n  }\n\n  &.active h1 svg {\n    color: ", ";\n  }\n"])), function (props) {
...
var PaymentMethodContainer = exports.PaymentMethodContainer = (0, _styledComponents.default)(BusinessDetailsContainer)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral([""])));
...
var OrderBill = exports.OrderBill = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  padding: 10px;\n  background-color: #FFF;\n  color: ", ";\n\n  table {\n    padding: 10px 0;\n    width: 100%;\n    font-size: 16px;\n    font-weight: 300;\n\n    td span {\n      unicode-bidi: bidi-override;\n    }\n\n    tr td:nth-child(2) {\n      font-weight: 500;\n      text-align: right;\n      ", "\n    }\n  }\n  table.driverTip {\n    border-top: 1px solid #EAEAEA;\n    button {\n      font-size: 14px;\n      padding: 0 10px;\n      text-transform: uppercase;\n    }\n\n    .recommendTxt {\n      color: ", ";\n      font-size: 13px;\n    }\n  }\n  table.total {\n    border-top: 1px solid #EAEAEA;\n    tr {\n      td:nth-child(1) {\n        font-weight: bold;\n      }\n      td:nth-child(2) {\n        font-weight: bold;\n        color: ", ";\n      }\n    }\n  }\n\n  @media (min-width: 411px) {\n    table {\n      font-size: 18px;\n    }\n  }\n"])), function (props) {
...
var CouponContainer = exports.CouponContainer = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin: 10px;\n"])));
var Exclamation = exports.Exclamation = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  position: relative;\n  display: inline-flex;\n  cursor: pointer;\n  margin-left: 5px;\n  top: 3px;\n"])));