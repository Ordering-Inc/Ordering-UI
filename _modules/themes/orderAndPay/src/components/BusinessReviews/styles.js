...
var WrapperSelect = exports.WrapperSelect = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  width: 95%;\n  margin: 10px 0px;\n  > div {\n    width: 100%;\n  }\n  @media (min-width: 480px){\n    width: 45%;\n    display: none;\n  }\n"])));
...
var Review = exports.Review = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  margin: 10px 0;\n  @media (min-width: 480px){\n    margin: 20px 0;\n  }\n"])));
var ReviewsNotFound = exports.ReviewsNotFound = _styledComponents.default.h2(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  margin: 65px 0;\n  font-size: 14px;\n  color: #B1BCCC;\n  text-align: center;\n"])));
...
var ReviewsHeaderWrapper = exports.ReviewsHeaderWrapper = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  svg {\n    font-size: 30px;\n    color: ", ";\n    margin-right: 13px;\n    ", "\n  }\n  h2 {\n    font-weight: 600;\n    font-size: 24px;\n    color: ", ";\n  }\n\n  ", "\n"])), function (props) {
  var _props$theme;
  ...
  return noReviews && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n    svg {\n      color: #B1BCCC;\n    }\n  "])));
});
var ReviewsProgressWrapper = exports.ReviewsProgressWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  p {\n    margin-top: 0;\n    font-size: 14px;\n    color: ", ";\n  }\n"])), function (props) {
  var _props$theme4;
...
var ReviewsMarkPoint = exports.ReviewsMarkPoint = _styledComponents.default.span(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 15px;\n  font-size: 12px;\n  color: #CED4DA\n"])));
var ReviewTime = exports.ReviewTime = _styledComponents.default.p(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  color: #909BA9;\n  margin: 0;\n"])));
var ReviewItemHeader = exports.ReviewItemHeader = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  margin-bottom: 17px;\n"])));
var ReviewItemContent = exports.ReviewItemContent = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  color: ", ";\n"])), function (props) {
  var _props$theme6;
