...
var BorderProductAccordion = exports.BorderProductAccordion = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid #D9D9D9;\n  margin-left : 15px;\n"])));
var CouponContainer = exports.CouponContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin: 10px;\n"])));
var CheckoutAction = exports.CheckoutAction = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0 6px;\n  box-sizing: border-box;\n  margin-left: 3px;\n  margin-bottom: ", ";\n  p {\n    margin: 0;\n    font-weight: 600;\n    font-size: 16px;\n    color: ", ";\n  }\n  button {\n    padding: 10px 30px;\n    width: 100%;\n    &:disabled{\n      opacity: 0.5;\n      cursor: not-allowed\n    }\n  }\n\n  @media (min-width: 767px){\n    top: 60px;\n  }\n\n  @media (max-width: 430px){\n    top: 60px;\n  }\n\n  @media (max-width: 376px){\n    top: 100px;\n  }\n"])), function (_ref6) {
...
var UpsellingPageTitleWrapper = exports.UpsellingPageTitleWrapper = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding:10px;\n  margin-left: 3px;\n  p {\n    font-weight: 500;\n    font-size: 16px;\n    color: ", ";\n  }\n\n  svg {\n    font-size: 20px;\n    cursor: pointer;\n    color: #748194;\n    ", "\n  }\n"])), function (props) {
  var _props$theme2;
...
var Exclamation = exports.Exclamation = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  position: relative;\n  display: inline-flex;\n  cursor: pointer;\n  margin-left: 5px;\n  top: 3px;\n"])));