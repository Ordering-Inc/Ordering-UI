...
var BusinessCartContent = exports.BusinessCartContent = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  background: white;\n  padding: 35px 30px;\n  border: 1px solid #E9ECEF;\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n  border-radius: 7.6px;\n"])));
var EmptyCart = exports.EmptyCart = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  .empty-content {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    svg {\n      font-size: 45px;\n      color: #B1BCCC;\n      margin-top: 10px;\n    }\n\n    p {\n      font-size: 14px;\n      color: #B1BCCC;\n      margin: 23px 0 0 0;\n    }\n  }\n"])));
var EmptyBtnWrapper = exports.EmptyBtnWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-top: 20px;\n\n  span {\n    font-weight: 600;\n    font-size: 16px;\n    color: ", ";\n  }\n\n  button {\n    color: #748194;\n    background: #F8F9FA;\n    border-radius: 7.6px;\n  }\n"])), function (props) {
  return props.theme.colors.darkTextColor;
});
var Title = exports.Title = _styledComponents.default.h1(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  font-weight: 600;\n  font-size: 20px;\n  color: ", ";\n  margin-bottom: 18px;\n"])), function (props) {
  return props.theme.colors.darkTextColor;
});
var ModalIcon = exports.ModalIcon = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0 40px;\n"])));
var GoBackContainer = exports.GoBackContainer = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: 90%;\n  img{\n    margin: 0 5px;\n    width: 46px;\n    height: 46px;\n    filter: drop-shadow(0px 1px 4px rgba(0, 0, 0, 0.1));\n    box-shadow: 0px 1px 4px 0px #0000001A;\n    border-radius: 7.6px;\n  }\n  h1{\n    font-size: 14px;\n    font-weight: 600;\n    color: ", ";\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    margin-right: 5px;\n    width: 70%;\n  }\n"])), function (props) {
  return props.theme.colors.darkTextColor;
});
var OrderTypeWrapperButton = exports.OrderTypeWrapperButton = (0, _styledComponents.default)(_Buttons.Button)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  background: ", ";\n  height: 35px;\n  margin-right: 10px;\n  display: flex;\n  align-items: center;\n  max-width: 100px;\n  h2{\n    font-size: 12px;\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis;\n  }\n"])), function (_ref) {
  var theme = _ref.theme;
  return theme.colors.primary;
});
var LogoutButtonContainer = exports.LogoutButtonContainer = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  position: relative;\n  top: 2px;\n"])));