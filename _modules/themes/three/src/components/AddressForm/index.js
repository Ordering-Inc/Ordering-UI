...
var AddressFormUI = function AddressFormUI(props) {
  var _ref, _formState$changes$ad, _formState$changes, _addressState$address, _addressState$address2, _addressState$address3, _formState$changes$lo, _formState$changes2, _configState$configs, _configState$configs$, _configState$configs2, _configState$configs3, _configState$configs4, _configState$configs5, _props$beforeElements, _props$beforeComponen, _props$beforeMidEleme, _props$beforeMidCompo, _configState$configs6, _configState$configs7, _ref9, _formState$changes$in, _formState$changes26, _ref10, _formState$changes$zi, _formState$changes27, _ref11, _formState$changes$ad5, _formState$changes28, _props$afterMidElemen, _props$afterMidCompon, _orderState$options6, _orderState$options6$, _props$afterComponent, _props$afterElements;

  var isSchedule = props.isSchedule,
  ...
  (0, _react.useEffect)(function () {
    if (formState.loading || !submitted || !isSchedule) return;
    onCancel();
  }, [formState, submitted]);
  ...
  }), isSchedule && /*#__PURE__*/_react.default.createElement(_ScheduleSetting.ScheduleSetting, {
    isRadioButtonStyle: true,
    title: t('WHEN', 'when')
  }), isSchedule ? /*#__PURE__*/_react.default.createElement(_styles.WrapSaveButton, null, /*#__PURE__*/_react.default.createElement(_Buttons.Button, {
    color: "primary",
    rectangle: true,
    type: "submit",
    disabled: formState.loading
  }, t('SAVE_CONTINUE', 'Save & Continue'))) : /*#__PURE__*/_react.default.createElement(_styles.FormActions, null, onCancel && /*#__PURE__*/_react.default.createElement(_Buttons.Button, {
    outline: true,
    type: "button",
    disabled: formState.loading,
