...
exports.MenuLinkSeparator = exports.TextInfo = exports.MenuLinkText = exports.MenuLinkIcon = exports.WrappContent = exports.WrapperUserAccountContent = exports.MenuLink = exports.MenuClose = exports.SidebarContent = exports.IconContent = exports.Container = void 0;
...
var WrapperUserAccountContent = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  padding: 16px;\n  display: flex;\n  align-items: center;\n\n  img {\n    width: 50px;\n    height: 50px;\n    border-radius: 25px;\n  }\n\n  svg {\n    width: 50px;\n    height: 50px;\n    border-radius: 25px;\n  }\n\n  p {\n    font-size: 18px;\n    font-weight: 500;\n    color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});

exports.WrapperUserAccountContent = WrapperUserAccountContent;
