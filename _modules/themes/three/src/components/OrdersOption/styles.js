...
var SkeletonMap = exports.SkeletonMap = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  border-radius: 16px;\n  span{\n    width: 300px;\n    height: 88px;\n  }\n  @media(min-width: 480px){\n    span{\n      height: 100px;\n      width: 400px;\n    }\n  }\n"])));
var SkeletonContent = exports.SkeletonContent = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n\n  ", "\n\n  ", "\n\n  @media (min-width: 768px) {\n    ", "\n  }\n"])), function (_ref14) {
  ...
  return !activeOrders && (0, _styledComponents.css)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n      flex-direction: row;\n      align-items: center;\n    "])));
});
var SkeletonText = exports.SkeletonText = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  text-align: left;\n\n  ", "\n\n  @media (max-width: 760px) {\n    ", "\n  }\n"])), function (props) {
  var _props$theme6;
  ...
  return verticalOrders && (0, _styledComponents.css)(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n      width: 100%;\n      padding: 0 10px;\n      box-sizing: border-box;\n    "])));
});
var SkeletonButton = exports.SkeletonButton = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  span{\n    width: 270px;\n    height: 36px;\n  }\n  @media(min-width: 480px){\n    span{\n      width: 360px;\n    }\n  }\n"])));
var SkeletonInformation = exports.SkeletonInformation = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  > *{\n    margin: 5px;\n  }\n\n  ", "\n\n  @media (min-width: 768px) {\n    ", "\n  }\n"])), function (_ref18) {
  var verticalOrders = _ref18.verticalOrders;
  return verticalOrders && (0, _styledComponents.css)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n    flex-direction: column;\n\n    > div:first-child {\n      width: 100%;\n      padding: 0 10px;\n      box-sizing: border-box;\n\n      span {\n        width: 100% !important;\n      }\n    }\n  "])));
}, function (_ref19) {
  var verticalOrders = _ref19.verticalOrders;
  return verticalOrders && (0, _styledComponents.css)(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n      flex-direction: row;\n      width: inherit !important;\n\n      > div:first-child {\n        width: initial;\n        padding: 0;\n        box-sizing: border-box;\n  \n        span {\n          width: 250px !important;\n        }\n      }\n    "])));
});
var SkeletonReorder = exports.SkeletonReorder = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  position: relative;\n  text-align: center;\n  align-items: center;\n  margin-right: 25px;\n\n  ", "\n\n  span:first-child span{\n    width: 40px;\n  }\n\n  span:last-child{\n    width: 75px;\n    height: 30px;\n  }\n\n  @media(min-width: 768px){\n    ", "\n    span:first-child span{\n      width: 80px;\n    }\n    span:last-child{\n      width: 150px;\n    }\n  }\n\n  @media (max-width: 767px) {\n    width: 100%;\n    padding: 0 10px;\n    box-sizing: border-box;\n\n    span:first-child {\n      width: 100%;\n    }\n\n    span:first-child span{\n      width: 60%;\n    }\n  \n    span:last-child{\n      width: 100%;\n    }\n  }\n"])), function (props) {
  var _props$theme7;
...
var ImageNotFound = exports.ImageNotFound = _styledComponents.default.div(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["\n  \n  margin: 0 auto;\n  img{\n    width: 100%\n  }\n"])));
var BusinessInformation = exports.BusinessInformation = _styledComponents.default.div(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral(["\n  display: inline-flex;\n  flex-direction: column;\n  flex: 1;\n  padding-left: 10px;\n  font-size: 0.9em;\n  ", "\n  ", "\n  h2 {\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    overflow: hidden;\n    font-size: 14px;\n    margin-block-end: 0;\n    margin-block-start: 0;\n  }\n  p {\n    margin-block-end: 0.1em;\n    margin-block-start: 0.1em;\n    color : #9A9A9A;\n    white-space: nowrap;\n    font-size: 0.9em;\n    ", "\n  }\n\n  p[name='order_number']{\n    width: 170px;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  }\n\n  p[name='view_order'] {\n    color: ", ";\n    cursor: pointer;\n    text-decoration: none;\n    width: fit-content;\n  }\n\n  @media (min-width: 480px){\n    h2 {\n    font-size: 14px;\n    margin-block-end: 0.1em;\n    margin-block-start: 0.1em;\n    }\n    p{\n      ", "\n    }\n    p[name='order_number']{\n      width: 230px;\n    }\n  }\n\n  @media (min-width: 768px){\n    font-size: 0.9em;\n    p {\n      font-size: 1em;\n    }\n  }\n"])), function (_ref20) {
  ...
  return activeOrders && (0, _styledComponents.css)(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n      font-size: 0.8em;\n    "])));
}, function (props) {
  return props.theme.colors.primary;
}, function (_ref22) {
  var activeOrders = _ref22.activeOrders;
  return activeOrders && (0, _styledComponents.css)(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["\n        font-size: 0.9em;\n      "])));
});