...
var _BusinessesFilter = require("../BusinessesFilter");
...
var FilterBusinessListingUI = function FilterBusinessListingUI(props) {
  var _props$beforeElements, _props$beforeComponen, _businessesList$busin, _orderState$options4, _props$afterComponent, _props$afterElements;

  var onFilterBusinessRedirect = props.onFilterBusinessRedirect,
      orderByValue = props.orderByValue,
      maxDeliveryFee = props.maxDeliveryFee,
      ...
      handleChangeMaxDeliveryFee = props.handleChangeMaxDeliveryFee,
  ...
  var handleMaxDeliveryFee = function handleMaxDeliveryFee(value) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (_props$beforeElements = props.beforeElements) === null || _props$beforeElements === void 0 ? void 0 : _props$beforeElements.map(function (BeforeElement, i) {
  ...
  }), /*#__PURE__*/_react.default.createElement(_styles.Container, null, /*#__PURE__*/_react.default.createElement(_SearchBar.SearchBar, {
    lazyLoad: true,
    isCustomMode: true,
    search: searchValue,
    placeholder: t('SEARCH_BUSINESSES', 'Search Businesses'),
    onSearch: handleOnSearch
  }), !(businessTypeSelected === 'null') && /*#__PURE__*/_react.default.createElement(_BusinessesFilter.BusinessesFilter, {
    isFilterPage: true,
    ...
    totalItems: paginationProps === null || paginationProps === void 0 ? void 0 : paginationProps.totalItems,
    handleChangeSort: handleChangeSort,
    handleMaxDeliveryFee: handleMaxDeliveryFee
  }), /*#__PURE__*/_react.default.createElement(_styles.FilterBusinessList, null, !businessesList.loading && businessesList.businesses.length === 0 && /*#__PURE__*/_react.default.createElement(_NotFoundSource.NotFoundSource, {
  ...
  }, t('CHANGE_ADDRESS', 'Select other Address'))), businessesList.businesses.length > 0 && ((_businessesList$busin = businessesList.businesses) === null || _businessesList$busin === void 0 ? void 0 : _businessesList$busin.map(function (business) {
...
var FilterBusinessesListing = function FilterBusinessesListing(props) {
  var FilterBusinessListingProps = _objectSpread(_objectSpread({}, props), {}, {
    UIComponent: FilterBusinessListingUI
  });

  return /*#__PURE__*/_react.default.createElement(_orderingComponents.BusinessList, FilterBusinessListingProps);
};
