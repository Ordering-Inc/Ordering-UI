...
var WrapperSearch = exports.WrapperSearch = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n\n  ", "\n  width: 100%;\n\n  > div:first-child {\n    ", "\n  }\n\n  .search-bar {\n    margin-right: 10px;\n    ", "\n  }\n\n  div:last-child {\n    text-align: right;\n\n    ", "\n  }\n\n  @media (min-width: 768px) {\n    width: inherit;\n  }\n"])), function (_ref) {
  ...
  return isDelivery && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n    padding-top: 20px;\n  "])));
}, function (props) {
  var _props$theme3;
...
var ProductsNotFound = exports.ProductsNotFound = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  width: 80%;\n  height: calc(100vh - 45px);\n  margin: auto;\n\n  h1 {\n    font-size: 20px;\n    opacity: 0.5;\n    text-align: center;\n  }\n\n  @media (min-width: 411px) {\n    h1 {\n      font-size: 24px;\n    }\n  }\n"])));
var ProductLoading = exports.ProductLoading = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n"])));
var SkeletonItem = exports.SkeletonItem = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  width: 80%;\n  margin: 30px auto;\n\n  span {\n    margin-bottom: 10px;\n  }\n"])));
var WrappLayout = exports.WrappLayout = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  max-width: 1200px;\n  width: 100%;\n  ", "\n"])), function (_ref2) {
...
var ProductsHeader = exports.ProductsHeader = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  align-items: flex-end;\n  margin: 25px 0px 10px 0;\n"])));
var DeliveryInfo = exports.DeliveryInfo = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  border: 1px solid #E7E7E7;\n  box-sizing: border-box;\n  border-radius: 8px;\n  padding: 10px 0;\n  display: flex;\n  width: 45%;\n  max-width: 450px;\n  min-width: 300px;\n  ", "\n  box-sizing: border-box;\n  ", "\n"])), function (_ref3) {
...
var DeliveryTime = exports.DeliveryTime = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 0 30px;\n  width: ", ";\n\n  h2,\n  p {\n    margin: 0px;\n  }\n\n  h2 {\n    font-size: 20px;\n  }\n\n  p {\n    margin-top: 5px;\n    font-size: 14px;\n    color: ", ";\n  }\n"])), function (_ref4) {
  var isDelivery = _ref4.isDelivery;
  return isDelivery ? '50%' : '100%';
}, function (props) {
  return props.theme.colors.darkGray;
});
var DeliveryPrice = exports.DeliveryPrice = (0, _styledComponents.default)(DeliveryTime)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  width: 50%;\n  ", "\n"])), function (props) {
  var _props$theme7;
