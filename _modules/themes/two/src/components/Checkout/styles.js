...
var WrapOrderType = exports.WrapOrderType = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  border-bottom: 1px solid #CCC;\n  padding: 20px 0;\n  \n  h1 {\n    font-size: 20px;\n    margin: 0 0 15px 0;\n    text-transform: uppercase;\n    width: 230px;\n  }\n\n  > div {\n    flex: 1;\n    ", "\n  }\n\n  @media (min-width: 768px) {\n    flex-direction: row;\n\n    h1 {\n      margin: 0px;\n    }\n  }\n"])), function (props) {
  var _props$theme2;
...
var BusinessDetailsContainer = exports.BusinessDetailsContainer = (0, _styledComponents.default)(WrapOrderType)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  p {\n    margin: 3px 0 8px 0;\n  }\n"])));
var PaymentMethodContainer = exports.PaymentMethodContainer = (0, _styledComponents.default)(WrapOrderType)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n"])));
var DriverTipContainer = exports.DriverTipContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid #CCC;\n  padding-bottom: 20px;\n  margin-bottom: 20px;\n  h1 {\n    font-size: 18px;\n    margin: 0 0 10px 0;\n  }\n"])));
var CartContainer = exports.CartContainer = (0, _styledComponents.default)(PaymentMethodContainer)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  border-bottom: none;\n\n  > div {\n    border-bottom: none;\n  }\n"])));
var WrapperPlaceOrderButton = exports.WrapperPlaceOrderButton = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: center;\n  margin: 20px 0px 10px;\n\n  button {\n    width: 100%;\n    padding: 5px 20px;\n    cursor: pointer;\n    box-sizing: border-box;\n\n    &:disabled {\n      opacity: 0.5;\n      cursor: not-allowed;\n    }\n  }\n"])));
var WarningMessage = exports.WarningMessage = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 150px;\n  max-height: 300px;\n  background-color: #F2BB40;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  opacity: 0.8;\n  border-radius: 10px;\n  position: relative;\n\n  svg {\n    position: absolute;\n    font-size: 30px;\n    top: 0;\n    left: 0;\n    margin: 11px;\n    ", "\n  }\n\n  h1 {\n    font-size: 20px;\n    margin: 0px 60px;\n    text-align: center;\n  }\n"])), function (props) {
  var _props$theme3;
...
var NotFoundImage = exports.NotFoundImage = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  max-width: 300px;\n\n  img {\n    width: 300px;\n  }\n"])));
var CartsList = exports.CartsList = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  width: 90%;\n  margin: auto;\n\n  @media (min-width: 381px) {\n    width: 80%;\n  }\n"])));
var WarningText = exports.WarningText = _styledComponents.default.p(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  margin: 10px auto;\n  color: ", ";\n"])), function (props) {
  return props.theme.colors.primary;
});
var WrapBusinessLogo = exports.WrapBusinessLogo = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n"])));
...
var BusinessName = exports.BusinessName = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  ", "\n\n  span:first-child {\n    color: ", ";\n    font-size: 14px;\n    font-weight: 500;\n  }\n  span:last-child {\n    font-weight: 500;\n    font-size: 20px;\n  }\n"])), function (props) {
  var _props$theme4;
...
var CouponContainer = exports.CouponContainer = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin: 10px;\n\n  input {\n    padding: 5px 15px;\n    border-radius: 8px;\n  }\n"])));
var Exclamation = exports.Exclamation = _styledComponents.default.div(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  position: relative;\n  display: inline-flex;\n  cursor: pointer;\n  margin-left: 5px;\n  top: 3px;\n"])));
var Spinner = exports.Spinner = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 0;\n  right: 0;\n  transform: translate(-20%, 15%);\n"])));
var CommentContainer = exports.CommentContainer = _styledComponents.default.td(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  position: relative;\n  .spinner-content > div{\n    width: 50px;\n    height: 50px;\n  }\n"])));