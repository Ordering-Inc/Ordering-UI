...
var OrderTypeWrapper = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  display: flex;\n  padding: 0 10px;\n  border-right: 1px solid ", ";\n  ", "\n  ", "\n  @media (max-width: 576px) {\n    ", "\n  }\n"])), function (props) {
  ...
  var isDeliveryAndPickup = _ref8.isDeliveryAndPickup;
  return isDeliveryAndPickup && (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n      display: none;\n    "])));
});
