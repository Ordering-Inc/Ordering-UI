...
var _VscClose = _interopRequireDefault(require("@meronex/icons/vsc/VscClose"));
...
var AddressListUI = function AddressListUI(props) {
  ...
  var actionStatus = props.actionStatus,
      ...
      isAddAndEdit = props.isAddAndEdit,
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.AddressListContainer, {
  ...
  }, (!isPopover || !addressOpen) && isHome && /*#__PURE__*/_react.default.createElement(_Buttons.Button, {
    className: "add",
    color: "primary",
    ...
    onSaveAddress: handleSaveAddress
  })), isAddAndEdit && /*#__PURE__*/_react.default.createElement(_AddressForm.AddressForm, {
    isAddressEdit: true,
    addressesList: addressList === null || addressList === void 0 ? void 0 : addressList.addresses,
    useValidationFileds: true,
    address: EditAddress,
    onCancel: props.onCancel,
    onSaveAddress: handleSaveAddress
  }), !addressList.loading && !actionStatus.loading && !orderState.loading && !addressList.error && (addressList === null || addressList === void 0 ? void 0 : (_addressList$addresse = addressList.addresses) === null || _addressList$addresse === void 0 ? void 0 : _addressList$addresse.length) > 0 && (!addressOpen && isPopover || isModal) && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("p", null, t('SEARCH_FOR_NEW_ADDRESS', 'Search for a new address')), /*#__PURE__*/_react.default.createElement(_styles.WrapAddressForm, null, /*#__PURE__*/_react.default.createElement(_AddressForm.AddressForm, {
    onlyGoogleAutoComplete: true,
    addressesList: addressList === null || addressList === void 0 ? void 0 : addressList.addresses,
    useValidationFileds: true,
    onCancel: function onCancel() {
      return setAddressOpen(false);
    ...
    onSaveAddress: handleSaveAddress
  })), /*#__PURE__*/_react.default.createElement(_styles.AddressListUl, {
    id: "list"
  ...
  }), (addressList.loading || actionStatus.loading || orderState.loading) && !isProductForm && !isAddAndEdit && /*#__PURE__*/_react.default.createElement(_styles.AddressListUl, null, /*#__PURE__*/_react.default.createElement(_reactLoadingSkeleton.default, {
    height: 50,
    count: 3,
    style: {
      marginBottom: '10px'
