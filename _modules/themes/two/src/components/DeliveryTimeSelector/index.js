...
exports.DeliveryTimeSelector = void 0;
...
var DeliveryTimeSelectorUI = function DeliveryTimeSelectorUI(props) {
  var _orderStatus$options2, _orderStatus$options3, _orderStatus$options4, _configs$format_time;

  var handleAsap = props.handleAsap;
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles.WrapTimeSelect, null, /*#__PURE__*/_react.default.createElement(_styles.Selector, {
    onClick: function onClick() {
      return handleTimeSelect('asap');
    }
  }, timeAsapSelected ? /*#__PURE__*/_react.default.createElement(_MdRadioButtonChecked.default, null) : /*#__PURE__*/_react.default.createElement(_MdRadioButtonUnchecked.default, null), /*#__PURE__*/_react.default.createElement("span", null, t('ASAP', 'ASAP')), /*#__PURE__*/_react.default.createElement(_BsDot.default, null), /*#__PURE__*/_react.default.createElement("span", null, "44 - 55"), /*#__PURE__*/_react.default.createElement("span", null, t('MINS', 'mins'))), /*#__PURE__*/_react.default.createElement(_styles.Selector, {
    onClick: function onClick() {
      return handleTimeSelect('schedule');
    }
  }, scheduleSelected ? /*#__PURE__*/_react.default.createElement(_MdRadioButtonChecked.default, null) : /*#__PURE__*/_react.default.createElement(_MdRadioButtonUnchecked.default, null), /*#__PURE__*/_react.default.createElement("span", null, (_orderStatus$options3 = orderStatus.options) !== null && _orderStatus$options3 !== void 0 && _orderStatus$options3.moment ? parseDate((_orderStatus$options4 = orderStatus.options) === null || _orderStatus$options4 === void 0 ? void 0 : _orderStatus$options4.moment, {
  ...
  }) : t('SCHEDULE_FOR_LATER', 'Schedule for later')))), /*#__PURE__*/_react.default.createElement(_Modal.Modal, {
    width: "70%",
    open: modalOpen,
    ...
    padding: "0"
  }, /*#__PURE__*/_react.default.createElement(_styles.WrapMomentContainer, null, /*#__PURE__*/_react.default.createElement(_MomentContent.MomentContent, null))));
};

var DeliveryTimeSelector = function DeliveryTimeSelector(props) {
...
exports.DeliveryTimeSelector = DeliveryTimeSelector;