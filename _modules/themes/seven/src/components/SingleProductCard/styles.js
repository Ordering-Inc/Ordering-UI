...
var CardLogoStyled = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  box-sizing: border-box;\n  position: relative;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  background-position: center;\n  object-fit: cover;\n  min-height: 75px;\n  width: 130px;\n  height: 130px;\n  \n  @media (min-width: 1024px) {\n    width: 150px;\n    height: 150px;\n  }\n\n  @media (min-width: 1200px) {\n    width: 195px;\n    height: 195px;\n  }\n\n"])));
...
var ProductInfo = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display:flex;\n  flex-direction: column;\n  align-items: center;\n  width: 100%;\n  @media (min-width: 768px) {\n    flex-direction: row;\n    width: 70%;\n    border-right: 2px solid ", ";\n    ", "\n  }\n  @media (min-width: 1440px) {\n    font-size: 20px;\n  }\n\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  var _props$theme4;
...
var CartAction = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  height: 140px;\n  justify-content: space-around;\n  \n  button {\n    padding: 7px 0;\n    text-transform: uppercase;\n    background-color: transparent;\n    @media (min-width: 1440px) {\n      padding: 11px 0;\n    }\n  }\n  @media (min-width: 768px) {\n    width: 30%;\n    padding-left: 15px;\n    ", "\n  }\n  @media (min-width: 1024px) {\n    height: 155px;\n  }\n  @media (min-width: 1200px) {\n    height: 195px;\n  }\n"])), function (props) {
  var _props$theme5;
...
var ProductCost = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  font-weight: bold;\n  font-size: 18px;\n  line-height: 30px;\n  color: ", ";\n  justify-content: ", ";\n  @media (min-width: 1440px) {\n    font-size: 20px;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
}, function (_ref6) {
  var textLeft = _ref6.textLeft;
  return textLeft ? 'flex-start' : 'center';
});

exports.ProductCost = ProductCost;

var Quantity = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-right: ", ";\n  ", "\n  span {\n    font-size: 16px;\n    line-height: 26px;\n    color: #000000;\n  }\n  input {\n    width: 85px;\n    height: 38px;\n    box-sizing: border-box;\n    text-align: center; \n\n    @media (min-width: 768px) {\n      width: 45px;\n      height: 33px;\n    }\n    \n    @media (min-width: 1200px) {\n      width: 85px;\n      height: 38px;\n    }\n  }\n"])), function (_ref7) {
