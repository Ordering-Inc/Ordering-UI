...
var Layout = exports.Layout = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  flex-direction: column-reverse;\n  @media (min-width: 1024px) {\n    flex-direction: row;\n  }\n"])));
var BusinissWrapper = exports.BusinissWrapper = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  width: 100%;\n  @media (min-width: 768px) {\n    display: flex;\n    flex-wrap: wrap;\n  }\n  ", "\n\n  h1 {\n    font-size: 15px;\n    @media (min-width: 1024px) {\n      font-size: 18px;\n    }\n  }\n"])), function (_ref2) {
  var isPickup = _ref2.isPickup;
  return isPickup && (0, _styledComponents.css)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n    @media (min-width: 1024px) {\n      width: 33.3%;\n      height: fit-content;\n      max-height: 100vh;\n      overflow-y: scroll;\n    }\n  "])));
});
var MapWrapper = exports.MapWrapper = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  /* display: none; */\n\n  ", "\n\n"])), function (_ref3) {
...
var NotFoundButtonWrapper = exports.NotFoundButtonWrapper = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  width: fit-content;\n  button {\n    margin: 0 5px;\n  }\n"])));