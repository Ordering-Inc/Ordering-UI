...
var SkeletonSocialWrapper = exports.SkeletonSocialWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 100%;\n  span{\n    border-radius: 0px;\n    margin-bottom: 10px\n  }\n\n  @media (min-width: 768px) {\n    margin-top: 40px;\n  }\n"])));
...
var OtpWrapper = exports.OtpWrapper = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  .otp-container{\n    display: flex;\n    justify-content: space-evenly;\n    margin: 20px;\n    \n    .otp-input{\n      width: 30px;\n      height: 30px;\n      padding: 12px 20px;\n      border: 2px solid #CCC;\n      border-radius: 16px;\n      background-color: #FFF;\n      outline: none;\n      font-size: 20px;\n      font-weight: bold; \n\n      &:focus{\n        border-color: ", " !important;\n      }\n\n      &::placeholder,\n      &::-webkit-input-placeholder {\n        color: #DBDCDB;\n      }\n      &:-ms-input-placeholder {\n        color: #DBDCDB;\n      }\n    }\n  }\n"])), function () {
  return (0, _polished.darken)(0.07, '#CCC');
});
var CountdownTimer = exports.CountdownTimer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-evenly;\n  align-items: center;\n  margin: 20px;\n  \n  span {\n    &:first-child {\n      font-size: 30px;\n      font-weight: bold;\n      color: ", "\n    }\n    &:last-child {\n      font-size: 24px;\n      color: #DBDCDB;\n      cursor: pointer;\n      :hover {\n        color: ", " !important;\n      }\n      :active {\n        color: ", " !important;\n      }\n    }\n  }\n\n"])), function (props) {
...
var FormTitle = exports.FormTitle = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  font-weight: bold;\n  font-size: 20px;\n  line-height: 28px;\n  text-transform: uppercase;\n  color: ", ";\n  margin-top: 10px;\n  @media (min-width: 768px) {\n    font-size: 24px;\n    line-height: 34px;\n    margin-top: 30px;\n    width: 100%;\n  }\n\n  @media (min-width: 1440px) {\n    width: 75%;\n    margin-right: auto;\n    ", "\n  }\n"])), function (props) {
  return props.theme.colors.primary;
}, function (props) {
  var _props$theme2;
...
var FormInline = exports.FormInline = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  position: relative;\n  width: 100%;\n\n  button {\n    width: 100%;\n    padding: 5px;\n    overflow: hidden;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    display: inline-flex;\n    justify-content: center;\n    align-items: center;\n  }\n\n  .forgot {\n    span {\n      color: ", ";\n      width: 100%;\n    }\n\n    a {\n      position: absolute;\n      z-index: 10;\n      opacity: 0;\n      text-decoration: none;\n      width: 100%;\n    }\n  }\n\n  .phone_number {\n    width: 100%;\n  }\n\n  @media (min-width: 768px) {\n    width: 48.6795%;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
var FormBottom = exports.FormBottom = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  justify-content: space-between;\n  padding: 10px 0;\n  border: 1px solid ", ";\n  border-left: none;\n  border-right: none;\n  align-items: center;\n"])), function (props) {
  return props.theme.colors.borderColor;
});
var CreateAccount = exports.CreateAccount = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  position: relative;\n  box-sizing: border-box;\n  a {\n    position: absolute;\n    z-index: 10;\n    width: 100%;\n    height: 100%;\n    opacity: 0;\n  }\n  button {\n    font-size: 16px;\n    line-height: 26px;\n    color: #666666;\n    padding: 11px 14px;\n    border-radius: 0;\n    background-color: transparent;\n  }\n"])));
var FormSubTitle = exports.FormSubTitle = _styledComponents.default.p(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  margin-top: 7px;\n  line-height: 20px;\n"])));