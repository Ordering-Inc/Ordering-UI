...
var ContentInfo = exports.ContentInfo = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  text-transform: capitalize;\n  margin-left: 10px;\n  width: 55%;\n\n  ", "\n\n  h3 {\n    font-size: 14px;\n    line-height: 24px;\n    color: #000000;\n    margin: 0px;\n    font-weight: 600;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    text-transform: uppercase;\n  }\n\n  span {\n    display: flex;\n    justify-content: space-between;\n    margin: 0px;\n\n    p {\n      margin: 0px;\n      font-size: 14px;\n    }\n\n    div {\n      display: flex;\n\n      span {\n        height: 20px;\n        svg {\n          font-size: 20px;\n          &:nth-child(1) {\n            margin-right: 3px;\n            ", "\n          }\n        }\n      }\n    }\n  }\n"])), function (props) {
  var _props$theme2;
...
var AccordionContent = exports.AccordionContent = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  overflow: hidden;\n  transition: max-height 0.6s ease;\n  width: 100%;\n  margin: auto;\n  @media (min-width: 481px) {\n    margin-left: 71px;\n  }\n"])));
var SubOption = exports.SubOption = _styledComponents.default.ul(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  margin: 0;\n  padding: 0;\n  padding-left: 25px;\n"])));
...
var ProductComment = exports.ProductComment = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  p {\n    font-size: 12px;\n    line-height: 22px;\n    color: #666666;\n    margin: 0;\n    margin-top: 10px;\n  }\n\n  span {\n    font-size: 12px;\n    line-height: 22px;\n    color: #666666;\n    margin-left: 25px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme4;
...
var ProductInfo = exports.ProductInfo = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: 100%;\n\n  p {\n    font-size: 20px;\n    margin: 0px 5px;\n  }\n\n  @media (min-width: 411px) {\n    width: 80%;\n  }\n\n  @media (min-width: 481px) {\n    width: 70%;\n  }\n"])));
var ProductError = exports.ProductError = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n\n  span {\n    font-size: 18px;\n    text-align: center;\n  }\n\n  @media (min-width: 411px){\n    width: 35%;\n\n    span{\n      text-align: right;\n    }\n  }\n"])));
var ProductActions = exports.ProductActions = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: flex-end;\n  margin-top: -5px;\n"])));
var ProductActionsEdit = exports.ProductActionsEdit = _styledComponents.default.span(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  svg {\n    font-size: 19px;\n    margin-right: 5px;\n    cursor: pointer;\n    ", "\n  }\n"])), function (props) {
  var _props$theme5;
...
var ProductActionsDelete = exports.ProductActionsDelete = (0, _styledComponents.default)(ProductActionsEdit)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: none;\n  svg {\n    margin-right: 0px;\n  }\n\n  @media (min-width: 411px){\n    display: block;\n  }\n"])));
var ProductPriceSection = exports.ProductPriceSection = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  width: 25%;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n"])));
var ProductPrice = exports.ProductPrice = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: flex-end;\n  padding-bottom: 0px !important;\n\n  p,\n  span {\n    font-size: 14px;\n  }\n\n  span {\n    font-weight: 500;\n  }\n\n  p {\n    margin: 0px 5px;\n  }\n\n  svg {\n    cursor: pointer;\n  }\n\n  @media (min-width: 512px) {\n    span,\n    p {\n      font-size: 18px;\n    }\n  }\n"])));
var ProductSelect = exports.ProductSelect = _styledComponents.default.select(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  max-width: 55px;\n  height: 38px;\n  padding: 0 10px;\n  border: 1px solid ", ";\n  background-color: transparent;\n  font-size: 14px;\n  outline: none;\n  margin-right: 5px;\n  cursor: pointer;\n  -moz-appearance: none;\n  -webkit-appearance: none;\n  -ms-progress-appearance: none;\n\n  background-image: url('https://res.cloudinary.com/dq4bhnmtt/image/upload/q_50/v1613334826/bzydg4yrmrz0hzihtsxs.png');\n  background-repeat: no-repeat, repeat;\n  background-position: right .5em top 50%, 0 0;\n  background-size: .65em auto, 100%;\n\n  ", "\n"])), function (props) {
...
var ProductNotAvailable = exports.ProductNotAvailable = _styledComponents.default.span(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  color: #D81212;\n"])));
var ProductOptionsList = exports.ProductOptionsList = _styledComponents.default.ul(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  list-style-type: none;\n  margin: 0;\n  margin-bottom: 15px;\n  padding: 0;\n\n  p {\n    font-size: 12px;\n    line-height: 22px;\n    color: #666666;\n    margin: 0;\n    margin-top: 10px;\n  }\n\n  li span {\n    font-size: 12px;\n    line-height: 22px;\n    color: #666666;\n  }\n\n  li.ingredient {\n    padding-left: 15px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme7;
...
var ProductQuantity = exports.ProductQuantity = _styledComponents.default.span(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 38px;\n  height: 38px;\n  margin-right: 20px;\n  border: 1px solid ", ";\n  ", "\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  var _props$theme8;
