...
var WrappLayout = exports.WrappLayout = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  @media (min-width: 768px) {\n    display: flex;\n    width: 100vw;\n    min-height: 60vh;\n  }\n\n  ", "\n"])), function (_ref) {
  ...
  return isCartOnProductsList && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n    display: flex;\n    flex-direction: column;\n    width: 100%;\n\n    .bp-list,\n    .cart {\n      width: 100%;\n    }\n\n    @media (min-width: 870px) {\n      flex-direction: row;\n      .bp-list {\n        width: 55%;\n      }\n      .cart {\n        width: calc(45% - 20px);\n        margin-left: 20px;\n      }\n    }\n\n    @media (min-width: 1024px) {\n      .bp-list {\n        width: 60%;\n      }\n      .cart {\n        width: calc(40% - 20px);\n      }\n    }  \n\n    @media (min-width: 1200px) {\n      .bp-list {\n        width: 70%;\n      }\n      .cart {\n        width: calc(30% - 20px);\n      }\n    }  \n  "])));
});
var BusinessProductsCategorieWrapper = exports.BusinessProductsCategorieWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  @media (min-width: 768px) {\n    width: 25%;\n  }\n  @media (min-width: 1200px) {\n    width: 20%;\n  }\n"])));
var CartegoryTitle = exports.CartegoryTitle = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  background-color: ", ";\n  font-size: 20px;\n  line-height: 30px;\n  color: #fff;\n  font-weight: bold;\n  padding: 10px 15px;\n  @media (min-width: 768px) {\n    margin-right: 14px;\n    background-color: ", ";\n    padding-left: 10%;\n    ", "\n  }\n  @media (min-width: 1024px) {\n    padding-left: 15%;\n    ", "\n  }\n"])), function (props) {
...
var AgeConfirmContainer = exports.AgeConfirmContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  background-color: #fff;\n  ", "\n  background-size: cover;\n  background-repeat: no-repeat;\n  background-position: top center;\n  box-shadow: border-box;\n\n  width: 100%;\n  height: 100%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n\n  @media (min-width: 1024px) {\n    height: 40vw;\n  }\n"])), function (_ref2) {
...
var UnderAge = exports.UnderAge = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  h2 {\n    text-align: center;\n    color: #000;\n  }\n"])));
var UnderAgeButtons = exports.UnderAgeButtons = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n\n  button {\n    width: 100px;\n    margin: 0 7px;\n    font-size: 16px;\n    font-weight: bold;\n  }\n"])));
var BreackFastCheckModalContent = exports.BreackFastCheckModalContent = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  padding: 20px;\n"])));
var AgreeButtonWrapper = exports.AgreeButtonWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  margin-top: 10px;\n  button {\n    text-transform: uppercase;\n    padding: 3px;\n    font-size: 14px;\n    width: 100px;\n  }\n"])));