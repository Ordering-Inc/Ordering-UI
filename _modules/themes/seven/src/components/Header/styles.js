...
var OrderTypes = exports.OrderTypes = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  width: 40%;\n  #select-input {\n    height: 40px;\n    padding: 10px 16px;\n    box-sizing: border-box;\n    border: 1px solid #DDDDDD;\n    background-color: #FAFAFA;\n    border-left: none;\n    font-weight: normal;\n    text-transform: capitalize;\n    ", "\n\n    @media (min-width: 1024px) {\n      padding: 6px 10px;\n      display: flex;\n      align-items: center;\n      font-size: 14px;\n      >div {\n        font-size: 14px;\n      }\n    }\n\n    @media (min-width: 1200px) {\n      font-size: 1rem;\n      height: 48px;\n      >div {\n        font-size: 1rem;\n      }\n    }\n  }\n\n  #list {\n    width: 100%;\n    top: 33px;\n      @media (min-width: 1200px) {\n      top: 40px;\n    }\n  } \n\n  @media (min-width: 1200px) {\n    width: unset;\n  }\n"])), function (props) {
  var _props$theme;
...
var OptionsHeader = exports.OptionsHeader = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-left: 10px;\n  ", "\n"])), function (props) {
  var _props$theme2;
...
var Navlinks = exports.Navlinks = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin: 0 20px;\n  a {\n    text-decoration: none;\n    margin: 0 5px;\n    color: #444444;\n    font-size: 1em;\n    &:hover {\n      color: ", ";\n    }\n\n    span.active {\n      color: ", ";\n    }\n\n    @media (min-width: 1200px) {\n      margin: 0 7px;\n      font-weight: bold;\n      font-size: 1.1em;\n    }\n\n    @media (min-width: 1440px) {\n      margin: 0 10px;\n    }\n  }\n\n\n"])), function (props) {
  return props.theme.colors.primary;
}, function (props) {
  return props.theme.colors.primary;
});
var IconLinks = exports.IconLinks = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  span {\n    cursor: pointer;\n  }\n  svg {\n    width: 20px;\n    height: 20px;\n    margin: 0 5px;\n    fill: #444444;\n  }\n"])));
var IconLink = exports.IconLink = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 30px;\n  height: 30px;\n"])));