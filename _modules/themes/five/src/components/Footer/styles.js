...
var SocialGroup = exports.SocialGroup = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  a {\n    color:  #344050;\n    display: flex;\n    align-items: center;\n    margin: 10px 0px 10px 15px;\n    ", "\n    > svg {\n      font-size: 20px;\n    }\n    transition: all 0.3s ease;\n    &:hover {\n      transform: scale(1.04);\n      color: ", ";\n    }\n  }\n"])), function (props) {
  var _props$theme4;
...
var PoweredByOrdering = exports.PoweredByOrdering = _styledComponents.default.p(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  text-align: center;\n  margin: 0;\n  display: flex;\n  justify-content: center;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  white-space: pre;\n  margin-bottom: 10px;\n  a{\n    font-weight: 600;\n  }\n"])));