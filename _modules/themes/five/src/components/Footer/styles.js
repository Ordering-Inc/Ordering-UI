...
var FooterWrapper = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  word-break: break-all;\n  padding: 0px 2px;\n\n  * {\n    font-family: ", " !important;\n  }\n"])), function (_ref) {
  var _theme$fonts, _theme$fonts$primary;
  var theme = _ref.theme;
  return (theme === null || theme === void 0 ? void 0 : (_theme$fonts = theme.fonts) === null || _theme$fonts === void 0 ? void 0 : (_theme$fonts$primary = _theme$fonts.primary) === null || _theme$fonts$primary === void 0 ? void 0 : _theme$fonts$primary.name) + ', sans-serif';
});
