...
var Footer = function Footer() {
  ...
  (0, _react.useEffect)(function () {
    ...
    var socialSharing = (_ref2 = _toConsumableArray(window.document.getElementsByClassName('social-icon'))) !== null && _ref2 !== void 0 ? _ref2 : null;
    var socialMedia = ['facebook', 'instagram', 'twitter'];
    var socialMediaOuterContainers = [];
    var socialMediaContainers = [];
    if (socialSharing) {
      socialSharing.map(function (social) {
    ...
    var handleClick = function handleClick(e) {
      if (socialMediaContainers.includes(e.target) || socialMediaOuterContainers.includes(e.target)) {
        events.emit('social_media_click', {
          social: e.target.ariaLabel
        });
      }
    };
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, footerState.body && /*#__PURE__*/_react.default.createElement(_styles.FooterWrapper, {
