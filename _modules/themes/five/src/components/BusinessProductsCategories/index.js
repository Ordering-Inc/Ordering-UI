...
var BusinessProductsCategoriesUI = function BusinessProductsCategoriesUI(props) {
  ...
  var handlerClickCategory = function handlerClickCategory(category) {
    ...
    var topPos = 0;
    if (category !== null && category !== void 0 && category.id && (category === null || category === void 0 ? void 0 : category.id) !== 'featured') topPos = document.getElementById("category".concat(category.id)).offsetTop;else topPos = document.getElementById('businessProductList').offsetTop;
    window.scrollTo({
      top: topPos - 60,
      left: 100,
      behavior: 'smooth'
