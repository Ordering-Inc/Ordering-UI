...
var BusinessProductsCategoriesUI = function BusinessProductsCategoriesUI(props) {
  ...
  var TabsComponent = function TabsComponent(props) {
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, props.pfchangs ? /*#__PURE__*/_react.default.createElement(_pfchangs.Tabs, props, props.children) : /*#__PURE__*/_react.default.createElement(_Tabs.Tabs, _extends({
      initialWidth: true
