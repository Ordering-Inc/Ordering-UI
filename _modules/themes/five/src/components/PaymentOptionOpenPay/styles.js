...
exports.WarningMessage = exports.Row = exports.OptionStripeContainer = exports.InputContainer = exports.CardItemContent = exports.CardItemActionsWrapper = exports.CardItemActions = exports.CardItem = exports.CardForm = exports.BlockLoading = exports.AddNewCard = exports.ActionsContent = void 0;
...
var OptionStripeContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  ", "\n"])), function (_ref) {
  ...
  return fromProfile && (0, _styledComponents.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    width: 65%;\n  "])));
});
exports.OptionStripeContainer = OptionStripeContainer;
var WarningMessage = _styledComponents.default.p(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  color: #D81212;\n  font-size: 24px;\n  padding-left: 10px;\n  font-weight: bold;\n  opacity: 0.8;\n  ", "\n"])), function (props) {
  var _props$theme;
...
var CardItem = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  padding: 10px 0;\n  border-bottom: 1px solid #EAEAEA;\n  margin-bottom: 10px;\n  ", "\n"])), function (_ref2) {
  ...
  return isCursor && (0, _styledComponents.css)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n    cursor: pointer;\n\n    &:hover {\n      background-color: #F8F9FA;\n    }\n  "])));
});
...
var CardItemActions = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  > span {\n    font-weight: 600;\n    font-size: 12px;\n    color: ", ";\n    margin-right: 20px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme4;
...
var BlockLoading = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin-bottom: 10px;\n"])));
exports.BlockLoading = BlockLoading;
var AddNewCard = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  span {\n    font-size: 14px;\n    color: ", ";\n    cursor: pointer;\n    user-select: none;\n  }\n"])), function (props) {
  var _props$theme6;
...
var CardItemActionsWrapper = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  position: relative;\n  span {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    border-radius: 7.6px;\n    cursor: pointer;\n    width: 26px;\n    height: 24px;\n    transition: all 0.3s;\n  \n    svg {\n      font-size: 20px;\n      color: #212121;\n    }\n\n    &:hover {\n      background: #F8F9FA;\n    }\n  }\n"])));
exports.CardItemActionsWrapper = CardItemActionsWrapper;
var ActionsContent = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  position: absolute;\n  z-index: 10;\n  top: 100%;\n  background: #FFFFFF;\n  border: 1px solid #E9ECEF;\n  box-sizing: border-box;\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n  border-radius: 7.6px;\n  overflow: hidden;\n  ", "\n\n  div {\n    padding: 10px 13px;\n    font-size: 14px;\n    cursor: pointer;\n    white-space: nowrap;\n    transition: all 0.3s;\n    color: ", ";\n\n    &:hover {\n      background: #f8f9fa;\n    }\n\n    &.delete {\n      color: #E63757;\n    }\n  }\n"])), function (props) {
  var _props$theme7;
...
var CardForm = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  *{ \n    box-sizing: border-box;\n  }\n.formDiv {\n  width: 400px;\n  padding: 30px;\n  border-radius: 10px;\n  -webkit-box-shadow: -1px 8px 15px 0px rgba(0, 0, 0, 0.44);\n  -moz-box-shadow: -1px 8px 15px 0px rgba(0, 0, 0, 0.44);\n  box-shadow: -1px 8px 15px 0px rgba(0, 0, 0, 0.44);\n}\n\n  input {\n    box-sizing: border-box;\n    width: 100%;\n    margin: 0px;\n  }\n\n  button {\n    width: 100%;\n    margin-top: 20px;\n  }\n"])));
exports.CardForm = CardForm;
var Row = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  margin: 20px 0;\n"])));
exports.Row = Row;
