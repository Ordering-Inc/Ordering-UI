...
var Title = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  box-sizing: border-box;\n  width: 100%;\n  border-bottom: 1px solid #fff;\n  display: flex;\n  justify-content: flex-start;\n  color: #fff;\n  padding: 15px;\n  h2{\n    font-size: 16px;\n  }\n"])));

exports.Title = Title;

var UserInformationContainer = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  color: #fff;\n  width: 100%;\n  display: flex;\n  flex-direction: row;\n  padding: 15px;\n  box-sizing: border-box;\n  justify-content: space-between;\n  align-items: center;\n  text-align: left;\n  p{\n    margin: 2px 0;\n  }\n  span {\n    color: ", ";\n    cursor: pointer;\n    text-decoration: underline;\n  }\n"])), function (_ref) {
  var _theme$colors;
...
var PhoneContainer = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  height: 30px;\n"])));

exports.PhoneContainer = PhoneContainer;

var CountryFlag = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  margin-right: 5px;\n  .PhoneInputCountryIcon {\n    width: 25px;\n  }\n  .PhoneInputInput {\n    display: none;\n  }\n  .PhoneInputCountrySelect {\n    display: none;\n  }\n"])));

exports.CountryFlag = CountryFlag;

var Info = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n"])));

exports.Info = Info;

var FormContainer = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  box-sizing: border-box;\n  width: 100%;\n  padding: 15px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  form {\n    box-sizing: border;\n  }\n  input.form {\n    padding: 5px;\n    font-size: 14px;\n    width: 100%;\n    margin-bottom: 20px;\n    box-sizing: border-box;\n    &:disabled {\n      background-color: rgba(239, 239, 239, 0.3);\n      cursor: not-allowed;\n    }\n  }\n  @media (min-width: 768px){\n    flex-direction: row;\n    justify-content: center;\n    flex-wrap: wrap;\n  }\n"])));
