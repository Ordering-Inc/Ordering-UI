...
var BusinessMediaContent = exports.BusinessMediaContent = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  padding-bottom: 20px;\n  > div {\n    display: flex;\n    justify-content: flex-start;\n    flex-wrap: wrap;\n\n    > img,\n    > iframe {\n      object-fit: cover;\n      border-radius: 10px;\n      margin: 10px 10px;\n      width: calc(100% - 12px);\n      cursor: pointer;\n\n      @media (min-width: 681px) {\n        width: calc(50% - 20px);\n      }\n\n      @media (min-width: 993px) {\n        width: calc(25% - 20px);\n      }\n    }\n  }\n"])));
var ModalIcon = exports.ModalIcon = _styledComponents.default.span(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  position: absolute;\n  width: 30px;\n  height: 30px;\n  font-size: 30px;\n  cursor: pointer;\n  color: ", ";\n  border-radius: 50%;\n  left: 5px;\n  top: 5px;\n  z-index: 1;\n  ", "\n  @media (min-width: 578px){\n    right: 10px;\n    ", "\n  }\n  @media (min-width: 768px){\n    left: 25px;\n    top: 30px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme4;
...
var Description = exports.Description = _styledComponents.default.p(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  margin: 0 10px;\n"])));
var ImageContainer = exports.ImageContainer = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral([" \n  max-height: 500px;\n  img{\n    width: 100%;\n    height: auto;\n    aspect-ratio: attr(width) / attr(height);\n    border-bottom-left-radius: 10px;\n    border-bottom-right-radius: 10px;\n  }\n"])));
var BusinessTitle = exports.BusinessTitle = _styledComponents.default.h2(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  font-weight: 600;\n  font-size: 24px;\n  color: ", ";\n  text-align: center;\n  margin-top: 0;\n  margin-bottom: 0;\n  padding-left: 30px;\n  padding-top: 25px;\n  ", "\n"])), function (props) {
  return props.theme.colors.darkTextColor;
}, function (props) {
  var _props$theme8;
...
var BusinessAddress = exports.BusinessAddress = _styledComponents.default.p(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  font-size: 14px;\n  color: ", ";\n  margin: 15px 0;\n"])), function (props) {
  return props.theme.colors.darkTextColor;
});
var BusinessAddressNotes = exports.BusinessAddressNotes = _styledComponents.default.p(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  font-size: 14px;\n  color: ", ";\n  margin: 15px 0 25px 0;\n"])), function (props) {
  return props.theme.colors.darkTextColor;
});
