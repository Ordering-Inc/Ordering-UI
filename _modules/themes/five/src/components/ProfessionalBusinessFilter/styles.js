...
var FilterWrapper = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n"])));

exports.FilterWrapper = FilterWrapper;

var FilterItem = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  span {\n    font-weight: 400;\n    font-size: 14px;\n    margin-right: 15px;\n    ", "\n  }\n  input {\n    width: 50px;\n    box-sizing: border-box;\n  }\n  margin-right: 15px;\n  ", "\n\n  @media (min-width: 500px) {\n    input {\n      width: 100px;\n    }\n    margin-right: 25px;\n    ", "\n  }\n"])), function (props) {
