...
exports.PaymentMethodsList = exports.PaymentMethodsContainer = exports.PayCardSelected = exports.PayCard = exports.Container = exports.CardItemContent = void 0;
...
var PayCard = exports.PayCard = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  width: calc(50% - 30px);\n  cursor: pointer;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  margin: 15px;\n  text-align: center;\n\n  ", "\n\n  > div {\n    max-width: 88px;\n    width: 100%;\n    border: 1px solid #DEE2E6;\n    border-radius: 7.6px;\n    padding: 15px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    margin-bottom: 12px;\n    box-sizing: border-box;\n\n    > svg {\n      font-size: 25px;\n      path {\n        fill: #DEE2E6;\n      }\n    }\n  }\n\n  p {\n    margin: 0px;\n    font-size: 13px;\n    text-align: center;\n    color: #DEE2E6;\n    white-space: nowrap;\n  }\n\n  @media (min-width: 351px) {\n    width: calc(33% - 30px);\n  }\n\n  @media (min-width: 513px) {\n    width: calc(25% - 30px);\n  }\n\n  @media (min-width: 768px) {\n    width: calc(25% - 30px);\n  }\n\n  @media (min-width: 1200px) {\n    width: calc(20% - 30px);\n  }\n\n  &.active {\n    > div {\n      border: 1px solid ", ";\n      svg path {\n        fill: ", ";\n      }\n    }\n    p {\n      color: ", ";\n    }\n  }\n\n  /* &:not(.active) {\n    border: ", ";\n  } */\n"])), function (props) {
