...
var HeaderItem = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  cursor: pointer;\n  > span {\n    padding: 10px;\n    display: flex;\n    align-items: center;\n    background: ", ";\n    color: #FFFFFF;\n    border-radius: 7.6px;\n\n    span {\n      margin: 0;\n      font-size: 14px;\n      ", " \n    }\n    svg {\n      font-size: 16px;\n    }\n  }\n  button{\n    margin-left: 20px;\n    img {\n      margin-left: ", ";\n      position: relative;\n      top: 2px;\n    }\n  }\n"])), function (props) {
  ...
  var isHideCartText = _ref.isHideCartText;
  return isHideCartText ? '0px' : '4px';
});
...
var CartLength = _styledComponents.default.span(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  padding: 2px 6px 2px 6px;\n  color: #000;\n  background: #fff;\n  border-radius: 50%;\n  margin-left: 5px;\n"])));
