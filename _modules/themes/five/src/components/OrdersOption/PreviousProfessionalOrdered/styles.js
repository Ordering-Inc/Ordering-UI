...
var ProductsList = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: flex;\n  box-sizing: border-box;\n\n  #autoscroll {\n    > div {\n      width: 300px;\n      max-width: 300px;\n    }\n  }\n\n  @media(min-width: 480px){\n    #autoscroll {\n      > div {\n        width: 350px;\n        max-width: 350px;\n      }\n    }\n  }\n"])));

exports.ProductsList = ProductsList;

var ProductsListContainer = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    margin-top: 10px;\n    display: flex;\n    overflow: scroll hidden;\n    ::-webkit-scrollbar {\n      width: 6px;\n      height: 6px;\n    }\n    ", "\n"])), function (_ref) {
