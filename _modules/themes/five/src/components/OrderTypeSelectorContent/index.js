...
var OrderTypeSelectorContentUI = function OrderTypeSelectorContentUI(props) {
  ...
  var orderTypeTitle = function orderTypeTitle(type) {
    var _theme$header2, _theme$header2$compon, _theme$header2$compon2, _theme$header2$compon3, _theme$header2$compon4, _theme$header2$compon5;
    return theme === null || theme === void 0 ? void 0 : (_theme$header2 = theme.header) === null || _theme$header2 === void 0 ? void 0 : (_theme$header2$compon = _theme$header2.components) === null || _theme$header2$compon === void 0 ? void 0 : (_theme$header2$compon2 = _theme$header2$compon.order_types) === null || _theme$header2$compon2 === void 0 ? void 0 : (_theme$header2$compon3 = _theme$header2$compon2.components) === null || _theme$header2$compon3 === void 0 ? void 0 : (_theme$header2$compon4 = _theme$header2$compon3[type]) === null || _theme$header2$compon4 === void 0 ? void 0 : (_theme$header2$compon5 = _theme$header2$compon4.components) === null || _theme$header2$compon5 === void 0 ? void 0 : _theme$header2$compon5.title;
  };
  var orderTypeDescription = function orderTypeDescription(type) {
    var _theme$header3, _theme$header3$compon, _theme$header3$compon2, _theme$header3$compon3, _theme$header3$compon4, _theme$header3$compon5;
    return theme === null || theme === void 0 ? void 0 : (_theme$header3 = theme.header) === null || _theme$header3 === void 0 ? void 0 : (_theme$header3$compon = _theme$header3.components) === null || _theme$header3$compon === void 0 ? void 0 : (_theme$header3$compon2 = _theme$header3$compon.order_types) === null || _theme$header3$compon2 === void 0 ? void 0 : (_theme$header3$compon3 = _theme$header3$compon2.components) === null || _theme$header3$compon3 === void 0 ? void 0 : (_theme$header3$compon4 = _theme$header3$compon3[type]) === null || _theme$header3$compon4 === void 0 ? void 0 : (_theme$header3$compon5 = _theme$header3$compon4.components) === null || _theme$header3$compon5 === void 0 ? void 0 : _theme$header3$compon5.description;
  };
  var orderTypeCallAction = function orderTypeCallAction(type) {
    var _theme$header4, _theme$header4$compon, _theme$header4$compon2, _theme$header4$compon3, _theme$header4$compon4, _theme$header4$compon5;
    return theme === null || theme === void 0 ? void 0 : (_theme$header4 = theme.header) === null || _theme$header4 === void 0 ? void 0 : (_theme$header4$compon = _theme$header4.components) === null || _theme$header4$compon === void 0 ? void 0 : (_theme$header4$compon2 = _theme$header4$compon.order_types) === null || _theme$header4$compon2 === void 0 ? void 0 : (_theme$header4$compon3 = _theme$header4$compon2.components) === null || _theme$header4$compon3 === void 0 ? void 0 : (_theme$header4$compon4 = _theme$header4$compon3[type]) === null || _theme$header4$compon4 === void 0 ? void 0 : (_theme$header4$compon5 = _theme$header4$compon4.components) === null || _theme$header4$compon5 === void 0 ? void 0 : _theme$header4$compon5.call_to_action;
  };
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, /*#__PURE__*/_react.default.createElement(_styles.OrderTypeTitle, null, orderTypeTitle(item === null || item === void 0 ? void 0 : item.text) || item.text), /*#__PURE__*/_react.default.createElement(_styles.OrderTypeDescription, null, orderTypeDescription(item === null || item === void 0 ? void 0 : item.text) || item.description), /*#__PURE__*/_react.default.createElement(_styles.OrderStartWrapper, null, /*#__PURE__*/_react.default.createElement("span", null, orderTypeCallAction(item === null || item === void 0 ? void 0 : item.text) || t('START_MY_ORDER', 'start my order')), /*#__PURE__*/_react.default.createElement(_BsArrowRight.default, null)), /*#__PURE__*/_react.default.createElement(_styles.OrderTypeOverlay, null));
