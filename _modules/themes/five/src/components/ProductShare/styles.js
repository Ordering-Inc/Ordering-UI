...
var ProductCopyURLContainer = exports.ProductCopyURLContainer = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding-top: 30px;\n\n  p {\n    text-align: center;\n    &.name {\n      font-size: 20px;\n      font-weight: 600;\n      line-height: 30px;\n      margin-bottom: 0;\n      margin-top: 15px;\n    }\n\n    &.description {\n      font-size: 14px;\n      line-height: 24px;\n      margin: 0;\n    }\n  }\n\n  button {\n    margin-top: 50px;\n    height: 44px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    min-width: 100px;\n\n    svg {\n      font-size: 24px;\n    }\n  }\n\n  @media (min-width: 768px) {\n    button {\n      width: 100%;\n      margin-top: 115px;\n    }\n  }\n"])));
var ProductImageWrapper = exports.ProductImageWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 95px;\n  height: 95px;\n\n  img {\n    width: 100%;\n    height: 100%;\n    object-fit: contain;\n    box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n    border-radius: 8px;\n  }\n\n  @media (min-width: 768px) {\n    width: 200px;\n    height: 200px;\n  }\n"])));