...
exports.WrapperMap = exports.WrapInput = exports.ViewLocationsContainer = exports.StartOrder = exports.SearchLocationsContainer = exports.OrderTypeSelectorContainer = exports.HeroContainerStyled = exports.HeroContainer = exports.Diviver = exports.DeliveryPickupContainer = exports.ContentWrapper = exports.ContainerResponsiveWrapper = exports.AddressInputContainer = exports.ActiveMapContainer = void 0;
...
var OrderTypeSelectorContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  border-radius: 0px;\n  background-color: transparent;\n\n  button {\n    border-radius: 10px;\n    outline: none;\n    background: none;\n    border: none;\n    cursor: pointer;\n    height: 45px;\n    margin: 10px;\n    background:  ", ";\n  }\n  .seperator {\n    width: 100%;\n    height: 20px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n"])), function (_ref11) {
  var theme = _ref11.theme;
  return theme.colors.gold;
});
exports.OrderTypeSelectorContainer = OrderTypeSelectorContainer;
var AddressInputContainer = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 20px;\n  position: relative;\n  button {\n    height: 46px;\n    margin-left: 10px;\n  }\n  .geolocation-button {\n    position: absolute;\n    top: 30px;\n    right: 10px;\n    width: 25px;\n    height: 25px;\n    cursor: pointer;\n  }\n"])));
exports.AddressInputContainer = AddressInputContainer;
var ViewLocationsContainer = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  margin-top: 20px;\n  width: 100%;\n  display: flex;\n  p {\n    font-size: 18px;\n    cursor: pointer;\n    margin: 0;\n    text-decoration: underline;\n  }\n  button { \n    width: 100%;\n  }\n"])));
exports.ViewLocationsContainer = ViewLocationsContainer;
var Diviver = _styledComponents.default.hr(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  background-color: rgb(230, 230, 230);\n  display: block;\n  height: 1px;\n  margin: 24px 0px;\n"])));
...
var ActiveMapContainer = _styledComponents.default.span(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  background: rgba(0,0,0,0.4);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  button {\n    width: 60%;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height: auto;\n    font-size: 16px;\n    font-weight: bold;\n  }\n  svg {\n    margin-right: 20px;\n    width: 30px;\n    height: 30px;\n  }\n  p{\n    margin-top: 21px;\n  }\n\n  @media (min-width: 1024px){\n    button{ \n      width: 40%;\n      font-size: 18px;\n    }\n  }\n"])));
exports.ActiveMapContainer = ActiveMapContainer;
var ContainerResponsiveWrapper = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  padding: 20px;\n  p {\n    color: #fff;\n  }\n"])));
exports.ContainerResponsiveWrapper = ContainerResponsiveWrapper;
var StartOrder = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  margin-top: 10px;\n  button {\n    width: 100%;\n  }\n"])));
