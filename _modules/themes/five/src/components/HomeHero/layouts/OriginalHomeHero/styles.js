...
var UseAccount = exports.UseAccount = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  position: absolute;\n  left: 0;\n  width: 100%;\n  min-height: 30vh;\n  padding: 10vw;\n  box-sizing: border-box;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n\n  > button {\n    width: 100%;\n    padding-top: 10px;\n    padding-bottom: 10px;\n    font-size: 14px;\n    line-height: 24px;\n  }\n\n  > *:last-child {\n    margin-top: 14px;\n    background-color: #E9F2FE;\n    color: ", ";\n  }\n\n  @media (min-width: 576px) {\n    display: none;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
var SectionHeader = exports.SectionHeader = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  font-size: 24px;\n  font-weight: 600;\n  line-height: 30px;\n  color: #344050;\n  margin: 0;\n  margin-bottom: 27px;\n  width: 100%;\n"])));
var LogoWrapper = exports.LogoWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  width: 150px;\n  margin: 53px auto;\n  display: flex;\n  justify-content: center;\n  img {\n    width: 100%;\n    object-fit: fill;\n  }\n"])));
var HeroContent = exports.HeroContent = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  button{\n    font-size: 12px;\n    line-height: 18px;\n    padding: 10px 16px;\n    margin-bottom: 45px;\n    white-space: nowrap;\n\n    @media (min-width: 576px) {\n      padding-top: 5px;\n      padding-bottom: 5px;\n      font-size: 18px;\n      width: 180px;\n      line-height: initial;\n    }\n  }\n"])));
var PoweredByOrdering = exports.PoweredByOrdering = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  text-align: center;\n  margin-top: 10px;\n  a{\n    font-weight: 600;\n    margin-left: 5px;\n  }\n"])));