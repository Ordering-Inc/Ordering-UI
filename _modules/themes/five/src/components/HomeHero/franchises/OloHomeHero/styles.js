...
var HomeImage = exports.HomeImage = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  width: 65%;\n  height: 100%;\n  background-image: ", ";\n"])), function (_ref2) {
  var bgimage = _ref2.bgimage;
  return "url(".concat(bgimage, ")");
});
var OrderTypeListItemContainer = exports.OrderTypeListItemContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 75px;\n  border-radius: 7.6px;\n  box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.10);\n  padding: 16px;\n  display: flex;\n  box-sizing: border-box;\n  margin-bottom: 15px;\n  cursor: pointer;\n"])));
var OrderTypeTitle = exports.OrderTypeTitle = _styledComponents.default.p(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  font-size: 16px;\n  box-sizing: border-box;\n"])));
var IconTypeButton = exports.IconTypeButton = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 44px;\n  height: 44px;\n  background: ", ";\n  border-radius: 44px;\n  margin-right: 30px;\n"])), function (_ref3) {
  var _theme$colors;
