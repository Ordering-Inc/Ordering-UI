...
var ProductPriceSection = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  width: 25%;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n\n  span {\n    white-space: nowrap;\n  }\n"])));
exports.ProductPriceSection = ProductPriceSection;
var ProductPrice = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: flex-end;\n\n  p,\n  span {\n    font-size: 14px;\n  }\n\n  span {\n    font-weight: 500;\n  }\n\n  p {\n    margin: 0px 5px;\n  }\n\n  svg {\n    cursor: pointer;\n  }\n"])));
exports.ProductPrice = ProductPrice;
var ProductSelectWrapper = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  position: relative;\n\n  > svg {\n    font-size: 10px;\n    position: absolute;\n    top: 9px;\n    right: 10px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme8;
...
var ProductSelect = _styledComponents.default.select(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  ", "\n  border-radius: 7.6px;\n  max-width: 35px;\n  height: 25px;\n  border: none;\n  font-size: 12px;\n  outline: none;\n  margin: 0 5px 0 15px;\n  padding: 0 3px;\n  cursor: pointer;\n  -moz-appearance: none;\n  -webkit-appearance: none;\n  -ms-progress-appearance: none;\n\n  ", "\n"])), function (_ref2) {
...
var ProductNotAvailable = _styledComponents.default.span(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  color: #D81212;\n"])));
exports.ProductNotAvailable = ProductNotAvailable;
var ProductOptionsList = _styledComponents.default.ul(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  list-style-type: none;\n\n  .suboption {\n    margin-left: -25px;\n    ", "\n  }\n\n  p:nth-child(1) {\n    margin-bottom: 0;\n  }\n\n  p {\n    font-weight: 400;\n    margin: 0px;\n  }\n\n  li span {\n    font-weight: 300;\n  }\n\n  li.ingredient {\n    padding-left: 15px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme11;
...
var ProductQuantity = _styledComponents.default.span(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  margin: 0 5px;\n"])));
exports.ProductQuantity = ProductQuantity;
var ScheduleInfoWrapper = _styledComponents.default.div(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["\n  width: calc(100% - 65px);\n  box-sizing: border-box;\n  h3 {\n    margin: 0px;\n    font-size: 14px;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  }\n  padding-left: 10px;\n  ", "\n"])), function (props) {
...
var ScheduleInfo = _styledComponents.default.div(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["\n  span {\n    font-weight: 400;\n    font-size: 12px;\n    line-height: 15px;\n    color: ", ";\n  }\n"])), function (props) {
