...
var ProductItemAccordion = function ProductItemAccordion(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.AccordionSection, {
    ...
    readOnlyMode: readOnlyMode
  }, /*#__PURE__*/_react.default.createElement("div", null, product === null || product === void 0 ? void 0 : product.quantity, /*#__PURE__*/_react.default.createElement("h3", {
    onClick: function onClick() {
      return onEditProduct(product);
    }
  }, product.name)), /*#__PURE__*/_react.default.createElement(_styles.PriceContainer, null, /*#__PURE__*/_react.default.createElement(_styles.ProductPrice, null, parsePrice(product.total || product.price)), !readOnlyMode && /*#__PURE__*/_react.default.createElement(_MdClose.default, {
    onClick: function onClick() {
      return onDeleteProduct(product);
    },
    disabled: orderState.loading
  }))), /*#__PURE__*/_react.default.createElement(_styles.ProductOptionsContainer, null, productInfo().ingredients.length > 0 && productInfo().ingredients.some(function (ingredient) {
