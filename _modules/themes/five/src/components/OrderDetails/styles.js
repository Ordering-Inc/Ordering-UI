...
var OrderBusiness = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  display: flex;\n  box-sizing: border-box;\n  width: 100%;\n  flex-direction: column;\n  align-items: flex-start;\n  border-radius: 7.6px;\n  padding: 20px;\n  margin-bottom: 20px;\n  box-shadow: 0px 4px 10px 0px #0000001F;\n\n  ", "\n\n  @media (min-width: 769px) {\n    flex-direction: row;\n  }\n"])), function (_ref2) {
  var _theme$layouts, _theme$layouts$confir, _theme$layouts$confir2, _theme$layouts$confir3;

  var theme = _ref2.theme;
  return (theme === null || theme === void 0 ? void 0 : (_theme$layouts = theme.layouts) === null || _theme$layouts === void 0 ? void 0 : (_theme$layouts$confir = _theme$layouts.confirmation) === null || _theme$layouts$confir === void 0 ? void 0 : (_theme$layouts$confir2 = _theme$layouts$confir.components) === null || _theme$layouts$confir2 === void 0 ? void 0 : (_theme$layouts$confir3 = _theme$layouts$confir2.layout) === null || _theme$layouts$confir3 === void 0 ? void 0 : _theme$layouts$confir3.type) === 'pfchangs' && (0, _styledComponents.css)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n    border: 1px solid #fff;\n    padding: 30px;\n  "])));
});

exports.OrderBusiness = OrderBusiness;

var BusinessWrapper = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n\n  ", "\n  ", "\n  img {\n    width: 100px;\n    height: 100px;\n    border-radius: 7.6px;\n    margin-right: 0;\n\n    @media (min-width: 400px) {\n      margin-right: 40px;\n    }\n  }\n\n  @media (min-width: 400px) {\n    flex-direction: row;\n    width: ", ";\n  }\n"])), function (props) {
  return props.borderBottom && (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n    padding-bottom: 15px;\n    border-bottom: 1px solid ", ";\n  "])), function (props) {
    return props.theme.colors.lightGray;
  });
}, function (props) {
  return props.borderTop && (0, _styledComponents.css)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n    margin-top: 15px;\n    border-top: 1px solid ", ";\n  "])), function (props) {
    return props.theme.colors.lightGray;
  });
}, function (props) {
  var _props$w;
...
var BtsOrderStatus = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  margin-top: 20px;\n\n  div + div {\n    margin-left: 0;\n    margin-top: 10px;\n  }\n  @media (min-width: 400px) {\n    flex-direction: row;\n    div + div {\n      margin-left: 30px;\n      margin-top: 0px;\n    }\n  }\n"])));
...
var OrderInfo = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin: 0px 0px 35px;\n  position: relative;\n  h1, p {\n    margin: 0px;\n    color: ", ";\n  }\n  h1 {\n    margin-bottom: 5px;\n    font-weight: 600;\n    font-size: 32px;\n  }\n  p {\n    font-size: 14px;\n    text-overflow: ellipsis;\n    overflow: hidden;\n    white-space: nowrap;\n  }\n\n  .date {\n    margin-bottom: 6px;\n  }\n\n  .types {\n    margin-bottom: 6px;\n    font-size: 16px;\n  }\n\n  .order-status {\n    font-weight: 600;\n    font-size: 16px;\n  }\n\n    \n  ", "\n"])), function (props) {
  ...
  return (theme === null || theme === void 0 ? void 0 : (_theme$layouts2 = theme.layouts) === null || _theme$layouts2 === void 0 ? void 0 : (_theme$layouts2$confi = _theme$layouts2.confirmation) === null || _theme$layouts2$confi === void 0 ? void 0 : (_theme$layouts2$confi2 = _theme$layouts2$confi.components) === null || _theme$layouts2$confi2 === void 0 ? void 0 : (_theme$layouts2$confi3 = _theme$layouts2$confi2.layout) === null || _theme$layouts2$confi3 === void 0 ? void 0 : _theme$layouts2$confi3.type) === 'pfchangs' && (0, _styledComponents.css)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n    border: 1px solid #fff;\n    padding: 30px;\n    box-sizing: border-box;\n  "])));
});

exports.OrderInfo = OrderInfo;

var OrderIdSec = _styledComponents.default.h1(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  font-size: 25px !important;\n  @media (min-width: 350px) {\n    font-size: 32px !important;\n  }\n"])));

exports.OrderIdSec = OrderIdSec;

var ReviewOrderLink = _styledComponents.default.span(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  margin: 0;\n  cursor: pointer;\n  text-decoration-line: underline;\n  user-select: none;\n  ", "\n  ", "\n"])), function (_ref4) {
...
var SectionTitleContainer = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  h2 {\n    font-size: 20px;\n    font-weight: 500;\n    margin: 0px 0px 5px 0px;\n  }\n"])));

exports.SectionTitleContainer = SectionTitleContainer;
var OrderCustomer = (0, _styledComponents.default)(BusinessInfo)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  border-radius: 7.6px;\n  padding: 20px;\n  box-shadow: 0px 4px 10px 0px #0000001F;\n  margin-bottom: 30px;\n\n  ", "\n"])), function (_ref6) {
  var _theme$layouts3, _theme$layouts3$confi, _theme$layouts3$confi2, _theme$layouts3$confi3;

  var theme = _ref6.theme;
  return (theme === null || theme === void 0 ? void 0 : (_theme$layouts3 = theme.layouts) === null || _theme$layouts3 === void 0 ? void 0 : (_theme$layouts3$confi = _theme$layouts3.confirmation) === null || _theme$layouts3$confi === void 0 ? void 0 : (_theme$layouts3$confi2 = _theme$layouts3$confi.components) === null || _theme$layouts3$confi2 === void 0 ? void 0 : (_theme$layouts3$confi3 = _theme$layouts3$confi2.layout) === null || _theme$layouts3$confi3 === void 0 ? void 0 : _theme$layouts3$confi3.type) === 'pfchangs' && (0, _styledComponents.css)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n    border: 1px solid #fff;\n    padding: 30px;\n  "])));
});
exports.OrderCustomer = OrderCustomer;

var PhotoBlock = _styledComponents.default.img(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  border-radius: 7.6px;\n  width: 100px;\n  height: 100px;\n  margin-right: 40px;\n"])));
...
var SkeletonBlock = _styledComponents.default.div(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["\n  width: ", ";\n  border-radius: 16px;\n  margin-bottom: 30px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n"])), function (_ref7) {
...
var SkeletonBlockWrapp = _styledComponents.default.div(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-top: 20px;\n  line-height: 40px;\n"])));

exports.SkeletonBlockWrapp = SkeletonBlockWrapp;

var ShareOrder = _styledComponents.default.div(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["\n  display: flex;\n  margin: 0 0 20px;\n  justify-content: space-between;\n  z-index: 1;\n\n  div.wrap {\n    & > div:first-child {\n      left: 0;\n    }\n    button {\n      border-radius: 7.6px;\n    }\n  }\n  \n  h1 {\n    font-size: 15px;\n    margin: 0px;\n  }\n\n  p {\n    font-size: 13px;\n    margin: 0px;\n  }\n\n  button {\n    display: flex;\n    justify-content: center;\n    position: relative;\n    font-size: 14px;\n    align-items: center;\n    background: ", ";\n\n    svg {\n      left: 0;\n      margin-right: 6px;\n      color: ", ";\n    }\n\n    &:hover {\n      svg {\n        color: #FFFFFF;\n      }\n    }\n  }\n\n  div.text {\n    width: 60%;\n  }\n\n  div.wrap {\n    display: flex;\n    align-items: center;\n\n    & > div:first-child {\n      width: 100%;\n      position: relative;\n      div {\n        right: 0px;\n        left: initial;\n        top: 35px;\n      }\n    }\n  }\n\n  @media (min-width: 1201px) {\n    div.wrap {\n      & > div:first-child {\n        left: 0;\n      }\n    }\n  }\n\n  @media (min-width: 768px) {\n    div.wrap {\n      width: 30%;\n      & > div:first-child {\n        left: 0;\n      }\n    }\n\n    h1 {\n      font-size: 20px;\n    }\n\n    p {\n      font-size: 18px;\n    }\n\n    button {\n      font-size: 18px;\n      width: 100%;\n      svg {\n        position: absolute;\n        margin-left: 10px;\n      }\n    }\n  }\n\n  @media (min-width: 425px) {\n    div.text {\n      width: 70%;\n    }\n\n    h1 {\n      font-size: 18px;\n    }\n\n    p {\n      font-size: 15px;\n    }\n  }\n"])), function (props) {
...
var MessagesIcon = _styledComponents.default.span(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["\n  position: relative;\n  cursor: pointer;\n"])));

exports.MessagesIcon = MessagesIcon;

var ExclamationWrapper = _styledComponents.default.div(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["\n  position: absolute;\n  transform: translate(75%, -25%);\n  svg{\n    font-size: 16px;\n    color: ", "\n  }\n"])), function (props) {
...
var WrapperLeftContainer = _styledComponents.default.div(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["\n  width: 100%;\n  box-sizing: border-box;\n"])));

exports.WrapperLeftContainer = WrapperLeftContainer;
var WrapperRightContainer = (0, _styledComponents.default)(WrapperLeftContainer)(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral([""])));
exports.WrapperRightContainer = WrapperRightContainer;

var Divider = _styledComponents.default.div(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral(["\n  height: 8px;\n  background: #F8F9FA;\n  width: calc(100% + 40px);\n  margin-left: -20px;\n\n  @media(min-width: 769px) {\n    width: calc(100% + 80px);\n    margin-left: -40px;\n  }\n"])));

exports.Divider = Divider;

var MyOrderActions = _styledComponents.default.div(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral([""])));

exports.MyOrderActions = MyOrderActions;

var ReviewWrapper = _styledComponents.default.div(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral(["\n  .review-sent {\n    border-radius: 7.6px;\n  }\n"])));

exports.ReviewWrapper = ReviewWrapper;

var Exclamation = _styledComponents.default.div(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n  position: relative;\n  display: inline-flex;\n  cursor: pointer;\n  margin-left: 5px;\n  top: 3px;\n"])));

exports.Exclamation = Exclamation;

var CommentContainer = _styledComponents.default.div(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["\n  margin: 0;\n  h3 {\n    margin: 0;\n  }\n"])));

exports.CommentContainer = CommentContainer;

var NewOrder = _styledComponents.default.div(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["\n  button {\n    width: 160px;\n  }\n"])));

exports.NewOrder = NewOrder;

var OrderActions = _styledComponents.default.div(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: flex-end;\n  justify-content: space-between;\n"])));

exports.OrderActions = OrderActions;

var TitleContainer = _styledComponents.default.div(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  width: 90%;\n  margin: auto;\n  button {\n    display: flex;\n    align-items: center;\n    font-size: 14px;\n    justify-content: space-around;\n    min-width: 200px;\n    max-height: 53px;\n  }\n  > h1 {\n    text-align: center;\n  }\n  @media (min-width: 650px) {\n    width: 50%;\n  }\n"])));

exports.TitleContainer = TitleContainer;

var ReOrder = _styledComponents.default.div(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 20px;\n  margin-bottom: 20px;\n  flex-direction: column;\n\n  button {\n    padding: 5px 16px;\n    min-width: unset;\n    margin: 5px 5px;\n\n    @media (min-width: 650px) {\n      margin: 0px 5px;\n    }\n  }\n\n  @media (min-width: 650px) {\n    flex-direction: row;\n  }\n"])));

exports.ReOrder = ReOrder;

var BusinessTitle = _styledComponents.default.div(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n"])));

exports.BusinessTitle = BusinessTitle;
var OrderPreferences = (0, _styledComponents.default)(OrderCustomer)(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral([""])));
exports.OrderPreferences = OrderPreferences;

var HeaderTitle = _styledComponents.default.div(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  h1{\n    font-size: 20px;\n    font-weight: 600;\n    margin-bottom: 5px;\n  }\n"])));

exports.HeaderTitle = HeaderTitle;

var PlaceSpotSection = _styledComponents.default.div(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n\n"])));

exports.PlaceSpotSection = PlaceSpotSection;

var OrderStatusAndLinkContainer = _styledComponents.default.div(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n\n  @media (min-width: 450px) {\n    flex-direction: row;\n  }\n"])));

exports.OrderStatusAndLinkContainer = OrderStatusAndLinkContainer;

var LinkWrapper = _styledComponents.default.div(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"])));

exports.LinkWrapper = LinkWrapper;

var OrderHistoryContainer = _styledComponents.default.div(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral([""])));

exports.OrderHistoryContainer = OrderHistoryContainer;

var HistoryItemWrapper = _styledComponents.default.div(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 28px 23px;\n  border-bottom: 1px solid ", ";\n\n  > svg {\n    width: 24px;\n    height: 24px;\n    color: ", ";\n  }\n"])), function (props) {
...
var DetailWrapper = _styledComponents.default.div(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["\n  margin-left: 50px;\n  ", "\n\n  h3 {\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n    margin: 0px;\n  }\n  p {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    margin: 0px;\n  }\n"])), function (props) {
...
var ButtonWrapper = _styledComponents.default.div(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral(["\n  margin-top: 40px;\n  button {\n    width: 100%;\n    height: 44px;\n    position: relative;\n\n    svg {\n      position: absolute;\n      top: 10px;\n      font-size: 22px;\n      right: 16px;\n      ", "\n    }\n  }\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral(["\n        left: 16px;\n        right: initial;\n        transform: rotate(180deg);\n      "])));
});

exports.ButtonWrapper = ButtonWrapper;

var MapWrapper = _styledComponents.default.div(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin-top: 20px;\n\n  @media (min-width: 769px) {\n    width: 50%;\n    margin-top: 0px;\n  }\n"])));

exports.MapWrapper = MapWrapper;

var BusinessExternalWrapper = _styledComponents.default.div(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n\n  @media (min-width: 769px) {\n    width: 50%;\n  }\n"])));
