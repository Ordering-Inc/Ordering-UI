...
var BtsOrderStatus = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: calc(100% - 20px);\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  margin-top: 20px;\n\n  div + div {\n    margin-left: 30px;\n  }\n"])));
...
var OrderInfo = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin: 0px 0px 35px;\n  position: relative;\n  h1, p {\n    margin: 0px;\n    color: ", ";\n  }\n  h1 {\n    margin-bottom: 5px;\n    font-weight: 600;\n    font-size: 32px;\n  }\n  p {\n    font-size: 14px;\n    text-overflow: ellipsis;\n    overflow: hidden;\n    white-space: nowrap;\n  }\n\n  .date {\n    margin-bottom: 6px;\n  }\n\n  .types {\n    margin-bottom: 6px;\n    font-size: 16px;\n  }\n\n  .order-status {\n    font-weight: 600;\n    font-size: 16px;\n  }\n"])), function (props) {
  return props.theme.colors.darkTextColor;
});
...
var LinkWrapper = _styledComponents.default.div(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n"])));

exports.LinkWrapper = LinkWrapper;

var OrderHistoryContainer = _styledComponents.default.div(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral([""])));

exports.OrderHistoryContainer = OrderHistoryContainer;

var HistoryItemWrapper = _styledComponents.default.div(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 28px 23px;\n  border-bottom: 1px solid ", ";\n\n  > svg {\n    width: 24px;\n    height: 24px;\n    color: ", ";\n  }\n"])), function (props) {
...
var DetailWrapper = _styledComponents.default.div(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n  margin-left: 50px;\n  ", "\n\n  h3 {\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n    margin: 0px;\n  }\n  p {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    margin: 0px;\n  }\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["\n    margin-left: 0px;\n    margin-right: 50px;\n  "])));
});

exports.DetailWrapper = DetailWrapper;

var ButtonWrapper = _styledComponents.default.div(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n  margin-top: 40px;\n  button {\n    width: 100%;\n    height: 44px;\n    position: relative;\n\n    svg {\n      position: absolute;\n      top: 10px;\n      font-size: 22px;\n      right: 16px;\n      ", "\n    }\n  }\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n        left: 16px;\n        right: initial;\n        transform: rotate(180deg);\n      "])));
});

exports.ButtonWrapper = ButtonWrapper;

var MapWrapper = _styledComponents.default.div(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin-top: 20px;\n\n  @media (min-width: 769px) {\n    width: 50%;\n    margin-top: 0px;\n  }\n"])));

exports.MapWrapper = MapWrapper;

var BusinessExternalWrapper = _styledComponents.default.div(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n\n  @media (min-width: 769px) {\n    width: 50%;\n  }\n"])));
