...
var ProfessionalWrapper = _styledComponents.default.div(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin: 0px 10px 10px 10px;\n\n  > img {\n    width: 55px;\n    height: 55px;\n    min-width: 55px;\n    border-radius: 8px;\n    object-fit: cover;\n  }\n\n  > svg {\n    width: 55px;\n    height: 55px;\n    min-width: 55px;\n  }\n\n  > p {\n    font-weight: 600;\n    font-size: 17px;\n    line-height: 26px;\n    margin-left: 14px;\n\n    ", "\n  }\n\n  @media (min-width: 411px) {\n    > img {\n      width: 65px;\n      height: 65px;\n      min-width: 65px;\n    }\n    > svg {\n      width: 65px;\n      height: 65px;\n      min-width: 65px;\n    }\n  }\n"])), function (props) {
...
var ProfessionalBlock = _styledComponents.default.div(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n  margin-bottom: 15px;\n"])), function (props) {
