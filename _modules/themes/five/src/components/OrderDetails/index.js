...
var OrderDetailsUI = function OrderDetailsUI(props) {
  ...
  var _useState5 = (0, _react.useState)(true),
    ...
    setIsProductReviewed = _useState6[1]; // set to false to enable product review in order details
  ...
  var _useState25 = (0, _react.useState)(null),
    ...
    dateTimeETA = _useState26[0],
    setDateTimeETA = _useState26[1];
  var _useState27 = (0, _react.useState)(null),
    _useState28 = _slicedToArray(_useState27, 2),
    segmentCustomData = _useState28[0],
    setSegmentCustomData = _useState28[1];
  var statusDelayInfo = JSON.parse(configs.eta_messages_config.value);
  ...
  var handleOpenReview = function handleOpenReview() {
    setSegmentCustomData({
      type: 'Calificar Orden',
      data: {
  ...
  var verifyOrderOnTime = function verifyOrderOnTime() {
    var updated_at = null;
    delayedETA = 0;
    if (order.updated_at) {
    ...
    if (order.updated_at && (order.delivery_type == 1 && statusDelayInfo[order.status].Show_delay_delivery || order.delivery_type == 2 && statusDelayInfo[order.status].Show_delay_pick_up)) {
      ...
      var delayETA = currentTime.getTime() - updated_at.getTime();
  ...
  var getEstimatedDeliveryTime = function getEstimatedDeliveryTime() {
    if (layout === 'pfchangs') {
      var estimatedDeliverytime = new Date(order.delivery_datetime);
      ...
      return setDateTimeETA(order !== null && order !== void 0 && order.delivery_datetime_utc ? parseDate(order === null || order === void 0 ? void 0 : order.delivery_datetime_utc) : parseDate(order === null || order === void 0 ? void 0 : order.delivery_datetime, {
        utc: false
      }));
    }
  };
  var preorderMetafieldEnabled = order === null || order === void 0 ? void 0 : (_order$metafields = order.metafields) === null || _order$metafields === void 0 ? void 0 : (_order$metafields$fin = _order$metafields.find(function (metafield) {
    return metafield.key === 'preorder';
  })) === null || _order$metafields$fin === void 0 ? void 0 : _order$metafields$fin.value;
  var uberDirectPin = Array.isArray(order === null || order === void 0 ? void 0 : order.metafields) && (order === null || order === void 0 ? void 0 : (_order$metafields2 = order.metafields) === null || _order$metafields2 === void 0 ? void 0 : _order$metafields2.find(function (_ref2) {
    var key = _ref2.key;
    return key === 'pin';
  }));
  var externalTrack = Array.isArray(order === null || order === void 0 ? void 0 : order.metafields) && !!(order !== null && order !== void 0 && (_order$metafields3 = order.metafields) !== null && _order$metafields3 !== void 0 && _order$metafields3.find(function (_ref3) {
    var key = _ref3.key;
    return key === 'data_driver';
  })) && JSON.parse(order === null || order === void 0 ? void 0 : (_order$metafields4 = order.metafields) === null || _order$metafields4 === void 0 ? void 0 : _order$metafields4.find(function (_ref4) {
    var key = _ref4.key;
    return key === 'data_driver';
  }).value);
  ...
  (0, _react.useEffect)(function () {
    if (loading) return;
    var intervalETA = setInterval(function () {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.Container, {
    pfchangs: layout === 'pfchangs'
  }, !loading && order && Object.keys(order).length > 0 && !(openMessages.driver || openMessages.business) && /*#__PURE__*/_react.default.createElement(_styles.WrapperContainer, null, /*#__PURE__*/_react.default.createElement(_styles.WrapperLeftContainer, null, /*#__PURE__*/_react.default.createElement(_styles.TrackContainer, null, externalTrack && /*#__PURE__*/_react.default.createElement(_styles.IframeMainContainer, null, /*#__PURE__*/_react.default.createElement(_styles.IframeContainer, null, /*#__PURE__*/_react.default.createElement("iframe", {
  ...
  }))), /*#__PURE__*/_react.default.createElement(_styles.BlockContainer, {
    ...
    className: "date"
  }, dateTimeETA), uberDirectPin && /*#__PURE__*/_react.default.createElement("p", {
    className: "types"
  }, t('UBER_PIN', 'Pin'), ": ", uberDirectPin === null || uberDirectPin === void 0 ? void 0 : uberDirectPin.value), preorderMetafieldEnabled && /*#__PURE__*/_react.default.createElement("p", {
    className: "types"
  }, t('DISCLAIMER_CATERING', 'Disclaimer Catering')), (acceptedStatus.includes(parseInt(order === null || order === void 0 ? void 0 : order.status, 10)) || !layout.includes(defaultLayoutThemes)) && /*#__PURE__*/_react.default.createElement(_styles.ReOrder, null, /*#__PURE__*/_react.default.createElement(ButtonComponent, {
    color: "primary",
    outline: true,
    onClick: function onClick() {
    ...
    disabled: reorderState === null || reorderState === void 0 ? void 0 : reorderState.loading
  }, reorderState !== null && reorderState !== void 0 && reorderState.loading ? t('LOADING', 'Loading...') : t('REORDER', 'Reorder')))), showDeliveryProgress && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, !externalTrack && /*#__PURE__*/_react.default.createElement(_styles.StatusBar, {
