...
var OrderProgressUI = function OrderProgressUI(props) {
  ...
  var convertDiffToHours = function convertDiffToHours(time, order) {
    ...
    var returnedDate = (0, _moment.default)(deliveryTime).add(result, 'minutes').format('hh:mm A');
    return returnedDate;
  };
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (orderList === null || orderList === void 0 ? void 0 : orderList.loading) && /*#__PURE__*/_react.default.createElement(_reactLoadingSkeleton.default, {
    ...
    }), /*#__PURE__*/_react.default.createElement(_styles.ProgressDescriptionWrapper, null, /*#__PURE__*/_react.default.createElement("h2", null, t('ORDER_IN_PROGRESS', 'Order in progress')), /*#__PURE__*/_react.default.createElement("p", null, ('RESTAURANT_PREPARING_YOUR_ORDER', 'The restaurant is preparing your order')))), /*#__PURE__*/_react.default.createElement(_styles.ProgressBarWrapper, null, /*#__PURE__*/_react.default.createElement(_styles.ProgressContentWrapper, null, /*#__PURE__*/_react.default.createElement(_styles.ProgressBar, null)), /*#__PURE__*/_react.default.createElement(_styles.ProgressTextWrapper, null, /*#__PURE__*/_react.default.createElement(_styles.StatusWrapper, null, getOrderStatus(order.status).value), /*#__PURE__*/_react.default.createElement(_styles.TimeWrapper, null, t('ESTIMATED_DELIVERY', 'Estimated delivery'), ":", order !== null && order !== void 0 && order.delivery_datetime_utc ? parseTime(order === null || order === void 0 ? void 0 : order.delivery_datetime_utc, {
