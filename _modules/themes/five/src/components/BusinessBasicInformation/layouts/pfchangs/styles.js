...
var BusinessContainer = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n  position: relative;\n  max-height: 400px;\n  height: 400px;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  object-fit: cover;\n  background-position: center;\n  min-height: 200px;\n  justify-content: center;\n  align-items: flex-end;\n  border-radius: 0;\n  position: absolute;\n  left: 0;\n  border-bottom: 1px solid #fff;\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n  @media (min-width: 490px) {\n    justify-content: flex-start;\n  }\n"])), function (props) {
  ...
  return !props.bgimage && (0, _styledComponents.css)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n    display: none;\n  "])));
});
exports.BusinessContainer = BusinessContainer;
var DeliveryPickupContainer = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  margin-top: 20px;\n  display: flex;\n  position: relative;\n  flex-direction: row-reverse;\n  border-radius: 0px;\n  border: 1px solid ", ";\n  height: 52px;\n  background-color: transparent;\n  width: 300px;\n  margin-bottom: 10px;\n  button {\n    outline: none;\n    background: none;\n    border: none;\n    cursor: pointer;\n    width: 100%;\n    z-index: 1;\n  }\n\n  &::after {\n    ", "\n"])), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.gold;
}, function (_ref3) {
  var orderTypeSelected = _ref3.orderTypeSelected;
  return orderTypeSelected === 1 ? (0, _styledComponents.css)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n      content: \"\";\n      background:  ", ";\n      position: absolute;\n      transition: all 0.2s linear 0s;\n      left: 6px;\n      bottom: 5px;\n      height: calc(100% - 10px);\n      width: calc(50% - 6px);\n    "])), function (_ref4) {
