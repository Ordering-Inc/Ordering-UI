...
var MomentControlUI = function MomentControlUI(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!scheduleList) {
      _timeLists = hoursList.filter(function (hour) {
        return (0, _moment.default)(addHours(cateringHours || 3)) < (0, _moment.default)(dateSelected + " ".concat(hour.startTime)) || !hasCateringProducts;
      }).map(function (hour) {
        return {
  ...
  (0, _react.useEffect)(function () {
    handleCheckBoxChange(hasCateringProducts ? null : true); // hasCateringProducts ? null : isAsap
