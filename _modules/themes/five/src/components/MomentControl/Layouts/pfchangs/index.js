...
var MomentControlUI = function MomentControlUI(props) {
  ...
  var asapText = "".concat(t('CHECKOUT_ASAP', 'ASAP'), " (").concat((0, _moment.default)(new Date()).format('LLLL'), " - ").concat(t('DELIVERY_TIME', 'delivery time'));
  var momentOptions = [{
    value: true,
    content: asapText,
    showOnSelected: asapText
  }, {
    value: null,
    content: t('SCHEDULE_FOR_LATER', 'Schedule for later'),
    showOnSelected: t('SCHEDULE_FOR_LATER', 'Schedule for later')
  }];
  ...
  var addHours = function addHours(numOfHours) {
    var date = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new Date();
    var dateCopy = new Date(date.getTime());
    dateCopy.setTime(dateCopy.getTime() + numOfHours * 60 * 60 * 1000); // return hours and minutes
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!scheduleList) {
      _timeLists = hoursList.filter(function (hour) {
        return (0, _moment.default)(addHours(3)) < (0, _moment.default)(dateSelected + " ".concat(hour.startTime)) || !hasCateringProducts;
      }).map(function (hour) {
        return {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    id: "moment_control"
  }, !isAppoint && /*#__PURE__*/_react.default.createElement(_styles.SelectContainer, null, /*#__PURE__*/_react.default.createElement(_Select.Select, {
