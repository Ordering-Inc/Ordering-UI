...
exports.WrapperDriverPhoto = exports.ReviewsProgressWrapper = exports.ReviewsProgressContent = exports.ReviewsProgressBar = exports.ReviewsMarkPoint = exports.ReviewProfessionalContainer = exports.LogoAndReviewWrapper = exports.DriverPhoto = exports.DriverInfoBlock = exports.CommentsList = exports.Comments = exports.CommentButton = exports.ActionBtnWrapper = void 0;
...
var ReviewProfessionalContainer = exports.ReviewProfessionalContainer = _styledComponents.default.form(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  width: 100%;\n"])));
...
var ActionBtnWrapper = exports.ActionBtnWrapper = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  margin-top: 30px;\n  width: 100%;\n\n  button {\n    font-size: 14px;\n    padding: 6px 20px;\n    width: 100%;\n  }\n"])));
...
var DriverPhoto = exports.DriverPhoto = function DriverPhoto(props) {
  var style = {};
  if (props.bgimage) {
...
var WrapperDriverPhoto = exports.WrapperDriverPhoto = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  align-self: center;\n  width: 124px;\n  height: 124px;\n  min-height: 124px;\n  max-width: 124px;\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n  border-radius: 7.6px;\n\n  svg {\n    width: 124px;\n    height: 124px;\n  }\n"])));
...
var ReviewsProgressBar = exports.ReviewsProgressBar = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  height: 6px;\n  border-radius: 50px;\n  background: #344050;\n  transition: all 0.2s linear;\n"])));
var ReviewsMarkPoint = exports.ReviewsMarkPoint = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 15px;\n  font-size: 12px;\n  color: #CED4DA;\n  cursor: pointer;\n\n  ", "\n\n  &.mark-point {\n    span {\n      position: relative;\n      margin-left: -50%;\n      ", "\n\n      > span {\n        position: absolute;\n        height: 6px;\n        top: -15px;\n        width: 2px;\n        background: #CED4DA;\n        transition: all 0.3s;\n      }\n    }\n  }\n\n  ", "\n"])), function (_ref) {
  ...
  var pass = _ref2.pass;
  return pass && (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n    span {\n      > span {\n        background: transparent !important;\n      }\n    }\n  "])));
});
var LogoAndReviewWrapper = exports.LogoAndReviewWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n"])));
...
var DriverInfoBlock = exports.DriverInfoBlock = _styledComponents.default.p(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  margin-top: 16px;\n  margin-bottom: 0;\n  font-size: 14px;\n  text-align: center;\n  color: #344050;\n"])));
var CommentButton = exports.CommentButton = (0, _styledComponents.default)(_Buttons.Button)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  border-radius: 50px;\n  margin-bottom: 18px;\n  margin-right: 18px;\n  font-size: 13px;\n  color: #414954;\n  background: #E9ECEF;\n  border: 1px solid #E9ECEF;\n  transition: all 0.3s linear;\n\n  ", "\n\n  svg {\n    vertical-align: middle;\n    margin-left: 5px;\n\n    ", "\n  }\n\n  ", "\n"])), function (props) {
  ...
  var _props$theme8;
  return ((_props$theme8 = props.theme) === null || _props$theme8 === void 0 ? void 0 : _props$theme8.rtl) && (0, _styledComponents.css)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n      margin-right: 5px;\n      margin-left: 0;\n    "])));
}, function (_ref3) {
