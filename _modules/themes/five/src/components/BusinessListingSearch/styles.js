...
var ProgressBar = exports.ProgressBar = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  height: 4px;\n  border-radius: 50px;\n  background: #344050;\n"])));
var MaxItemContainer = exports.MaxItemContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n"])));
var BusinessList = exports.BusinessList = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  box-sizing: border-box;\n  align-items: center;\n  ", "\n  @media (min-width: 480px){\n    flex-direction: row;\n  }\n  #searchlist {\n    > div {\n      width: calc(100vw - 40px);\n      min-width: calc(100vw - 40px);\n\n      @media (min-width: 681px) {\n        width: calc(50vw - 40px);\n        min-width: calc(50vw - 40px);\n      }\n      @media (min-width: 993px) {\n        width: calc(33vw - 40px);\n        min-width: calc(33vw - 40px);\n      }\n      @media (min-width: 1200px) {\n        width: calc(25vw - 40px);\n        min-width: calc(25vw - 40px);\n      }\n    }\n  }\n"])), function (_ref) {
  var noResults = _ref.noResults;
  return noResults && (0, _styledComponents.css)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n    justify-content: center;\n  "])));
});
var MaxItem = exports.MaxItem = _styledComponents.default.p(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  margin-top: 0;\n  font-size: 14px;\n  font-weight: ", ";\n"])), function (_ref2) {
  var active = _ref2.active;
  return active ? '600' : '400';
});
var SortItem = exports.SortItem = _styledComponents.default.p(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  font-size: 14px;\n  font-weight: ", ";\n"])), function (_ref3) {
  var active = _ref3.active;
  return active ? '600' : '400';
});
var ProductsList = exports.ProductsList = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  margin-top: 10px;\n"])));
...
var Metadata = exports.Metadata = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  margin-top: 5px;\n  display: flex;\n  font-weight: 300;\n  font-size: 10px;\n  color: #909BA9;\n  flex-wrap: wrap;\n  ", "\n  p {\n    color: #909BA9;\n    svg {\n      font-size: 7px;\n      min-width: 6px;\n      margin: 0 3px;\n    }\n\n    span {\n      margin-right: 10px;\n      ", "\n    }\n  }\n\n  @media (min-width: 481px) {\n    font-size: 14px;\n  }\n"])), function (_ref4) {
...
var BusinessInfoItem = exports.BusinessInfoItem = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  width: 60%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  font-size: 12px;\n  margin-left: 10px;\n  div {\n    display: flex;\n    p {\n      margin-right: 5px;\n      ", "\n      text-transform: capitalize;\n      display: flex;\n      align-items: center;\n      margin: 0px;\n      overflow: hidden;\n      white-space: nowrap;\n      text-overflow: ellipsis;\n    }\n    p.bold {\n      font-weight: bold;\n    }\n  }\n  @media (min-width: 480px) {\n    width: 100%;\n  }\n"])), function (props) {
  var _props$theme2;
...
var SingleBusinessSearch = exports.SingleBusinessSearch = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  margin: 20px 0;\n"])));
var BusinessProductsListContainer = exports.BusinessProductsListContainer = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  box-sizing: border-box;\n\n  .product-card {\n    width: 270px;\n    max-width: 270px;\n  }\n\n  @media(min-width: 480px){\n    .product-card {\n      width: 400px;\n      max-width: 400px;\n    }\n  }\n"])));
...
var BusinessProductsListWrapper = exports.BusinessProductsListWrapper = (0, _styledComponents.default)(BusinessListWrapper)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral([""])));
var BusinessControllerSkeleton = exports.BusinessControllerSkeleton = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  flex-direction: column;\n  > div {\n    flex: 1;\n  }\n  @media (min-width: 681px){\n    flex-direction: row;\n  }\n"])));
var NotFoundWrapper = exports.NotFoundWrapper = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  padding-top: 50px;\n"])));
var BusinessLogoStyled = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 48px;\n  height: 48px;\n  box-sizing: border-box;\n  position: relative;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  object-fit: cover;\n  background-position: center;\n  min-height: 48px;\n  border-radius: 7.6px;\n\n  ", "\n\n  @media (min-width: 681px){\n    min-width: 75px;\n    min-height: 75px;\n    height: 75px;\n    width: 75px;\n    min-height: 75px;\n  }\n\n"])), function (_ref5) {
...
var BusinessName = exports.BusinessName = _styledComponents.default.h6(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  font-weight: 500;\n  margin-block-start: 0;\n  margin-block-end: 0;\n  color: ", ";\n  @media (min-width: 681px){\n    font-size: 16px;\n  }\n"])), function (props) {
  return props.theme.colors.darkTextColor;
});
var BusinessesTitle = exports.BusinessesTitle = _styledComponents.default.h1(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  font-weight: 600;\n  font-size: 24px;\n  color: ", ";\n  margin-bottom: 20px;\n"])), function (props) {
  var _props$theme3;
  return (_props$theme3 = props.theme) === null || _props$theme3 === void 0 ? void 0 : _props$theme3.colors.headingColor;
});
var BrandContainer = exports.BrandContainer = _styledComponents.default.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  > h3 {\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n    margin-top: 0px;\n    margin-bottom: 10px;\n  }\n"])));
var BrandListWrapper = exports.BrandListWrapper = _styledComponents.default.div(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  max-height: 300px;\n  overflow: auto;\n"])));
var BrandItem = exports.BrandItem = _styledComponents.default.div(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  cursor: pointer;\n  margin-bottom: 8px;\n\n  span {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    transition: all 0.3s linear;\n  }\n\n  svg {\n    color: ", ";\n    font-size: 16px;\n  }\n  &:hover {\n    span {\n      color: ", ";\n    }\n  }\n"])), function (props) {
  return props.theme.colors.success500;
}, function (props) {
  return props.theme.colors.secundaryContrast;
});
var NoResult = exports.NoResult = _styledComponents.default.div(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["\n  text-align: center;\n"])));
var PriceFilterWrapper = exports.PriceFilterWrapper = _styledComponents.default.div(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral([""])));
var PriceFilterListWrapper = exports.PriceFilterListWrapper = _styledComponents.default.div(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  width: calc(100% + 10px);\n  margin-left: -5px;\n  ", "\n\n  > button {\n    border-radius: 50px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    font-size: 12px;\n    line-height: 24px;\n    margin: 5px;\n\n    svg {\n      margin-left: 5px;\n      font-size: 12px;\n      ", "\n    }\n  }\n"])), function (props) {
...
var PreviouslyOrderedContainer = exports.PreviouslyOrderedContainer = _styledComponents.default.div(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["\n\n"])));
var SearchBarContainer = exports.SearchBarContainer = _styledComponents.default.div(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  svg {\n    font-size: 26px;\n    color: ", ";\n    ", "\n  }\n"])), function (props) {
