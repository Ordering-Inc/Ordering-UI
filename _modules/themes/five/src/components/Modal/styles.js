...
var ModalTitle = exports.ModalTitle = _styledComponents.default.h2(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  font-weight: 600;\n  font-size: 24px;\n  text-align: center;\n  letter-spacing: 0px;\n  color: #010300;\n  opacity: 1;\n  margin: 0px 0px;\n  margin-bottom: 20px;\n  padding-left: 10px;\n  /* text-transform: capitalize; */\n  flex: 1;\n  ", "\n  &::first-letter {\n    text-transform: capitalize;\n  }\n"])), function (props) {
  var _props$theme2;
...
var ModalIcon = exports.ModalIcon = _styledComponents.default.span(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  position: fixed;\n  left: 25px;\n  top: 30px;\n  font-size: 30px;\n  cursor: pointer;\n  z-index: 2;\n  ", "\n  ", "\n  svg{\n    /* background: rgba(255,255,255,0.5); */\n    transition: all .2s ease-in;\n\n    &:hover {\n      background-color: #1507260a;\n\n      > svg {\n        color:  #151b26;\n      }\n    }\n\n    &:active {\n      background-color: ", ";\n    }\n  \n    border-radius: 50%;\n  }\n\n  @media(min-width: 769px){\n    position: absolute;\n  }\n"])), function (props) {
  ...
  return isProductForm && (0, _styledComponents.css)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n    top: 18px;\n  "])));
}, function () {
...
var ModalIconWrapper = exports.ModalIconWrapper = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  background-color: ", ";\n  z-index: 100;\n  height: 70px;\n\n  @media (min-width: 450px) {\n    position: initial;\n    height: initial;\n  }\n"])), function (props) {
