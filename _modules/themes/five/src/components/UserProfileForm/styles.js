...
var UserProfileContainer = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  width: 90%;\n  margin: 25px auto ", ";\n\n  ", "\n  @media (min-width: 768px) {\n    align-items: flex-start;\n    flex-direction: row;\n  }\n"])), function (props) {
  ...
  return fromProfile && (0, _styledComponents.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n    margin: 60px auto 44vh;\n  "])));
});
...
var UserImage = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: center;\n  width: 100%;\n  position: relative;\n\n  ", "\n\n  @media (min-width: 768px){\n    width: auto;\n    align-items: flex-end;\n  }\n"])), function (_ref2) {
  ...
  return (theme === null || theme === void 0 ? void 0 : (_theme$profile = theme.profile) === null || _theme$profile === void 0 ? void 0 : (_theme$profile$compon = _theme$profile.components) === null || _theme$profile$compon === void 0 ? void 0 : (_theme$profile$compon2 = _theme$profile$compon.layout) === null || _theme$profile$compon2 === void 0 ? void 0 : _theme$profile$compon2.type) === 'pfchangs' && (0, _styledComponents.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    display: none;\n  "])));
});
...
var SideForm = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  width: 100%;\n\n  ", "\n  @media (min-width: 768px) {\n    width: 70%;\n    display: flex;\n    align-items: center;\n    margin: 30px 0px 0px 30px;\n    ", "\n  }\n"])), function (_ref3) {
  ...
  return (theme === null || theme === void 0 ? void 0 : (_theme$profile2 = theme.profile) === null || _theme$profile2 === void 0 ? void 0 : (_theme$profile2$compo = _theme$profile2.components) === null || _theme$profile2$compo === void 0 ? void 0 : (_theme$profile2$compo2 = _theme$profile2$compo.layout) === null || _theme$profile2$compo2 === void 0 ? void 0 : _theme$profile2$compo2.type) === 'pfchangs' && (0, _styledComponents.css)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n    background: ", ";\n  "])), function (props) {
...
var Camera = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  position: absolute;\n  left: calc(50% - 12px);\n  bottom: 25px;\n\n  svg {\n    font-size: 25px;\n    color: white;\n  }\n"])));
exports.Camera = Camera;
var UserData = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  width: 100%;\n\n  h1 {\n    font-size: 20px\n  }\n\n  > * {\n    margin: 5px 0;\n    width: 75%;\n  }\n\n  > button {\n    width: auto;\n    background: ", ";\n  }\n\n  @media (min-width: 768px){\n    align-items: flex-start;\n    text-align: left;\n    ", "\n  }\n\n"])), function (props) {
...
var SavedPlaces = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  width: 90%;\n  text-align: center;\n  margin: 0 auto;\n  margin-top: 40px;\n  margin-bottom: 20px;\n\n\n  h1{\n    font-size: 24px;\n    text-align: left;\n    ", "\n    color: ", ";\n  }\n\n  > div{\n    display: flex;\n    flex-direction: column-reverse;\n    align-items: center;\n  }\n\n  button{\n    width: 100%;\n    align-self: center;\n  }\n\n  ", "\n\n  @media (min-width: 768px){\n    width: 90%;\n    margin-top: 40px;\n    h1 {\n      text-align: center;\n    }\n    ul{\n      width: 100%;\n    }\n    button {\n      width: 50%;\n      align-self: flex-end;\n    }\n    ", "\n  }\n\n"])), function (props) {
  var _props$theme3;
  ...
  return (theme === null || theme === void 0 ? void 0 : (_theme$profile4 = theme.profile) === null || _theme$profile4 === void 0 ? void 0 : (_theme$profile4$compo = _theme$profile4.components) === null || _theme$profile4$compo === void 0 ? void 0 : (_theme$profile4$compo2 = _theme$profile4$compo.layout) === null || _theme$profile4$compo2 === void 0 ? void 0 : _theme$profile4$compo2.type) === 'pfchangs' && (0, _styledComponents.css)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n        ul {\n          width: 70%;\n          margin: 30px 0 0 30px;\n        }\n      "])));
});
