...
var SingleOrderCardUI = function SingleOrderCardUI(props) {
  ...
  var order = props.order,
      ...
      deleteFavoriteOrder = props.deleteFavoriteOrder,
      addFavoriteOrder = props.addFavoriteOrder,
  ...
  var handleChangeFavorite = function handleChangeFavorite(order) {
    if (order !== null && order !== void 0 && order.favorite) deleteFavoriteOrder(order.id);else addFavoriteOrder(order.id);
  };
...
var SingleOrderCard = function SingleOrderCard(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_naked.SingleOrderCard, singleOrderCardProps);
};
