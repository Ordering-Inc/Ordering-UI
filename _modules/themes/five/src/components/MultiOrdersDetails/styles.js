...
var OrderSummary = exports.OrderSummary = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  border-radius: 7.6px;\n  border: 1px solid ", ";\n  padding: 30px 25px;\n  background-color: ", ";\n  margin: 50px 0 42px 0;\n\n  table {\n    width: 100%;\n    tr {\n      td {\n        font-size: 14px;\n        line-height: 24px;\n        padding: 4px 0;\n        &:last-child {\n          ", "\n        }\n      }\n    }\n  }\n"])), function (props) {
  return props.theme.colors.gray200;
}, function (props) {
...
var SingleOrderContainer = exports.SingleOrderContainer = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  border-radius: 7.6px;\n  border: 1px solid ", ";\n  padding: 30px 25px;\n  margin-bottom: 66px;\n  p.order-status {\n    font-size: 14px;\n    line-height: 24px;\n    margin: 0;\n  }\n  p.order-total {\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n    margin: 28px 0 0 0;\n    ", "\n  }\n"])), function (props) {
  return props.theme.colors.gray200;
}, function (props) {
  var _props$theme3;
...
var SingleOrderHeader = exports.SingleOrderHeader = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex-direction: column;\n\n  > div {\n    > div {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      @media (min-width: 769px) {\n        flex-direction: row;\n      }\n      p {\n        line-height: 24px;\n        font-size: 14px;\n        margin: 3px 0;\n        &.date {\n          margin: 0 5px;\n        }\n      }\n    }\n  }\n\n  button {\n    height: 43px;\n  }\n\n  @media (min-width: 576px) {\n    flex-direction: row;\n  }\n"])));
var OrderBusinessDetails = exports.OrderBusinessDetails = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  margin: 50px 0;\n"])));
var OrderBusinessWrapper = exports.OrderBusinessWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  @media (min-width: 576px) {\n    flex-direction: row;\n  }\n"])));
var BusinessData = exports.BusinessData = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  margin-top: 10px;\n  p {\n    font-size: 14px;\n    line-height: 21px;\n    margin: 2px 0;\n    &.bold {\n      font-weight: 500;\n    }\n  }\n  @media (min-width: 576px) {\n    margin-top: 0px;\n  }\n"])));
var ActionsBlock = exports.ActionsBlock = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  span {\n    cursor: pointer;\n    font-size: 16px;\n    color: ", ";\n    ", "\n  }\n"])), function (props) {
...
var StatusBar = exports.StatusBar = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  height: 12px;\n  margin-bottom: 12px;\n  background: ", ";\n  ", "\n"])), function (props) {
...
var MessagesIcon = exports.MessagesIcon = _styledComponents.default.span(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  position: relative;\n  cursor: pointer;\n"])));
var ExclamationWrapper = exports.ExclamationWrapper = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  position: absolute;\n  transform: translate(75%, -25%);\n  svg{\n    font-size: 16px;\n    color: ", "\n  }\n"])), function (props) {
  var _props$theme6;
...
var StatusBarContainer = exports.StatusBarContainer = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  margin-top: 10px;\n  p {\n    font-weight: 500;\n    margin-top: 0;\n  }\n"])));