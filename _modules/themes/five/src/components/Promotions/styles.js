...
var PromotionTitle = _styledComponents.default.h1(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  align-self: flex-start;\n"])));
exports.PromotionTitle = PromotionTitle;
var SingleOfferContainer = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  height: 80px;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 20px;\n  p, h2{\n    margin: 0;\n  }\n  h2{\n    font-size: 16px;\n  }\n  p{\n    font-size: 12px;\n    font-weight: 400;\n  }\n\n  button{ \n    height: 45px;\n    font-size: 14px;\n  }\n\n  @media (min-width: 720px){\n    button{\n      font-size: 16px;\n    }\n  }\n"])));
...
var ExpiresAt = _styledComponents.default.p(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  color: #414954;\n"])));
