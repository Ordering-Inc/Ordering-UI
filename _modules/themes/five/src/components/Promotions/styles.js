...
var AvailableBusinesses = exports.AvailableBusinesses = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  white-space: pre;\n  width: 80%;\n  p:nth-child(2){\n    overflow: hidden;\n    text-overflow: ellipsis;\n  }\n"])));
var OfferData = exports.OfferData = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  p{\n    color: #909BA9;\n    margin: 3px;\n    font-size: 14px;\n  }\n"])));
var Code = exports.Code = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  span{\n    color: ", ";\n    font-size: 24px;\n    margin-bottom: 20px;\n  }\n  p{\n    font-size: 16px;\n  }\n"])), function (_ref3) {
  var theme = _ref3.theme;
  return theme.colors.primary;
});
var ValueOfOffer = exports.ValueOfOffer = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  p{\n    font-size: 16px;\n  }\n  span{\n    font-size: 20px;\n  }\n"])));
...
var OfferView = exports.OfferView = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  margin-top: 20px;\n  text-align: center;\n  h2 {\n    font-size: 16px;\n  }\n  @media(min-width: 720px){\n    h2 {\n      font-size: 20px;\n    }\n  }\n"])));