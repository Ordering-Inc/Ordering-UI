...
var SignUpDriverContainer = exports.SignUpDriverContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  ", "\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-direction: column-reverse;\n  padding: 25px 30px 30px;\n\n  > div {\n    width: 100%;\n    max-width: 580px;\n    box-sizing: border-box;\n  }\n\n  @media (min-width: 993px) {\n    flex-direction: row;\n    align-items: center;\n    padding: 120px 130px;\n    > div {\n      width: calc(50% - 12px);\n    }\n  }\n"])), function (_ref) {
  var bgImage = _ref.bgImage;
  return bgImage && (0, _styledComponents.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    background-image: url(", ");\n    background-repeat: no-repeat;\n    background-size: cover;\n    object-fit: cover;\n    background-position: center;\n  "])), bgImage);
});
var SignupDescriptionContainer = exports.SignupDescriptionContainer = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  margin-right: 0;\n  margin-top: 45px;\n\n  @media (min-width: 993px) {\n    margin-right: 24px;\n    margin-top: 0;\n  }\n"])));
var SignupDescriptionTitle = exports.SignupDescriptionTitle = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  font-style: normal;\n  font-weight: 600;\n  font-size: 28px;\n  line-height: 60px;\n  color: ", ";\n\n  @media (min-width: 430px) {\n    font-size: 37px;\n  }\n\n  @media (min-width: 1275px) {\n    font-size: 48px;\n  }\n"])), function (props) {
  return props.theme.colors.colorTextSignForm;
});
var SignupDescriptionContent = exports.SignupDescriptionContent = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  margin-top: 0;\n  font-style: normal;\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 36px;\n  color: ", ";\n\n  @media (min-width: 430px) {\n    font-size: 20px;\n  }\n\n  @media (min-width: 993px) {\n    margin-top: 15px;\n  }\n\n  @media (min-width: 1275px) {\n    font-size: 24px;\n  }\n"])), function (props) {
  return props.theme.colors.colorTextSignForm;
});
...
var WrapperPassword = exports.WrapperPassword = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  position: relative;\n  width: 100%;\n  input{\n    box-sizing: border-box;\n    width: 100%;\n    padding-right: 40px;\n  }\n"])));
var TogglePassword = exports.TogglePassword = _styledComponents.default.span(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  position: absolute;\n  font-weight: 300;\n  padding: 10px 0;\n  color: #333;\n  font-size: 26px;\n  transform: translate(-150%, 10%);\n  max-height: 100%;\n  ", "\n  span{\n    cursor: pointer;\n  }\n"])), function (props) {
  var _props$theme;
...
var TermsConditionWrapper = exports.TermsConditionWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin: 10px 0;\n\n  > label {\n    font-size: 14px;\n    ", "\n\n    > span:first-child {\n      font-weight: 500;\n      ", "\n    }\n\n    > a {\n      color: ", " !important;\n    }\n  }\n\n  @media (min-width: 768px) {\n    > label {\n      font-size: 16px;\n    }\n  }\n"])), function (props) {
  var _props$theme2;
...
var SkeletonWrapper = exports.SkeletonWrapper = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  span{\n    margin: 10px 0;\n    border-radius: 7.6px;\n  }\n"])));
var FormSide = exports.FormSide = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  border-radius: 31px;\n  display: flex;\n  width: 100%;\n  flex-direction: column;\n  align-items: center;\n  margin: auto;\n  padding: 25px 30px 25px;\n\n  > h1 {\n    width: 100%;\n    margin-bottom: 25px;\n    margin-top: 15;\n    font-weight: 500;\n    font-size: 24px;\n  }\n\n  @media (min-width: 769px) {\n    padding: 42px 58px 65px;\n    ", "\n  }\n\n  @media (min-width: 992px) {\n    width: 45%;\n    font-size: ", ";\n  }\n\n  @media (min-width: 1200px){\n    font-size: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.colorTextSignForm;
}, function (_ref2) {
  var isPopup = _ref2.isPopup;
  return isPopup && (0, _styledComponents.css)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n      margin: 20px 0px;\n    "])));
}, function (_ref3) {
...
var SignUpTitle = exports.SignUpTitle = _styledComponents.default.h1(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  margin-top: 0;\n  margin-bottom: 10px !important;\n  font-style: normal;\n  font-weight: 600;\n  font-size: 36px;\n  line-height: 65px;\n  color: ", ";\n"])), function (props) {
