...
var ReviewsProgressContent = exports.ReviewsProgressContent = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  background: #E9ECEF;\n  border-radius: 50px;\n  width: 100%;\n  height: 6px;\n  position: relative;\n  margin-bottom: 30px;\n"])));
var ReviewsProgressBar = exports.ReviewsProgressBar = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  height: 6px;\n  border-radius: 50px;\n  background: #344050;\n  transition: all 0.2s linear;\n"])));
...
var MultiLogosContainer = exports.MultiLogosContainer = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-around;\n"])));