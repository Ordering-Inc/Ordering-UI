...
var BusinessCartContainer = exports.BusinessCartContainer = (0, _styledComponents.default)(BusinessCategoriesContainer)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: none;\n  margin-top: 70px;\n  min-width: 325px;\n  height: fit-content;\n  @media (min-width: 769px) {\n    ", "\n  }\n  @media (min-width: 1000px) and (min-height: 600px) {\n    display: block;\n  }\n"])), function (_ref2) {
  ...
  return isProfessional && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n      margin-top: 0px;\n    "])));
});
...
var ProfessionalFilterWrapper = exports.ProfessionalFilterWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  padding-bottom: 35px;\n  ", "\n"])), function (_ref5) {
  var isTop = _ref5.isTop;
  return isTop && (0, _styledComponents.css)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n    margin-top: 30px;\n  "])));
});
var WrapperSearchAbsolute = exports.WrapperSearchAbsolute = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  position: absolute;\n  right: 5px;\n  top: 0px;\n  display: flex;\n  justify-content: center;\n  align-items: flex-end;\n  width: 40px;\n  height: 52px;\n  background-color: ", ";\n  box-sizing: border-box;\n  padding-bottom: 5px;\n"])), function (props) {
  return props.theme.colors.backgroundPage;
});
var NearBusiness = exports.NearBusiness = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  width: 100%;\n"])));
var PageBannerWrapper = exports.PageBannerWrapper = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  > div {\n    border-radius: 8px;\n  }\n"])));
var BackButton = exports.BackButton = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  button {\n    display: flex;\n    flex-direction: row;\n    align-items: center;\n    svg {\n      margin-right: 10px;\n    }\n  }\n"])));