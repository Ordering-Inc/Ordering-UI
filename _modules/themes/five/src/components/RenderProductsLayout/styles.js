...
var MobileCartViewWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  position: fixed;\n  width: 100vw;\n  left: 0;\n  bottom: 0;\n  background-color: white;\n  padding: 10px 25px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  box-sizing: border-box;\n  z-index: 1000;\n  box-shadow: 0px 4px 10px rgb(0 0 0 / 12%);\n\n  span {\n    font-weight: 600;\n    font-size: 16px;\n  }\n\n  button {\n    height: 44px;\n    border-radius: 7.6px;\n  }\n"])));
...
var ProfessionalFilterWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  padding-bottom: 35px;\n  ", "\n"])), function (_ref6) {
  var isTop = _ref6.isTop;
  return isTop && (0, _styledComponents.css)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n    margin-top: 30px;\n  "])));
});

exports.ProfessionalFilterWrapper = ProfessionalFilterWrapper;

var WrapperSearchAbsolute = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  position: absolute;\n  right: 5px;\n  top: 0px;\n  display: flex;\n  justify-content: center;\n  align-items: flex-end;\n  width: 40px;\n  height: 52px;\n  background-color: ", ";\n  box-sizing: border-box;\n  padding-bottom: 5px;\n"])), function (props) {
  return props.theme.colors.backgroundPage;
});

exports.WrapperSearchAbsolute = WrapperSearchAbsolute;

var NearBusiness = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  width: 100%;\n"])));
