...
var CancelButton = exports.CancelButton = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  padding: 0 15px;\n  cursor: pointer;\n  font-size: 14px;\n  font-weight: 600;\n"])));
var LogoHeader = exports.LogoHeader = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: none;  \n  @media (min-width: 768px) {\n    cursor: pointer;\n    display: flex;\n  }\n"])));
var BusinessProductsListContainer = exports.BusinessProductsListContainer = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  max-height: calc(100vh - 88px);\n  overflow: auto;\n"])), function (props) {
  return props.theme.colors.backgroundPage;
});
var BusinessProductsListWrapper = exports.BusinessProductsListWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 95%;\n  margin: 0px auto;\n"])));