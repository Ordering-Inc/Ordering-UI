...
var AutoscrollContainer = exports.AutoscrollContainer = _styledComponents.default.span(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: ", ";\n  width: ", ";\n  ", "\n  > svg {\n    background: #D9D9D9;\n    display: inline-block;\n    border-radius: 50%;\n    width: 25px;\n    min-width: 25px;\n    height: 25px;\n    align-self: center;\n    top: ", ";\n    position: sticky;\n    color: #000000;\n    border: 1px solid #D9D9D9;\n    opacity: 0.8;\n  }\n\n  .right-autoscroll{\n    border: 1px solid #CCCCCC;\n    z-index: 100;\n    ", "\n  }\n  .left-autoscroll{\n    border: 1px solid #CCCCCC;\n    z-index: 100;\n    ", "    \n  }\n  svg:active{\n    border: 0\n  }\n  svg.hidden{\n    display: none;\n  }\n\n  @media (min-width: 480px){\n    .right-autoscroll{\n    ", "\n   }\n    .left-autoscroll{\n      ", "\n    }\n  }\n\n  @media (min-width: 768px){\n    width: ", ";\n    display: inherit;\n    ", "\n  }\n\n  @media (min-width: 1024px){\n    .right-autoscroll{\n      ", "\n    }\n      .left-autoscroll{\n        ", "\n    }\n  }\n"])), function (props) {
  ...
  var isColumnMode = _ref.isColumnMode;
  return isColumnMode && (0, _styledComponents.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    flex-direction: column;\n    overflow: hidden;\n    align-items: center;\n  "])));
}, function (props) {
  ...
  return props.modal && (0, _styledComponents.css)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n      .left-autoscroll{\n        opacity: 0;\n      }\n      .right-autoscroll{\n        opacity: 0;\n      }\n    "])));
}, function (props) {
  var _props$theme5;
