...
var Address = _styledComponents.default.p(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  width: 70%;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  margin: 0;\n  font-size: 14px;\n  font-weight: 600;\n"])));
exports.Address = Address;
var SelectStoreContainer = _styledComponents.default.div(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  button{ \n    background: transparent;\n    color: ", ";\n    border-color: ", ";\n    height: 27px;\n    line-height: 0;\n    font-size: 14px;\n    white-space: nowrap;\n    position: relative;\n    bottom: 20px;\n  }\n"])), function (_ref9) {
  var _theme$colors;
...
var FavoriteWrapper = _styledComponents.default.div(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  cursor: pointer;\n  margin-left: 15px;\n  ", "\n\n  svg {\n    font-size: 16px;\n    color: ", ";\n  }\n"])), function (props) {
