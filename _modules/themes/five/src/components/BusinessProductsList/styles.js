...
var DescriptionModalContainer = exports.DescriptionModalContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  padding: 0 10px;\n  img{\n    border-radius: 7.6px;\n    width: 200px;\n    height: 200px;\n    min-width: 200px;\n    min-height: 200px;\n    margin-bottom: 20px;\n  }\n"])));
var DescriptionContainer = exports.DescriptionContainer = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  height: 100%;\n  width: 100%;\n  overflow-y: auto;\n  overflow-x: hidden;\n  div{\n    height: 300px;\n    ::-webkit-scrollbar {\n      width: 6px;\n      height: 6px;\n    }\n  }\n  p{\n    white-space: pre-wrap;\n    overflow-wrap: break-word;\n  }\n"])));
var RibbonBox = exports.RibbonBox = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  padding: 2px 8px;\n  box-sizing: border-box;\n  color: ", ";\n  font-weight: 400;\n  font-size: 10px;\n  line-height: 13px;\n  background-color: ", ";\n  max-width: 200px;\n  display: -webkit-box;\n  -webkit-box-orient: vertical;\n  -webkit-line-clamp: 2;\n  overflow: hidden;\n  margin-left: 5px;\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n"])), function (props) {
  ...
  return bgColor && (0, _styledComponents.css)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n    background-color: ", ";\n  "])), bgColor);
}, function (_ref4) {
  var isRoundRect = _ref4.isRoundRect;
  return isRoundRect && (0, _styledComponents.css)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n    border-radius: 7.6px;\n  "])));
}, function (_ref5) {
  var isCapsule = _ref5.isCapsule;
  return isCapsule && (0, _styledComponents.css)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n    border-radius: 50px;\n  "])));
});
var SubCategoriesContainer = exports.SubCategoriesContainer = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  overflow: auto hidden;\n  margin-top: 10px;\n  width: 100%;\n  ::-webkit-scrollbar {\n      opacity: 0;\n  }\n  @media (min-width: 993px) {\n    width: calc(100% - 30px);\n  }\n"])));
var SubCategoriesInnerContainer = exports.SubCategoriesInnerContainer = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n"])));
var ContainerButton = exports.ContainerButton = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  button {\n    white-space: nowrap;\n    font-size: 14px;\n    display: flex;\n    align-items: center;\n    overflow: hidden;\n    margin-right: 10px;\n    border-radius: 50px;\n\n    svg {\n      margin-left: 5px;\n      font-size: 13px;\n      ", "\n    }\n  }\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n        margin-right: 5px;\n        margin-left: 0px;\n      "])));
});
var SubcategorySearchContainer = exports.SubcategorySearchContainer = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  margin-left: 30px;\n"])));
var PreviouslyOrderedContainer = exports.PreviouslyOrderedContainer = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n    display: flex;\n    overflow: scroll hidden;\n    ::-webkit-scrollbar {\n      width: 0px;\n      height: 0px;\n    }\n"])));
var PreviouslyOrderedWrapper = exports.PreviouslyOrderedWrapper = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  box-sizing: border-box;\n\n  .product-card {\n    width: 270px;\n    max-width: 270px;\n  }\n\n"])));