...
var HightestRated = function HightestRated(props) {
  var highestRatedProps = _objectSpread(_objectSpread({}, props), {}, {
    UIComponent: HighestRatedUI,
    initialOrderByValue: 'rating'
  });

  return /*#__PURE__*/_react.default.createElement(_naked.BusinessList, highestRatedProps);
};

exports.HightestRated = HightestRated;