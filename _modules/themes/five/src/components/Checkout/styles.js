...
exports.WrapperUserDetails = exports.WrapperRightContainer = exports.WrapperPlaceOrderButton = exports.WrapperLeftContent = exports.WrapperLeftContainer = exports.WrapperActionsInput = exports.WarningText = exports.WarningMessage = exports.WalletPaymentOptionContainer = exports.UserDetailsContainer = exports.TitleContainer = exports.SubtitleContainer = exports.SelectSpotContainer = exports.Row = exports.RewardDisclaimerContainer = exports.RewardContainer = exports.RewardBoxContainer = exports.RewardBox = exports.PaymentMethodContainer = exports.PayCardSelected = exports.NotFoundImage = exports.MasterCardCoupon = exports.ItemHeader = exports.InputContainer = exports.IframeMainContainer = exports.IframeContainer = exports.GoToMenu = exports.DriverTipDivider = exports.DriverTipContainer = exports.DeliveryOptionsContainer = exports.Container = exports.ColumnDivider = exports.Column = exports.CheckOutDivider = exports.CartsList = exports.CartHeader = exports.CartContainer = exports.CardItemContent = exports.CardForm = exports.BusinessDetailsContainer = exports.BusinessDetails = exports.BackIcon = void 0;
...
var RewardContainer = _styledComponents.default.div(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n  padding: 0px 10px 25px 10px;\n  text-align: left;\n"])));
exports.RewardContainer = RewardContainer;
var RewardDisclaimerContainer = _styledComponents.default.div(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["\n    font-size: 12px;\n    padding-left: 10px;\n    padding-right: 10px;\n    text-align: center;\n"])));
exports.RewardDisclaimerContainer = RewardDisclaimerContainer;
var RewardBox = _styledComponents.default.div(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["\n  margin: 10px auto;\n  padding: 5px 10px;\n  border-radius: 10px;\n  -webkit-box-shadow: 0px -1px 10px 0px rgb(138 138 138 / 60%);\n  -moz-box-shadow: 0px -1px 10px 0px rgba(138,138,138,0.6);\n  box-shadow: 0px -1px 10px 0px rgb(138 138 138 / 60%);\n  text-align: left;\n  > div {\n    color: #003C4A;\n    font-size: 16px;\n    margin: 7px 0;\n  }\n"])));
exports.RewardBox = RewardBox;
var RewardBoxContainer = _styledComponents.default.div(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n\n  div.image-reward {\n    display: flex;\n  }\n  div.value {\n    font-weight: bold;\n    margin: auto 0px;\n  }\n"])));
exports.RewardBoxContainer = RewardBoxContainer;
var CardForm = _styledComponents.default.div(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["\n  *{\n    box-sizing: border-box;\n  }\n.formDiv {\n  width: 400px;\n  padding: 30px;\n  border-radius: 10px;\n  -webkit-box-shadow: -1px 8px 15px 0px rgba(0, 0, 0, 0.44);\n  -moz-box-shadow: -1px 8px 15px 0px rgba(0, 0, 0, 0.44);\n  box-shadow: -1px 8px 15px 0px rgba(0, 0, 0, 0.44);\n}\n\n  input {\n    box-sizing: border-box;\n    width: 100%;\n    margin: 0px;\n  }\n\n  button {\n    width: 100%;\n    margin-top: 20px;\n  }\n"])));
exports.CardForm = CardForm;
var Row = _styledComponents.default.div(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  margin: 20px 0;\n"])));
exports.Row = Row;
var Column = _styledComponents.default.div(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n"])));
exports.Column = Column;
var InputContainer = _styledComponents.default.div(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["\n  flex: 1;\n  ", "\n  input {\n    border: 1px solid #7D7E7B;\n  }\n  input::placeholder { /* Chrome, Firefox, Opera, Safari 10.1+ */\n    color: #7D7E7B;\n    opacity: 1; /* Firefox */\n  }\n\n  input:-ms-input-placeholder { /* Internet Explorer 10-11 */\n    color: #7D7E7B;\n  }\n\n  input::-ms-input-placeholder { /* Microsoft Edge */\n    color: #7D7E7B;\n  }\n"])), function (_ref28) {
  var isValid = _ref28.isValid,
    showBorder = _ref28.showBorder;
  return showBorder && (0, _styledComponents.css)(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n    ", "\n  "])), isValid ? (0, _styledComponents.css)(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n      -webkit-box-shadow: 1px 1px 1px 1px #0CAD63;\n      -moz-box-shadow: 1px 1px 1px 1px #0CAD63;\n      box-shadow: 1px 1px 1px 1px #0CAD63;\n    "]))) : (0, _styledComponents.css)(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["\n      -webkit-box-shadow: 1px 1px 1px 1px #C90800;\n      -moz-box-shadow: 1px 1px 1px 1px #C90800;\n      box-shadow: 1px 1px 1px 1px #C90800;\n    "]))));
});
exports.InputContainer = InputContainer;
var PayCardSelected = _styledComponents.default.div(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n  padding: 30px 0px 0px;\n"])));
exports.PayCardSelected = PayCardSelected;
var CardItemContent = _styledComponents.default.div(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n  font-weight: bold;\n\n  span {\n    display: flex;\n  }\n\n  .checks svg {\n    color: ", ";\n    font-size: 22px;\n  }\n\n  .brand svg {\n    font-size: 26px;\n  }\n\n  img {\n    max-width: 26px;\n    max-height: 26px;\n  }\n\n  > * {\n    margin-right: 10px\n    ", "\n  }\n"])), function (props) {
  return props.theme.colors.primary;
}, function (props) {
  var _props$theme3;
  return ((_props$theme3 = props.theme) === null || _props$theme3 === void 0 ? void 0 : _props$theme3.rtl) && (0, _styledComponents.css)(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral(["\n      margin-left: 10px;\n      margin-right: 0;\n    "])));
});
exports.CardItemContent = CardItemContent;
var IframeMainContainer = _styledComponents.default.div(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["\n  height: 100vh;\n"])));
exports.IframeMainContainer = IframeMainContainer;
var IframeContainer = _styledComponents.default.div(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral(["\n  height: 100%;\n  width: 100%;\n"])));
