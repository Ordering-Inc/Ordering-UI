...
exports.Row = Row;
var InputContainer = _styledComponents.default.div(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["\n  flex: 1;\n  ", "\n  input {\n    border: 1px solid #7D7E7B;\n  }\n  input::placeholder { /* Chrome, Firefox, Opera, Safari 10.1+ */\n    color: #7D7E7B;\n    opacity: 1; /* Firefox */\n  }\n\n  input:-ms-input-placeholder { /* Internet Explorer 10-11 */\n    color: #7D7E7B;\n  }\n\n  input::-ms-input-placeholder { /* Microsoft Edge */\n    color: #7D7E7B;\n  }\n"])), function (_ref28) {
  var isValid = _ref28.isValid,
    showBorder = _ref28.showBorder;
  return showBorder && (0, _styledComponents.css)(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["\n    ", "\n  "])), isValid ? (0, _styledComponents.css)(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n      -webkit-box-shadow: 1px 1px 1px 1px #0CAD63;\n      -moz-box-shadow: 1px 1px 1px 1px #0CAD63;\n      box-shadow: 1px 1px 1px 1px #0CAD63;\n    "]))) : (0, _styledComponents.css)(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n      -webkit-box-shadow: 1px 1px 1px 1px #C90800;\n      -moz-box-shadow: 1px 1px 1px 1px #C90800;\n      box-shadow: 1px 1px 1px 1px #C90800;\n    "]))));
});
exports.InputContainer = InputContainer;
var PayCardSelected = _styledComponents.default.div(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["\n  padding: 30px 0px 0px;\n"])));
exports.PayCardSelected = PayCardSelected;
var CardItemContent = _styledComponents.default.div(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n  font-weight: bold;\n\n  span {\n    display: flex;\n  }\n\n  .checks svg {\n    color: ", ";\n    font-size: 22px;\n  }\n\n  .brand svg {\n    font-size: 26px;\n  }\n\n  img {\n    max-width: 26px;\n    max-height: 26px;\n  }\n\n  > * {\n    margin-right: 10px\n    ", "\n  }\n"])), function (props) {
  return props.theme.colors.primary;
}, function (props) {
  var _props$theme3;
  return ((_props$theme3 = props.theme) === null || _props$theme3 === void 0 ? void 0 : _props$theme3.rtl) && (0, _styledComponents.css)(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n      margin-left: 10px;\n      margin-right: 0;\n    "])));
});
