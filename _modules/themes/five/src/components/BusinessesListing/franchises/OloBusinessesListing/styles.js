...
var BusinessSearch = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    display: flex;\n    background-color: #f8f9fa;\n    align-items: center;\n    padding: 7px;\n    border-radius: 7px;\n    font-size: 11px;\n    svg {\n      font-size: 15px;\n    }\n"])));
...
var HightestRatedWrapper = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  padding: 50px 0 30px 0;\n"])));
...
var HeaderSearchMode = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  position: absolute;\n  width: 200px;\n"])));
exports.HeaderSearchMode = HeaderSearchMode;
var AddressFormWrapper = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  @media (min-width: 450px) {\n    margin-top: 20px;\n  }\n"])));
exports.AddressFormWrapper = AddressFormWrapper;
var IconTypeButton = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 44px;\n  height: 44px;\n  background: ", ";\n  border-radius: 44px;\n"])), function (_ref) {
  var _theme$colors;
...
var TypesContainer = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  margin-top: 20px;\n"])));
exports.TypesContainer = TypesContainer;
var AdditionalTypesContainer = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  width: 60%;\n  display: flex;\n  margin-bottom: 20px;\n  button {\n    padding: 4px 10px;\n    border-radius: 50px;\n    font-size: 10px;\n    line-height: 0;\n    height: 25px;\n    margin-right: 20px;\n  }\n  .activated {\n    color: ", "\n  }\n"])), function (_ref2) {
  var _theme$colors2;
...
var TypeButton = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: 215px;\n  height: 75px;\n  border-radius: 7.6px;\n  padding: 16px;\n  box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.10);\n  margin-right: 32px;\n  cursor: pointer;\n  box-sizing: border-box;\n  background: ", ";\n  p{\n    margin: 0;\n    margin-left: 33px;\n    ", "\n  }\n"])), function (_ref3) {
...
var Title = _styledComponents.default.h2(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n    font-size: 32px;\n    font-weight: 600;\n    margin: 0;\n    margin-bottom: 20px;\n"])));
exports.Title = Title;
var Subtitle = _styledComponents.default.h3(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n    font-size: 18px;\n    font-weight: 400;\n    margin: 0;\n    margin-bottom: 20px;\n"])));
exports.Subtitle = Subtitle;
var BusinessListContainer = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  width: 50%;\n  padding: 40px 20px 0px 20px;\n  box-sizing: border-box;\n"])));
exports.BusinessListContainer = BusinessListContainer;
var AdditionalTypesWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  padding: 20px;\n  padding-bottom: 0;\n"])));
exports.AdditionalTypesWrapper = AdditionalTypesWrapper;
var WrapInput = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  position: relative;\n  cursor: pointer;\n  background: #FFFFFF;\n  padding: 8px 16px;\n  border: 1px solid #DEE2E6;\n  box-sizing: border-box;\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n  border-radius: 7.6px;\n  display: flex;\n  align-items: center;\n  margin-bottom: 22px;\n  margin-top: 22px;\n  width: 100%;\n  height: 44px;\n  ", "\n\n  p{\n    color: ", ";\n    position: relative;\n    margin: 0;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    font-size: 12px;\n    line-height: 18px;\n    @media (min-width: 576px) {\n      font-size: 1rem;\n      line-height: initial;\n    }\n  }\n\n  svg {\n    color: #B1BCCC;\n    font-size: 20px;\n    ", "\n\n    @media (min-width: 576px) {\n      ", "\n    }\n  }\n"])), function (_ref5) {
...
var PaginationContainer = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  align-self: flex-end;\n  width: 100%;\n  margin-bottom: 20px;\n"])));
...
var CityContainer = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  width: 100%;\n  padding: 20px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border-bottom: 1px solid ", ";;\n  height: 70px;\n  margin: 0;\n  box-sizing: border-box;\n\n  h3{\n    font-size: 16px;\n  }\n  ", "\n"])), function (_ref6) {
  var _theme$colors6;
...
var LoadMoreButtonCityWrap = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  margin-top: 10px;\n  button {\n    width: 100%;\n  }\n"])));
exports.LoadMoreButtonCityWrap = LoadMoreButtonCityWrap;
var ViewLocations = _styledComponents.default.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  p {\n    color: ", ";\n    cursor: pointer;\n  }\n"])), function (_ref8) {
  var _theme$colors7;
  var theme = _ref8.theme;
  return theme === null || theme === void 0 || (_theme$colors7 = theme.colors) === null || _theme$colors7 === void 0 ? void 0 : _theme$colors7.primary;
});
exports.ViewLocations = ViewLocations;
var CitiesContainer = _styledComponents.default.div(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  border-radius: 7.6px;\n  box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.10);\n  > div {\n    cursor: pointer;\n  }\n  margin-bottom: 20px;\n"])));
exports.CitiesContainer = CitiesContainer;
var Separator = _styledComponents.default.div(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  height: 1px;\n  margin-left: 20px;\n  margin-right: 40px;\n  background: #E9ECEF;\n  box-sizing: border-box;\n"])));
