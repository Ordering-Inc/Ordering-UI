...
var IconTypeButton = exports.IconTypeButton = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 44px;\n  height: 44px;\n  background: ", ";\n  border-radius: 44px;\n"])), function (_ref) {
  var _theme$colors;
...
var TypesContainer = exports.TypesContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  margin-top: 20px;\n"])));
var AdditionalTypesContainer = exports.AdditionalTypesContainer = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  width: 60%;\n  display: flex;\n  margin-bottom: 20px;\n  button {\n    padding: 4px 10px;\n    border-radius: 50px;\n    font-size: 10px;\n    line-height: 0;\n    height: 25px;\n    margin-right: 20px;\n  }\n  .activated {\n    color: ", "\n  }\n"])), function (_ref2) {
  var _theme$colors2;
...
var TypeButton = exports.TypeButton = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: 215px;\n  height: 75px;\n  border-radius: 7.6px;\n  padding: 16px;\n  box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.10);\n  margin-right: 32px;\n  cursor: pointer;\n  box-sizing: border-box;\n  background: ", ";\n  p{\n    margin: 0;\n    margin-left: 33px;\n    ", "\n  }\n"])), function (_ref3) {
  ...
  var activated = _ref4.activated,
    theme = _ref4.theme;
  return activated && (0, _styledComponents.css)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n      color: ", ";\n    "])), theme === null || theme === void 0 || (_theme$colors5 = theme.colors) === null || _theme$colors5 === void 0 ? void 0 : _theme$colors5.white);
});
var Title = exports.Title = _styledComponents.default.h2(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n    font-size: 32px;\n    font-weight: 600;\n    margin: 0;\n    margin-bottom: 20px;\n"])));
var Subtitle = exports.Subtitle = _styledComponents.default.h3(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n    font-size: 18px;\n    font-weight: 400;\n    margin: 0;\n    margin-bottom: 20px;\n"])));
...
var AdditionalTypesWrapper = exports.AdditionalTypesWrapper = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  padding: 20px;\n  padding-bottom: 0;\n"])));
var WrapInput = exports.WrapInput = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  position: relative;\n  cursor: pointer;\n  background: #FFFFFF;\n  padding: 8px 16px;\n  border: 1px solid #DEE2E6;\n  box-sizing: border-box;\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n  border-radius: 7.6px;\n  display: flex;\n  align-items: center;\n  margin-bottom: 22px;\n  margin-top: 22px;\n  width: 100%;\n  height: 44px;\n  ", "\n\n  p{\n    color: ", ";\n    position: relative;\n    margin: 0;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    font-size: 12px;\n    line-height: 18px;\n    @media (min-width: 576px) {\n      font-size: 1rem;\n      line-height: initial;\n    }\n  }\n\n  svg {\n    color: #B1BCCC;\n    font-size: 20px;\n    ", "\n\n    @media (min-width: 576px) {\n      ", "\n    }\n  }\n"])), function (_ref5) {
  var withIcon = _ref5.withIcon;
  return withIcon && (0, _styledComponents.css)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n    box-sizing: border-box;\n\n    &::before {\n      content: \"\";\n      position: absolute;\n      right: 5px;\n      top: 0;\n      bottom: 18px;\n      width: 15px;\n\n      ", "\n    }\n\n    @media (min-width: 576px) {\n      padding: 10px 25px;\n      margin-bottom: 27px;\n    }\n  "])), function (props) {
    var _props$theme;
...
var PaginationContainer = exports.PaginationContainer = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  align-self: flex-end;\n  width: 100%;\n  margin-bottom: 20px;\n"])));
var WrapperMap = exports.WrapperMap = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  width: 50%;\n  max-height: 2500px;\n  > div {\n    position: relative !important;\n    width: 100% !important;\n    height: 100% !important;\n  }\n  .btn-choose-store {\n    line-height: 30px;\n    padding: 0 10px;\n    font-size: 14px;\n    cursor: pointer;\n    outline: none;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    min-width: 80px;\n    height: 38px;\n    font-size: 14px;\n    background: ", ";\n    color: ", ";\n    border-color: ", ";\n  }\n\n  .btn-address-map {\n    cursor: pointer;\n    &:hover{\n      text-decoration: underline;\n    }\n  }\n  .className {\n    object-fit: none;\n  }\n"])), function (props) {
...
var CityContainer = exports.CityContainer = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  width: 100%;\n  padding: 20px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border-bottom: 1px solid ", ";;\n  height: 70px;\n  margin: 0;\n  box-sizing: border-box;\n\n  h3{\n    font-size: 16px;\n  }\n  ", "\n"])), function (_ref6) {
  var _theme$colors6;
  ...
  return isSelected && (0, _styledComponents.css)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n      \n  "])));
});
var LoadMoreButtonCityWrap = exports.LoadMoreButtonCityWrap = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  margin-top: 10px;\n  button {\n    width: 100%;\n  }\n"])));
var ViewLocations = exports.ViewLocations = _styledComponents.default.div(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  p {\n    color: ", ";\n    cursor: pointer;\n  }\n"])), function (_ref8) {
  var _theme$colors7;
  var theme = _ref8.theme;
  return theme === null || theme === void 0 || (_theme$colors7 = theme.colors) === null || _theme$colors7 === void 0 ? void 0 : _theme$colors7.primary;
});
var CitiesContainer = exports.CitiesContainer = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  border-radius: 7.6px;\n  box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.10);\n  > div {\n    cursor: pointer;\n  }\n  margin-bottom: 20px;\n"])));
var Separator = exports.Separator = _styledComponents.default.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  height: 1px;\n  margin-left: 20px;\n  margin-right: 40px;\n  background: #E9ECEF;\n  box-sizing: border-box;\n"])));