...
var BusinessesListingUI = function BusinessesListingUI(props) {
  var _businessesList$busin, _businessesList$busin3, _props$beforeElements, _props$beforeComponen, _theme$images, _theme$images$general, _configs$advanced_bus, _orderState$options2, _orderState$options2$, _configs$advanced_bus2, _orderState$options3, _orderState$options3$, _businessesList$busin4, _businessesList$busin5, _orderState$options6, _props$afterComponent, _props$afterElements;
