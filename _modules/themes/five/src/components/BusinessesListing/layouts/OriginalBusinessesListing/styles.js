...
var BusinessHeroImgStyled = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  margin-bottom: 30px;\n  width: 100%;\n  height: calc(65vh - 98px);\n\n  ", "\n  @media (min-width: 450px) {\n    height: 370px;\n  }\n\n  @media (min-width: 821px) {\n    height: ", ";\n    width: 75%;\n    ", "\n  }\n"])), function (_ref3) {
  ...
  return isFullScreen && (0, _styledComponents.css)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n      width: 100%;\n    "])));
});
...
var HightestRatedWrapper = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  padding: 50px 0 30px 0;\n"])));
exports.HightestRatedWrapper = HightestRatedWrapper;
var Divider = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  background: #F8F9FA;\n  height: 8px;\n  width: 100%;\n"])));
exports.Divider = Divider;
var OrderProgressWrapper = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  padding: 45px 20px;\n"])));
exports.OrderProgressWrapper = OrderProgressWrapper;
var SearchContainer = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n"])));
exports.SearchContainer = SearchContainer;
var BusinessCityList = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  \n"])));
...
var BusinessLogosContainer = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  display: flex;\n  overflow: auto;\n  padding-bottom: 10px;\n  span {\n    margin-right: 15px;\n  }\n  ::-webkit-scrollbar {\n    width: 6px;\n    height: 6px;\n  }\n"])));
