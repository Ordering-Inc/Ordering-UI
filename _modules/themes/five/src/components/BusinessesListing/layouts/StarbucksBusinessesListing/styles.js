...
var ListWrapper = exports.ListWrapper = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;  \n  min-height: 70vh;\n  overflow: auto;\n  box-shadow: 0 -2px 4px 0 rgb(0 0 0 / 12%);\n  @media(min-width: 850px){\n    width: 40vw;\n  }\n"])));
var MapWrapper = exports.MapWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  position: relative;\n  /* height: 100vh; */\n"])));
var BusinessFilter = exports.BusinessFilter = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;  \n  padding-left: 20px;\n  ", "\n"])), function (props) {
  var _props$theme2;
...
var AddressInput = exports.AddressInput = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  border: 1px solid #ccc;\n  padding: 10px 15px;\n  margin: 20px;\n  margin-bottom: 0;\n  border-radius: 7.6px;\n  cursor: pointer;\n  p{\n    margin: 0;\n    margin-left: 35px\n  }\n\n  svg {\n    position: absolute;\n    width: 24px;\n    height: 24px;\n  }\n"])));