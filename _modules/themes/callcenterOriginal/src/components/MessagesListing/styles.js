...
var OrderListItems = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  border: 1px solid rgb(233, 236, 239);\n  height: 100%;\n  margin-top: 20px;\n  overflow: hidden;\n\n  @media (min-width: 1024px) {\n    width: 330px;\n    max-width: 330px;\n    margin-top: 0px;\n    border-top: none;\n    border-bottom: none;\n  }\n\n  @media (min-width: 1300px){\n    max-width: 500px;\n    width: 500px;\n  }\n"])));
exports.OrderListItems = OrderListItems;
var MessageContainer = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  border: 1px solid rgb(233, 236, 239);\n  overflow: hidden;\n  margin-top: 20px;\n\n  @media (min-width: 1024px) {\n    margin-top: 0px;\n    height: 100%;\n    flex: 1 1 0%;\n    border-top: none;\n    border-bottom: none;\n    border-left: none;\n    ", "\n  }\n"])), function (props) {
  var _props$theme;
  return ((_props$theme = props.theme) === null || _props$theme === void 0 ? void 0 : _props$theme.rtl) && (0, _styledComponents.css)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n      border-right: none;\n    "])));
});
exports.MessageContainer = MessageContainer;
var ListHeader = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  height: 62px;\n  padding: 10px;\n  box-sizing: border-box;\n  border-bottom: 1px solid rgb(233, 236, 239);\n"])));
exports.ListHeader = ListHeader;
var OrdersOrderByOptionContainer = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  display: flex;\n  overflow-x: auto;\n"])));
exports.OrdersOrderByOptionContainer = OrdersOrderByOptionContainer;
var InnerTabsContainer = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  display: flex;\n\n  button {\n    font-size: 13px;\n    white-space: nowrap;\n    padding: 4px 10px;\n    line-height: 14px;\n    border-radius: 4px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme2;
...
exports.Title = Title;
var OrderListContainer = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  height: calc(100% - 63px);\n  /* border: 1px solid; */\n"])));
...
var OrderCard = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  position: relative;\n  cursor: pointer;\n  border-radius: 8px;\n  border: 1px solid ", ";\n  margin-bottom: 20px;\n  padding: 15px 20px;\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  ", "\n\n  p,\n  h2 {\n    color: ", ";\n    margin: 0px;\n  }\n  \n  h2 {\n    font-size: 16px;\n    font-weight: 600;\n  }\n"])), function (props) {
...
var OrderHeader = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  > div {\n    display: flex;\n    margin: 5px 0 10px;\n    > p {\n      font-size: 12px;\n    }\n  }\n\n  > p {\n    font-size: 14px;\n    margin-top: 5px;\n    color: ", ";\n  }\n"])), function (props) {
...
var CardContent = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  @media (min-width: 1300px) {\n    flex-direction: row;\n  }\n"])));
...
var UnreadMessageCounter = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 12px;\n  ", "\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: ", "20;\n  border-radius: 6px;\n  font-size: 12px;\n  height: 24px;\n  color: ", ";\n  padding: 0 10px;\n"])), function (props) {
  var _props$theme4;
...
exports.Image = Image;
var DriverSelectorWrapper = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  width: 100%;\n  box-sizing: border-box;\n  margin-top: 10px;\n  > div {\n    > div:first-child {\n      border: none;\n      padding: 0px;\n      > div:first-child {\n        padding: 0px\n      }\n    }\n  }\n\n  @media (min-width: 1300px) {\n    width: 55%;\n    margin-top: 0px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme5;
...
var LoadMoreButtonWrap = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  margin-bottom: 20px;\n   \n   button {\n     width: 100%;\n     padding: 5px;\n     background: ", " !important;\n     color: #fff\n   }\n"])), function (props) {
...
var DriverInfo = _styledComponents.default.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 10px;\n\n  @media (min-width: 1300px) {\n    margin-top: 0px;\n  }\n"])));
exports.DriverInfo = DriverInfo;
var OptionContent = _styledComponents.default.div(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  flex: 1;\n  display: flex;\n  align-items: center;\n   margin-left: 10px;\n\n"])));
exports.OptionContent = OptionContent;
var DriverNameContainer = _styledComponents.default.div(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  line-height: 1.3;\n  color: #263238;\n\n  ", "\n"])), function (_ref3) {
...
var DriverName = _styledComponents.default.p(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral(["\n  font-size: 14px;\n  font-weight: 500;\n  line-height: 1.3;\n  color: ", ";\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  max-width: 150px;\n  margin: 0px;\n\n  ", "\n\n  @media (max-width: 576px) {\n    max-width: 90px;\n  }\n"])), function (props) {
  return props.theme.colors.headingColor;
}, function (_ref4) {
...
var DriverText = _styledComponents.default.span(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  ", "\n"])), function (_ref5) {
...
var NotFoundSourceWrapper = _styledComponents.default.div(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["\n  display: flex;\n  height: 100%;\n"])));
