...
var HorizontalImage = exports.HorizontalImage = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  img {\n    border-radius: 7.6px;\n    min-width: 80px;\n    min-height: 80px;\n    width: 80px;\n    height: 80px;\n    margin-left: 10px;\n\n    ", "\n\n  }\n"])), function (props) {
  var _props$theme;
...
var HorizontalDetails = exports.HorizontalDetails = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  min-width: 100px;\n  position: relative;\n\n  > div {\n    line-height: 18px;\n  }\n\n  h3 {\n    font-weight: 500;\n    font-size: 12px;\n    color: ", ";\n    margin: 0;\n    display: -webkit-box;\n    -webkit-box-orient: vertical;\n    -webkit-line-clamp: 2;\n    overflow: hidden;\n  }\n\n  span {\n    font-size: 12px;\n    color: ", ";\n\n    &.discount {\n      font-size: 10px;\n      color: #909BA9;\n      ", "\n    }\n  }\n\n  button {\n    position: absolute;\n    bottom: 0px;\n    left: 0px;\n    margin-top: 3px;\n    border-radius: 50px;\n    font-size: 12px;\n    line-height: 20px;\n    padding-left: 10px;\n    padding-right: 10px;\n    color: ", ";\n    background: ", ";\n    border: none;\n    &:active {\n      color: white;\n    }\n  }\n"])), function (props) {
...
var WrapAutoScroll = exports.WrapAutoScroll = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  margin-top: 20px;\n  width: 100%;\n  overflow-x: auto;\n  display: flex;\n"])));
var UpsellingPageTitleWrapper = exports.UpsellingPageTitleWrapper = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  p {\n    font-weight: 500;\n    font-size: 16px;\n    color: ", ";\n  }\n\n  svg {\n    font-size: 20px;\n    cursor: pointer;\n    color: #748194;\n    margin-left: 30px;\n\n    ", "\n  }\n"])), function (props) {
  var _props$theme5;
