...
var BussinessAndDriverSignUp = exports.BussinessAndDriverSignUp = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex-direction: column;\n  width: 95%;\n\n  @media (min-width: 993px) {\n    flex-direction: row;\n  }\n\n  button {\n    width: 100%;\n    margin-top: 15px;\n    padding: 5px;\n\n    @media (min-width: 993px) {\n      width: 48%;\n    }\n  }\n"])));
var ButtonContainer = exports.ButtonContainer = _styledComponents.default.div(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  margin-top: 50px;\n\n  button{ \n    width: 100%;\n  }\n"])));