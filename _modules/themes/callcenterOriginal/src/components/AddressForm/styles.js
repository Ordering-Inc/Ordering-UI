...
var AddressTagSection = exports.AddressTagSection = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin: 10px 0px;\n  display: flex;\n  justify-content: space-between;\n\n  button {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    width: 46px;\n    height: 46px;\n    border: none;\n    color: #B1BCCC;\n\n    img {\n      width: 25px;\n      height: 25px;\n    }\n\n    span {\n      display: flex;\n      justify-content: center;\n      align-items: center;\n\n      svg {\n        font-size: 30px;\n      }\n    }\n  }\n\n  button.active {\n    color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
var WrapperMap = exports.WrapperMap = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  z-index: 100;\n  width: 48%;\n  position: absolute;\n  top: ", ";\n  right: 0;\n  padding-top: ", ";\n  padding-right: 20px;\n  height: ", ";\n\n  > div {\n    position: relative !important;\n    width: 100% !important;\n    height: 100% !important;\n    border-radius: 15px;\n  }\n"])), function (_ref) {
...
var WrapperSkeleton = exports.WrapperSkeleton = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  padding: 10px;\n\n  span {\n    width: 100%;\n  }\n"])));
var AddressMarkContainer = exports.AddressMarkContainer = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  background: #FFE69C;\n  border: 1px solid #FFF3CD;\n  display: flex;\n  padding: 8px;\n  justify-content: center;\n  align-items: center;\n  border-radius: 4px;\n  position: absolute;\n  top: 50px;\n  width: max-content;\n  p {\n    margin: 0;\n    color: #664D03;\n    font-size: 12px;\n  }\n\n  ", "\n"])), function (_ref3) {
  var blue = _ref3.blue;
  return blue && (0, _styledComponents.css)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n      background-color: #CFF4FC;\n      border: 1px solid #9EEAF9;\n      p {\n        color: #055160;\n      }\n  "])));
});
var StreetViewText = exports.StreetViewText = _styledComponents.default.span(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  position: absolute;\n  right: 35px;\n  top: 30px;\n  text-decoration: underline;\n  color: ", ";\n  z-index: 9999;\n  cursor: pointer;\n"])), function (_ref4) {
  var _theme$colors;
  var theme = _ref4.theme;
  return theme === null || theme === void 0 || (_theme$colors = theme.colors) === null || _theme$colors === void 0 ? void 0 : _theme$colors.primary;
});
var WithoutAddressContainer = exports.WithoutAddressContainer = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: center;\n  p {\n    margin-bottom: 0;\n  }\n"])));
var SmsClient = exports.SmsClient = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  position: relative;\n  top: 20px;\n  display: flex;\n  p{\n    margin: 0;\n    white-space: pre;\n  }\n"])));
var TabsContainer = exports.TabsContainer = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  position: absolute;\n  width: 50%;\n  top: 60px;\n  right: 0px;\n  padding-right: 20px;\n  z-index: 1000;\n  border-bottom: 1px solid #E9ECEF;\n\n"])));