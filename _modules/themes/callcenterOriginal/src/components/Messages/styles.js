...
var HeaderProfile = exports.HeaderProfile = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 15px 20px;\n  border-bottom: 1px solid #EEEEEE;\n  height: 70px;\n  box-sizing: border-box;\n\n  ", "\n\n  ", "\n\n  div {\n     p {\n       margin-left: 10px;\n       ", "\n      }\n     strong {\n      p{\n        margin-block-end: 0.1em;\n      }\n    }\n    p {\n      margin-block-start: 0.1em;\n      font-size: 0.7em\n    }\n  }\n"])), function (_ref2) {
...
var HeaderName = exports.HeaderName = _styledComponents.default.p(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  font-size: 1.1em;\n  margin-block-end: 0.1em;\n  margin-block-start: 0.1em;\n\n"])));
var Status = exports.Status = _styledComponents.default.p(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  margin-block-start: 0.1em;\n  margin-block-end: 0.1em;\n  font-size: 0.7em;\n"])));
var Image = exports.Image = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  width: 36px;\n  height: 36px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 7.6px;\n  padding: 5px;\n  box-sizing: border-box;\n  overflow: hidden;\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n\n  img {\n    width: 100%;\n    height: auto;\n    border-radius: 50%;\n    object-fit: cover;\n    border: 1px solid #F5F5F5;\n  }\n\n  img[name]{\n    border: 1px solid #D81212;\n    border-radius: 50%;\n  }\n\n  svg {\n    width: 36px;\n    height: 36px;\n  }\n"])));
var HeaderOnline = exports.HeaderOnline = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  height: 36px;\n  display: flex;\n  align-items: flex-start;\n  justify-content: center;\n  text-align: left;\n  margin-left: 10px;\n\n  ", "\n  h1,\n  span {\n    margin: 0px;\n  }\n\n  h1 {\n    font-weight: 600;\n    font-size: 14px;\n  }\n\n  span {\n    font-size: 10px;\n    font-weight: 300;\n  }\n"])), function (props) {
  var _props$theme3;
...
var Chat = exports.Chat = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: calc(100vh - 490px);\n  min-height: 400px;\n  flex-direction: column;\n  padding: 0 20px;\n  > :first-child{\n    margin-top: 10px;\n  }\n  @media (min-width: 769px){\n    height: calc(60vh - 90px);\n    ", ";\n  }\n"])), function (_ref4) {
...
var MessageConsole = exports.MessageConsole = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: inline-flex;\n  justify-content: center;\n  font-size: 0.8em;\n  border-radius: 60px;\n"])));
var MessageBusiness = exports.MessageBusiness = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n  font-size: 0.8em;\n"])));
var MessageCustomer = exports.MessageCustomer = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  flex-wrap: wrap;\n  font-size: 0.8em;\n"])));
var BubbleConsole = exports.BubbleConsole = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  border-radius: 5px;\n  padding: 5px 15px;\n  max-width: 40%;\n  margin-bottom: 15px;\n  background: #EFEFEF;\n  text-align: center;\n  height: auto;\n  overflow: hidden;\n  overflow-wrap: break-word;\n  @media (min-width: 1024px){\n    max-width: 30%\n  }\n"])));
var BubbleBusines = exports.BubbleBusines = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  border-radius: 7.6px 7.6px 7.6px 0px;\n  padding: 10px 25px 10px 25px;\n  max-width: 60%;\n  min-width: 80px;\n  margin-bottom: 10px;\n  background: #EFEFEF;\n  overflow: hidden;\n  overflow-wrap: break-word;\n  &[name=image]{\n    border-radius: 7.6px 7.6px 7.6px 0px;\n    width: 100%;\n  }\n\n  ", "\n\n  @media (min-width: 480px) {\n    border-radius: 7.6px 7.6px 7.6px 0px;\n\n    ", "\n  }\n\n  @media (min-width: 1024px){\n    max-width: 40%;\n  }\n"])), function (props) {
  var _props$theme4;
...
var BubbleCustomer = exports.BubbleCustomer = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  border-radius: 7.6px 7.6px 0px 7.6px;\n  padding: 10px 25px 10px 25px;\n  max-width: 60%;\n  min-width: 80px;\n  height: auto;\n  margin-bottom: 10px;\n  background: ", ";\n  color: white;\n  overflow-wrap: break-word;\n  overflow: hidden;\n\n  p:last-child {\n    left: 10px;\n  }\n\n  &[name=image]{\n    border-radius: 7.6px 7.6px 0px 7.6px;\n    width: 100%;\n  }\n\n  ", "\n  \n  @media (min-width: 480px){\n    border-radius: 7.6px 7.6px 0px 7.6px;\n\n    ", "\n  }\n\n  @media (min-width: 1024px){\n    max-width: 40%\n  }\n\n"])), function (props) {
  var _props$theme6;
...
var SkeletonBubbleCustomer = exports.SkeletonBubbleCustomer = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  span{\n    border-radius: 7.6px 7.6px 0px 7.6px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme9;
...
var SkeletonBubbleBusiness = exports.SkeletonBubbleBusiness = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  span{\n    border-radius: 7.6px 7.6px 7.6px 0px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme10;
...
var ChatImage = exports.ChatImage = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: auto;\n  margin-bottom: 10px;\n  img{\n    width: 100%;\n    height: auto;\n    max-height: 300px;\n    aspect-ratio: attr(width) / attr(height);\n    vertical-align: middle;\n    object-fit: contain;\n    cursor: pointer;\n  }\n"])));
var PartnerName = exports.PartnerName = _styledComponents.default.p(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  margin-block-start: 0;\n  margin-block-end: 0.6em;\n  font-size: 1.1em;\n"])));
var MyName = exports.MyName = _styledComponents.default.p(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n    margin-block-start: 0;\n    margin-block-end: 0.6em;\n    font-size: 1.1em;\n    text-align: right;\n\n    ", "\n"])), function (props) {
  var _props$theme11;
...
var TimeofSent = exports.TimeofSent = _styledComponents.default.p(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  position: relative;\n  text-align: right;\n  font-size: 0.8em;\n  margin-block-start: 0.2em;\n  margin-block-end: initial;\n\n  ", "\n"])), function (props) {
  var _props$theme12;
...
var TimeofSentByAdmin = exports.TimeofSentByAdmin = _styledComponents.default.p(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["\n    position: relative;\n  text-align: left;\n  font-size: 0.8em;\n  margin-block-start: 0.2em;\n  margin-block-end: initial;\n\n  ", "\n"])), function (props) {
  var _props$theme13;
...
var SendForm = exports.SendForm = _styledComponents.default.div(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  padding: 5px;\n  bottom: 0;\n  width: 100%;\n  box-sizing: border-box;\n  border-top: 1px solid #DEE2E6;\n\n  @media (min-width: 480px){\n    padding: 5px 20px;\n  }\n\n  @media (min-width: 769px) {\n    padding: 10px 20px;\n    position: sticky;\n    width: auto;\n    background-color: #F8F8F8 ;\n  }\n"])));
var Send = exports.Send = _styledComponents.default.form(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["\n  align-items: center;\n  display: flex;\n  margin-top: 3px;\n  height: auto;\n  width: 100%;\n  input {\n    padding-top: 13px;\n    padding-bottom: 13px;\n    width: 100%;\n    background: #F8F9FA;\n    border-radius: 7.6px;\n    border: none;\n    font-size: 12px;\n    box-sizing: border-box;\n    ", "\n  }\n"])), function (props) {
  var _props$theme14;
...
var SendImage = exports.SendImage = _styledComponents.default.label(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["\n  width: 15px;\n  height: 15px;\n  position: ", ";\n  opacity: ", ";\n  right: 16px;\n  top: 11px;\n\n  ", "\n\n  input {\n    display: none;\n  }\n\n\n\n  svg {\n    color: #CFD0D0;\n    width: 15px;\n    height: 15px;\n    cursor: pointer\n  }\n"])), function (props) {
...
var WrapperDeleteImage = exports.WrapperDeleteImage = _styledComponents.default.div(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["\n  width: 25px;\n  height: 25px;\n  position: absolute;\n  top: 9px;\n  ", "\n  > div {\n    position: relative;\n\n    img{\n      width: 25px;\n      height: 25px;\n      &:disabled {\n      cursor: not-allowed;\n      }\n      border-radius: 8px;\n    }\n\n    svg{\n      margin-bottom: 5px;\n      color: black;\n    }\n\n    button{\n      position: absolute;\n      background: white;\n      width: 18px;\n      height: 18px;\n      transform: translate(100%, -50%);\n    }\n  }\n\n"])), function (props) {
  var _props$theme16;
...
var WrapperSendMessageButton = exports.WrapperSendMessageButton = _styledComponents.default.div(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral(["\n  white-space: nowrap;\n  margin-left: 20px;\n  ", "\n\n  button{\n    padding-top: 6px;\n    padding-bottom: 6px;\n      svg {\n        display: inline;\n        width: 20px;\n        height: 20px; \n        vertical-align: middle;\n        color: white;\n        ", "\n    }\n\n    span {\n      display: none;\n    }\n\n    &:disabled {\n      opacity: 0.5;\n      cursor: not-allowed;\n    }\n  }\n\n  @media (min-width: 480px){\n    button{\n      svg {\n        display: none;\n      }\n      span {\n        display: inline;\n      }\n    }\n  }\n"])), function (props) {
  var _props$theme17;
...
var ImageContainer = exports.ImageContainer = _styledComponents.default.div(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral([" \n  max-height: 500px;\n  img{\n    width: 100%;\n    height: auto;\n    aspect-ratio: attr(width) / attr(height);\n    border-bottom-left-radius: 10px;\n    border-bottom-right-radius: 10px;\n  }\n"])));
var ModalIcon = exports.ModalIcon = _styledComponents.default.span(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["\n  display: flex;\n  position: absolute;\n  width: 30px;\n  height: 30px;\n  font-size: 30px;\n  cursor: pointer;\n  color: white;\n  border-radius: 50%;\n  right: 5px;\n  top: 5px;\n  z-index: 1;\n  background: rgba(0,0,0,0.3);\n  ", "\n  @media (min-width: 578px){\n    right: 10px;\n    ", "\n  }\n  @media (min-width: 769px){\n    right: 5px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme19;
...
var MessagesLayoutWrapper = exports.MessagesLayoutWrapper = _styledComponents.default.div(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["\n  display: flex;\n  border-left: 1px solid #DEE2E6;\n  border-right: 1px solid #DEE2E6;\n  position: relative;\n  flex-direction: column;\n\n  @media (min-width: 769px) {\n    flex-direction: row;\n  }\n"])));
var MessagesLeftLayout = exports.MessagesLeftLayout = _styledComponents.default.div(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["\n  width: 100%;\n  border-right: 1px solid #DEE2E6;\n  min-width: 250px;\n\n  ", "\n\n  @media (min-width: 769px) {\n    width: 30%;\n  }\n"])), function (props) {
  var _props$theme22;
...
var MessagesRightLayout = exports.MessagesRightLayout = _styledComponents.default.div(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n  width: 100%;\n  border-top: 1px solid #DEE2E6;\n  margin-top: 30px;\n  ", "\n\n  @media (min-width: 769px) {\n    width: 70%;\n    border: none;\n    margin-top: 0;\n    ", "\n  }\n"])), function (_ref5) {
...
var MessagesTitle = exports.MessagesTitle = _styledComponents.default.div(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid #DEE2E6;\n  padding: 15px 20px;\n  height: 70px;\n  box-sizing: border-box;\n\n  h1 {\n    font-weight: 600;\n    font-size: 20px;\n    color: ", ";\n    margin: 0;\n  }\n"])), function (props) {
  var _props$theme23;
  return (_props$theme23 = props.theme) === null || _props$theme23 === void 0 ? void 0 : _props$theme23.colors.headingColor;
});
var CustomerList = exports.CustomerList = _styledComponents.default.div(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral(["\n  > div {\n    border: none;\n  }\n"])));
var MessagesClose = exports.MessagesClose = _styledComponents.default.div(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  ", "\n  cursor: pointer;\n\n  svg {\n    font-size: 24px;\n  }\n"])), function (props) {
  var _props$theme24;
...
var InputWrapper = exports.InputWrapper = _styledComponents.default.div(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral(["\n  width: 60%;\n  flex: 1;\n  position: relative;\n"])));
var MessageContentWrapper = exports.MessageContentWrapper = _styledComponents.default.div(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral([""])));
var MessageCreatedDate = exports.MessageCreatedDate = _styledComponents.default.div(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-bottom: 12px;\n\n  span {\n    font-size: 12px;\n    color: ", "\n  }\n"])), function (props) {
  var _props$theme25;
  return (_props$theme25 = props.theme) === null || _props$theme25 === void 0 ? void 0 : _props$theme25.colors.darkGray;
});
var NotSendMessage = exports.NotSendMessage = (0, _styledComponents.default)(SendForm)(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n  width: 100%;\n  color: #909BA9;\n  background: #F8F9FA;\n\n  svg {\n    font-size: 20px;\n  }\n\n  p {\n    font-size: 14px;\n    color: #909BA9;\n    margin: 6px 0;\n  }\n"])));
...
var ProfileMessageHeader = exports.ProfileMessageHeader = _styledComponents.default.div(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  padding: 10px 15px;\n  border-bottom: 1px solid #EEEEEE;\n  height: 62px;\n  box-sizing: border-box;\n"])));
var MessagesTypes = exports.MessagesTypes = _styledComponents.default.div(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral(["\n  display: flex;\n"])));
var OrderData = exports.OrderData = _styledComponents.default.div(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  h2 {\n    margin: 0;\n    font-size: 14px;\n  }\n\n  p {\n    margin: 0;\n    font-size: 12px;\n    color: #344050;\n  }\n"])));
var MessageType = exports.MessageType = _styledComponents.default.div(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  box-sizing: border-box;\n  cursor: pointer;\n  >div {\n    margin-right: 5px;\n    box-shadow: none;\n  }\n\n  ", "\n"])), function (_ref7) {
