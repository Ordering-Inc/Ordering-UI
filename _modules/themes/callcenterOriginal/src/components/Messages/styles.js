...
var HeaderOnline = exports.HeaderOnline = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  height: 36px;\n  display: flex;\n  align-items: flex-start;\n  justify-content: center;\n  text-align: left;\n  margin-left: 10px;\n\n  ", "\n  h1,\n  span {\n    margin: 0px;\n  }\n\n  h1 {\n    font-weight: 600;\n    font-size: 14px;\n  }\n\n  span {\n    font-size: 10px;\n    font-weight: 300;\n  }\n"])), function (props) {
  var _props$theme3;
...
var Chat = exports.Chat = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: calc(100vh - 490px);\n  min-height: 400px;\n  flex-direction: column;\n  padding: 0 20px;\n  > :first-child{\n    margin-top: 10px;\n  }\n  @media (min-width: 769px){\n    height: calc(60vh - 90px);\n    ", ";\n  }\n"])), function (_ref4) {
  var profileMessages = _ref4.profileMessages;
  return profileMessages && (0, _styledComponents.css)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n      height: calc(100vh - 266px);\n    "])));
});
...
var SkeletonBubbleBusiness = exports.SkeletonBubbleBusiness = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  span{\n    border-radius: 7.6px 7.6px 7.6px 0px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme0;
  return ((_props$theme0 = props.theme) === null || _props$theme0 === void 0 ? void 0 : _props$theme0.rtl) && (0, _styledComponents.css)(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n    border-radius: 7.6px 7.6px 0px 7.6px;\n    "])));
});
...
var MyName = exports.MyName = _styledComponents.default.p(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n    margin-block-start: 0;\n    margin-block-end: 0.6em;\n    font-size: 1.1em;\n    text-align: right;\n\n    ", "\n"])), function (props) {
  var _props$theme1;
  return ((_props$theme1 = props.theme) === null || _props$theme1 === void 0 ? void 0 : _props$theme1.rtl) && (0, _styledComponents.css)(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n      text-align: left;\n  "])));
});
var TimeofSent = exports.TimeofSent = _styledComponents.default.p(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  position: relative;\n  text-align: right;\n  font-size: 0.8em;\n  margin-block-start: 0.2em;\n  margin-block-end: initial;\n\n  ", "\n"])), function (props) {
  var _props$theme10;
  return ((_props$theme10 = props.theme) === null || _props$theme10 === void 0 ? void 0 : _props$theme10.rtl) && (0, _styledComponents.css)(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n    text-align: left;\n  "])));
});
...
var SendImage = exports.SendImage = _styledComponents.default.label(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n  width: 15px;\n  height: 15px;\n  position: ", ";\n  opacity: ", ";\n  right: 16px;\n  top: 11px;\n\n  ", "\n\n  input {\n    display: none;\n  }\n\n\n\n  svg {\n    color: #CFD0D0;\n    width: 15px;\n    height: 15px;\n    cursor: pointer\n  }\n"])), function (props) {
  ...
  var _props$theme13;
  return ((_props$theme13 = props.theme) === null || _props$theme13 === void 0 ? void 0 : _props$theme13.rtl) && (0, _styledComponents.css)(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["\n    left: 16px;\n    right: initial;\n  "])));
});
var WrapperDeleteImage = exports.WrapperDeleteImage = _styledComponents.default.div(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["\n  width: 25px;\n  height: 25px;\n  position: absolute;\n  top: 9px;\n  ", "\n  > div {\n    position: relative;\n\n    img{\n      width: 25px;\n      height: 25px;\n      &:disabled {\n      cursor: not-allowed;\n      }\n      border-radius: 8px;\n    }\n\n    svg{\n      margin-bottom: 5px;\n      color: black;\n    }\n\n    button{\n      position: absolute;\n      background: white;\n      width: 18px;\n      height: 18px;\n      transform: translate(100%, -50%);\n    }\n  }\n\n"])), function (props) {
  var _props$theme14;
  return (_props$theme14 = props.theme) !== null && _props$theme14 !== void 0 && _props$theme14.rtl ? (0, _styledComponents.css)(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["\n    left: 12px;\n  "]))) : (0, _styledComponents.css)(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["\n    right: 12px;\n  "])));
});
var WrapperSendMessageButton = exports.WrapperSendMessageButton = _styledComponents.default.div(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["\n  white-space: nowrap;\n  margin-left: 20px;\n  ", "\n\n  button{\n    padding-top: 6px;\n    padding-bottom: 6px;\n      svg {\n        display: inline;\n        width: 20px;\n        height: 20px; \n        vertical-align: middle;\n        color: white;\n        ", "\n    }\n\n    span {\n      display: none;\n    }\n\n    &:disabled {\n      opacity: 0.5;\n      cursor: not-allowed;\n    }\n  }\n\n  @media (min-width: 480px){\n    button{\n      svg {\n        display: none;\n      }\n      span {\n        display: inline;\n      }\n    }\n  }\n"])), function (props) {
  ...
  var _props$theme16;
  return ((_props$theme16 = props.theme) === null || _props$theme16 === void 0 ? void 0 : _props$theme16.rtl) && (0, _styledComponents.css)(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral(["\n        transform: rotate(270deg);\n      "])));
});
...
var ModalIcon = exports.ModalIcon = _styledComponents.default.span(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n  display: flex;\n  position: absolute;\n  width: 30px;\n  height: 30px;\n  font-size: 30px;\n  cursor: pointer;\n  color: white;\n  border-radius: 50%;\n  right: 5px;\n  top: 5px;\n  z-index: 1;\n  background: rgba(0,0,0,0.3);\n  ", "\n  @media (min-width: 578px){\n    right: 10px;\n    ", "\n  }\n  @media (min-width: 769px){\n    right: 5px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme17;
  return ((_props$theme17 = props.theme) === null || _props$theme17 === void 0 ? void 0 : _props$theme17.rtl) && (0, _styledComponents.css)(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["\n    left: 5px;\n    right: initial;\n  "])));
}, function (props) {
  var _props$theme18;
  return ((_props$theme18 = props.theme) === null || _props$theme18 === void 0 ? void 0 : _props$theme18.rtl) && (0, _styledComponents.css)(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["\n    left: 10px;\n    right: initial;\n  "])));
}, function (props) {
  var _props$theme19;
...
var MessagesLeftLayout = exports.MessagesLeftLayout = _styledComponents.default.div(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["\n  width: 100%;\n  border-right: 1px solid #DEE2E6;\n  min-width: 250px;\n\n  ", "\n\n  @media (min-width: 769px) {\n    width: 30%;\n  }\n"])), function (props) {
  var _props$theme20;
  return ((_props$theme20 = props.theme) === null || _props$theme20 === void 0 ? void 0 : _props$theme20.rtl) && (0, _styledComponents.css)(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["\n    border-left: 1px solid #DEE2E6;\n    border-right: none;\n  "])));
});
var MessagesRightLayout = exports.MessagesRightLayout = _styledComponents.default.div(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["\n  width: 100%;\n  border-top: 1px solid #DEE2E6;\n  margin-top: 30px;\n  ", "\n\n  @media (min-width: 769px) {\n    width: 70%;\n    border: none;\n    margin-top: 0;\n    ", "\n  }\n"])), function (_ref5) {
  ...
  return profileMessages && (0, _styledComponents.css)(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n    margin-top: 0px;\n  "])));
}, function (_ref6) {
  var profileMessages = _ref6.profileMessages;
  return profileMessages && (0, _styledComponents.css)(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n      width: 100%;\n    "])));
});
var MessagesTitle = exports.MessagesTitle = _styledComponents.default.div(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid #DEE2E6;\n  padding: 15px 20px;\n  height: 70px;\n  box-sizing: border-box;\n\n  h1 {\n    font-weight: 600;\n    font-size: 20px;\n    color: ", ";\n    margin: 0;\n  }\n"])), function (props) {
  var _props$theme21;
  return (_props$theme21 = props.theme) === null || _props$theme21 === void 0 ? void 0 : _props$theme21.colors.headingColor;
});
var CustomerList = exports.CustomerList = _styledComponents.default.div(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n  > div {\n    border: none;\n  }\n"])));
var MessagesClose = exports.MessagesClose = _styledComponents.default.div(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  ", "\n  cursor: pointer;\n\n  svg {\n    font-size: 24px;\n  }\n"])), function (props) {
  var _props$theme22;
  return ((_props$theme22 = props.theme) === null || _props$theme22 === void 0 ? void 0 : _props$theme22.rtl) && (0, _styledComponents.css)(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral(["\n    left: 10px;\n    right: initial;\n  "])));
});
var InputWrapper = exports.InputWrapper = _styledComponents.default.div(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["\n  width: 60%;\n  flex: 1;\n  position: relative;\n"])));
var MessageContentWrapper = exports.MessageContentWrapper = _styledComponents.default.div(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral([""])));
var MessageCreatedDate = exports.MessageCreatedDate = _styledComponents.default.div(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-bottom: 12px;\n\n  span {\n    font-size: 12px;\n    color: ", "\n  }\n"])), function (props) {
  var _props$theme23;
  return (_props$theme23 = props.theme) === null || _props$theme23 === void 0 ? void 0 : _props$theme23.colors.darkGray;
});
var NotSendMessage = exports.NotSendMessage = (0, _styledComponents.default)(SendForm)(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n  width: 100%;\n  color: #909BA9;\n  background: #F8F9FA;\n\n  svg {\n    font-size: 20px;\n  }\n\n  p {\n    font-size: 14px;\n    color: #909BA9;\n    margin: 6px 0;\n  }\n"])));
var QuickMessageWrapper = exports.QuickMessageWrapper = _styledComponents.default.div(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n\n  button {\n    margin-bottom: 5px;\n    border-radius: 50px;\n    color: #414954;\n    background: #E9ECEF;\n    border: none;\n    margin-right: 12px;\n    font-size: 12px;\n    line-height: 25px;\n    padding: 0px 12px;\n    ", "\n\n    &:active {\n      background: ", ";\n    }\n  }\n"])), function (props) {
...
var ProfileMessageHeader = exports.ProfileMessageHeader = _styledComponents.default.div(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  padding: 10px 15px;\n  border-bottom: 1px solid #EEEEEE;\n  height: 62px;\n  box-sizing: border-box;\n"])));
var MessagesTypes = exports.MessagesTypes = _styledComponents.default.div(_templateObject68 || (_templateObject68 = _taggedTemplateLiteral(["\n  display: flex;\n"])));
var OrderData = exports.OrderData = _styledComponents.default.div(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  h2 {\n    margin: 0;\n    font-size: 14px;\n  }\n\n  p {\n    margin: 0;\n    font-size: 12px;\n    color: #344050;\n  }\n"])));
var MessageType = exports.MessageType = _styledComponents.default.div(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  box-sizing: border-box;\n  cursor: pointer;\n  >div {\n    margin-right: 5px;\n    box-shadow: none;\n  }\n\n  ", "\n"])), function (_ref7) {
  var active = _ref7.active;
  return active && (0, _styledComponents.css)(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral(["\n    >div {\n      box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;\n    }\n  "])));
});