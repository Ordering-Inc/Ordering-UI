...
var BusinessMenuListContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  margin-bottom: 35px;\n\n  > p {\n    font-weight: 600;\n    font-size: 20px;\n    margin-top: 0px;\n    margin-bottom: 13px;\n  }\n"])));
exports.BusinessMenuListContainer = BusinessMenuListContainer;
