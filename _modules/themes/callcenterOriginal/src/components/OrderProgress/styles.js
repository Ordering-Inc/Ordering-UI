...
var ProgressContentWrapper = exports.ProgressContentWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 12px;\n  background: #F8F9FA;\n"])));
...
var ProgressTextWrapper = exports.ProgressTextWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-top: 14px;\n"])));
var StatusWrapper = exports.StatusWrapper = _styledComponents.default.p(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  margin-top: 0px;\n  margin-bottom: 0px;\n  font-size: 14px;\n  margin-right: 10px;\n\n  ", "\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n    margin-right: 0px;\n    margin-left: 10px;\n  "])));
});
var TimeWrapper = exports.TimeWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  color: #909BA9;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: flex-end;\n  flex-direction: column;\n\n  @media (min-width: 576px) {\n    flex-direction: row;\n    font-size: 14px;\n  }\n"])));