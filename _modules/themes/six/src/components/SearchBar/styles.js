...
var BusinessSearch = exports.BusinessSearch = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: flex-end;\n  position: relative;\n\n  input {\n    width: 100%;\n    background-position: right 10px center;\n    background-repeat: no-repeat;\n    background-size: 15px;\n    box-sizing: border-box;\n    border:none;\n    border-bottom: 1px solid ", ";\n    border-radius: 0px;\n\n    ", "\n\n    ", "\n\n    ", "\n\n    @media (min-width: 681px) {\n      width: 100%;\n      ", "\n      ", "\n    }\n  }\n"])), function (props) {
  ...
  return (theme === null || theme === void 0 || (_theme$business_listi2 = theme.business_listing_view) === null || _theme$business_listi2 === void 0 || (_theme$business_listi2 = _theme$business_listi2.components) === null || _theme$business_listi2 === void 0 || (_theme$business_listi2 = _theme$business_listi2.layout) === null || _theme$business_listi2 === void 0 ? void 0 : _theme$business_listi2.type) === 'mapview' && (0, _styledComponents.css)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n      ", "\n    "])), disablePadding && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n        padding-left: 0;\n      "]))));
});
var DeleteContent = exports.DeleteContent = _styledComponents.default.span(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  position: absolute;\n  font-weight: 300;\n  padding: 10px 0;\n  color: #333;\n  font-size: 14px;\n  transform: translate(-30%, 0%);\n  border-radius: 25%;\n  max-height: 100%;\n  ", "\n  ", "\n  ", "\n  span{\n    cursor: pointer;\n  }\n  svg {\n    color: #ADB5BD;\n    width: 24px;\n    height: 24px;\n    position: relative;\n    bottom: 4px;\n  }\n  img{\n    width: 20px;\n    transform: translate(-25%, 0%);\n    ", "\n  }\n"])), function (_ref5) {
  var _theme$business_listi3;
  var theme = _ref5.theme,
    isHome = _ref5.isHome;
  return (theme === null || theme === void 0 || (_theme$business_listi3 = theme.business_listing_view) === null || _theme$business_listi3 === void 0 || (_theme$business_listi3 = _theme$business_listi3.components) === null || _theme$business_listi3 === void 0 || (_theme$business_listi3 = _theme$business_listi3.layout) === null || _theme$business_listi3 === void 0 ? void 0 : _theme$business_listi3.type) === 'mapview' && (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n    left: ", ";\n  "])), isHome ? '40px' : '30px');
}, function (_ref6) {
  var isClear = _ref6.isClear,
    isHome = _ref6.isHome;
  return isClear && (0, _styledComponents.css)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n    left: initial;\n    right: 40px;\n  "])));
}, function (props) {
  var _props$theme3;
...
var SearchWrapper = exports.SearchWrapper = (0, _styledComponents.default)(DeleteContent)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral([""])));
var FunnelWrapper = exports.FunnelWrapper = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  svg {\n    position: absolute;\n    right: 10px !important;\n    color: #ADB5BD;\n    width: 20px;\n    height: 20px;\n    bottom: 22px;\n  }\n"])));
var SearchIcon = exports.SearchIcon = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  background-image: url(", ");\n  background-position: right 10px center;\n  background-repeat: no-repeat;\n  background-size: 15px;\n  background-color: ", ";\n\n"])), function (props) {
  var _props$theme5;
