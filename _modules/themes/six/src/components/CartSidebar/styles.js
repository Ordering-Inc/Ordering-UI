...
var MenuClose = exports.MenuClose = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  border: 1px solid ", ";\n  border-radius: 100px;\n  display: flex;\n  align-items: center;\n  padding: 5px 10px;\n  color: ", ";\n  font-size: 16px;\n  svg {\n    font-size: 18px;\n    ", "\n  }\n"])), function (props) {
  return props.theme.colors.primary;
}, function (props) {
  return props.theme.colors.primary;
}, function (props) {
...
var CartContentWrapper = exports.CartContentWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 94%;\n  margin: 0 auto;\n"])));