...
var ProductQuantity = exports.ProductQuantity = _styledComponents.default.span(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  display: inline-block !important;\n  margin-right: 5px !important; \n  font-size: 1.1rem;\n  color: #585858;\n"])));
var CartActions = exports.CartActions = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 10px;\n  width: 100%;\n  .disabled {\n    pointer-events: none;\n    color: ", ";\n  }\n  .incdec-control {\n    display: flex;\n    align-items: center;\n    color: #6C757D;\n    margin-right: 20px;\n    margin-bottom: 5px;\n    ", "\n    svg {\n      font-size: 20px;\n      cursor: pointer;\n    }\n    span {\n      margin: 0 8px;\n      font-size: 22px;\n      line-height: 24px;\n    }\n  }\n\n  @media (min-width: 411px) {\n    width: calc(100% - 120px);\n    margin-left: auto;\n    margin-right: 0px;\n    ", "\n  }\n\n  @media (min-width: 1024px) {\n    width: calc(100% - 145px);\n  }\n"])), function (props) {
