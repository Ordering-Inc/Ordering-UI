...
var Slogan = exports.Slogan = _styledComponents.default.p(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  margin: 0px;\n  text-align: left;\n  font-size: 16px;\n  @media (min-width: 576px) {\n    font-size: 18px;\n    text-align: center;\n  }\n  @media (min-width: 1200px) {\n    font-size: 22px;\n  }\n"])));
var InputSpan = exports.InputSpan = _styledComponents.default.span(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  background: #FFF;\n  color: #010300;\n  border: 1px solid #DBDCDB;\n  border-radius: 30px;\n  font-size: 16px;\n  padding: 7px 50%;\n  outline: none;\n  color: #FFF;\n  border-color: #FFF;\n  cursor: pointer;\n  background: rgba(0,0,0,0.1);\n"])));
var OrderTypes = exports.OrderTypes = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  display: flex;\n  background-color: #fff;\n  padding: 30px 0;\n  @media (min-width: 768px) {\n    padding: 45px;\n  }\n  @media (min-width: 1200px) {\n    padding: 75px;\n  }\n  @media (min-width: 1405px) {\n    padding: 90px;\n  }\n"])));