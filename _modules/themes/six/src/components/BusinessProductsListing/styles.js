...
var WrapProductsCategroy = exports.WrapProductsCategroy = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  \n"])));
var WrapBusinessList = exports.WrapBusinessList = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 100%;\n\n  @media (min-width: 1024px) {\n    &.right-list-panel {\n      padding-left: 25px;\n    }\n  } \n\n  @media (min-width: 1405px) {\n    &.right-list-panel {\n      padding-left: 45px;\n    }\n  } \n  \n"])));
var ProductDetail = exports.ProductDetail = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  position: relative;\n  display: flex;\n  width: 100%;\n  height: 100%;  \n"])));
var BackMenu = exports.BackMenu = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  position: absolute;\n  width: 30px;\n  height: 30px;\n  top: 15px;\n  right: 10px;\n  z-index: 10;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border-radius: 100px;\n  cursor: pointer;  \n  svg {    \n    font-size: 1.5rem;\n  }\n\n  @media (min-width: 768px) {\n    right: 25px;\n    ", "\n\n  }\n\n  @media (min-width: 1024px) {\n    right: unset;\n    left: calc(40% - 45px);\n    ", "\n  }\n\n  @media (min-width: 1200px) {\n    right: unset;\n    left: calc(40% - 50px);\n    ", "\n  }\n\n  @media (min-width: 1440px) {\n    right: unset;\n    left: calc(40% - 60px);\n    ", "\n  }\n"])), function (props) {
  var _props$theme3;
