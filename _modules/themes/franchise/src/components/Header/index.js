...
var Header = exports.Header = function Header(props) {
  var _configState$configs, _customerState$user, _orderState$options3, _props$beforeElements, _props$beforeComponen, _theme$images, _theme$images2, _theme$images3, _orderState$options5, _configState$configs2, _configState$configs3, _orderState$options6, _orderState$options7, _configState$configs4, _theme$defaultLanguag2, _theme$defaultLanguag3, _orderState$options8, _orderState$options9, _configState$configs5, _configState$configs6, _orderState$options0, _orderState$options1, _configState$configs7, _configState$configs8, _orderState$options10, _customerState$user2, _customerState$user3, _theme$defaultLanguag4, _theme$defaultLanguag5, _theme$defaultLanguag6, _theme$defaultLanguag7, _theme$defaultLanguag8, _theme$defaultLanguag9, _props$afterComponent, _props$afterElements;
  ...
  var _useState9 = (0, _react.useState)(false),
    ...
    authModalOpen = _useState0[0],
    setAuthModalOpen = _useState0[1];
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (_props$beforeElements = props.beforeElements) === null || _props$beforeElements === void 0 ? void 0 : _props$beforeElements.map(function (BeforeElement, i) {
    ...
    variant: "address",
    addressState: orderState === null || orderState === void 0 || (_orderState$options0 = orderState.options) === null || _orderState$options0 === void 0 || (_orderState$options0 = _orderState$options0.address) === null || _orderState$options0 === void 0 || (_orderState$options0 = _orderState$options0.address) === null || _orderState$options0 === void 0 || (_orderState$options0 = _orderState$options0.split(',')) === null || _orderState$options0 === void 0 ? void 0 : _orderState$options0[0],
    onClick: function onClick(variant) {
      return openModal(variant);
    }
  }), !isCustomerMode && /*#__PURE__*/_react.default.createElement(_HeaderOption.HeaderOption, {
    variant: "moment",
    momentState: orderState === null || orderState === void 0 || (_orderState$options1 = orderState.options) === null || _orderState$options1 === void 0 ? void 0 : _orderState$options1.moment,
