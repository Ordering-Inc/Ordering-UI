...
var BusinessesTitle = exports.BusinessesTitle = _styledComponents.default.h1(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  font-size: 18px;\n  margin: 0px 20px;\n"])));
var PreviousButtonWrapper = exports.PreviousButtonWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: center;\n  margin-top: 10px;\n  margin-bottom: 20px;\n  button{\n    width: 100%;\n  }\n\n  @media(min-width: 681px){\n      button{\n      width: 80%;\n    }\n  }\n"])));