...
var ReviewsMarkPoint = exports.ReviewsMarkPoint = _styledComponents.default.span(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 15px;\n  font-size: 12px;\n  color: #CED4DA;\n  cursor: pointer;\n\n  ", "\n"])), function (_ref) {
...
var CommentsList = exports.CommentsList = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  p {\n    margin-top: 0;\n    margin-bottom: 10px;\n    font-size: 14px;\n    color: ", ";\n  }\n\n  button {\n    border-radius: 50px;\n    margin-bottom: 10px;\n    margin-right: 4px;\n    font-size: 13px;\n    padding: 2px 10px;\n  \n    ", "\n\n    svg {\n      vertical-align: middle;\n      margin-left: 5px;\n\n      ", "\n    }\n\n    @media (min-width: 768px){\n      margin-bottom: 18px;\n      margin-right: 40px;\n      font-size: 16px;\n      padding: 2px 15px;\n    }\n  }\n"])), function (props) {
  var _props$theme5;
