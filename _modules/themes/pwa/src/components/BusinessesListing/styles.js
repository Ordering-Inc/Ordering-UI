...
var BusinessHeroImgStyled = exports.BusinessHeroImgStyled = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  height: auto;\n  width: 100%;\n  height: calc(65vh - 98px);\n\n  ", "\n\n  @media (min-width: 821px) {\n    height: 500px;\n  }\n"])), function (_ref2) {
  ...
  return bgimage && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n    background-repeat: no-repeat, repeat;\n    background-size: cover;\n    object-fit: cover;\n    background-position: center;\n  "])));
});
...
var BusinessFeatures = exports.BusinessFeatures = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 10%;\n  width: 100%;\n  padding: 0 15px;\n  box-sizing: border-box;\n"])));
var AddressMenu = exports.AddressMenu = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  font-size: 14px;\n  display: flex;\n  align-items: center;\n  background-color: #fff;\n  color: #344050;\n  font-weight: 600;\n  border-radius: 50px;\n  padding: 13px 19px;\n  margin-bottom: 10px;\n  svg {\n    margin-right: 5px;\n    color: #B1BCCC;\n    ", "\n  }\n"])), function (props) {
  var _props$theme2;
...
var FeatureItems = exports.FeatureItems = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n"])));
var ItemInline = exports.ItemInline = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  > span #select-input {\n    background-color: #F8F9FA !important;\n    border: none;\n    border-radius: 7.6px;\n    svg {\n      font-size: 14px;\n    }\n    #list {\n      background-color: #fff;\n      border: none;\n      border-radius: 7.6px;\n\n      left: 0px;\n      right: initial;\n\n      ", "\n    }\n\n    > div:first-child {\n      font-size: 11px;\n    }\n  }\n\n  .moment-popover {\n    > div:first-child {\n      font-size: 11px;\n      padding: 4px 7px;\n      svg {\n        font-size: 14px;\n      }\n    }\n  }\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n        left: initial;\n        right: 0px;\n      "])));
});
var BusinessSearch = exports.BusinessSearch = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n    display: flex;\n    background-color: #f8f9fa;\n    align-items: center;\n    padding: 7px;\n    border-radius: 7px;\n    font-size: 11px;\n    svg {\n      font-size: 15px;\n    }\n"])));
var BusinessItemsWrapper = exports.BusinessItemsWrapper = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  width: 100%;\n  box-sizing: border-box;\n"])));
var BusineessItems = exports.BusineessItems = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  margin-top: 10px;\n"])));
var BusinessItem = exports.BusinessItem = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  margin-bottom: 15px;\n"])));
...
var BusinessMeta = exports.BusinessMeta = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  display: flex;\n  margin-top: 5px;\n  width: 100%;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  p {\n    margin: 0;\n    font-size: 12px;\n    svg {\n      font-size: 8px;\n      margin: 0 3px;\n    }\n  }\n"])));
var SearchTitle = exports.SearchTitle = _styledComponents.default.h1(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  text-align: center;\n  font-weight: 600;\n  font-size: 24px;\n  margin-top: -5px;\n  margin-bottom: 15px;\n"])));