...
var OrderTypeTitle = exports.OrderTypeTitle = _styledComponents.default.h2(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  font-weight: 600;\n  font-size: 16px;\n  color: #FFFFFF;\n  margin-top: 0;\n  margin-bottom: 5px;\n"])));
var OrderTypeDescription = exports.OrderTypeDescription = _styledComponents.default.p(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  font-size: 13px;\n  color: #FFFFFF;\n  margin-top: 0;\n  margin-bottom: 5px;\n  @media (min-width: 576px) {\n    margin-bottom: 20px;\n    font-size: 14px;\n  }\n"])));
var OrderStartWrapper = exports.OrderStartWrapper = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  user-select: none;\n  cursor: pointer;\n  font-size: 13px;\n\n  span {\n    color: #FFFFFF;\n    ", "\n  }\n\n  svg {\n    font-size: 16px;\n    color: #FFFFFF;\n  }\n\n  @media (min-width: 576px) {\n    font-size: 14px;\n  }\n"])), function (props) {
  var _props$theme;
...
var OrderTypeListTitle = exports.OrderTypeListTitle = _styledComponents.default.h1(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  text-align: center;\n  font-weight: 600;\n  font-size: 15px;\n  line-height: 21px;\n  line-height: 21px;\n  color: ", ";\n  margin: 0 0 30px;\n\n  @media (min-width: 576px) {\n    padding-left: 30px;\n    font-size: 20px;\n    ", "\n  }\n\n  @media (min-width: 768px) {\n    font-size: 24px;\n  }\n    \n"])), function (props) {
