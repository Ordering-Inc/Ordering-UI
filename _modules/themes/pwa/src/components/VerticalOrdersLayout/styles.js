...
var Floting = exports.Floting = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  display: flex;\n  flex: 1;\n  flex-direction: column;\n  justify-content: space-between;\n  height: 64px;\n  ", "\n\n button {\n  background: ", ";\n  border: none;\n  border-radius: 50px;\n  font-size: 10px;\n  line-height: 15px;\n  padding: 4px 8px;\n  color: ", ";\n  &.review {\n    background: transparent;\n    border: 1px solid ", ";\n  }\n }\n"])), function (props) {
  var _props$theme2;
...
var OrderPrice = exports.OrderPrice = _styledComponents.default.p(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  margin: 0;\n  font-size: 12px;\n  line-height: 18px;\n  color: #344050;\n"])));