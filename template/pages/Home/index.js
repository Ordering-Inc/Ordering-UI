...
import { HomeHero } from '../../../src/themes/starbucks/src/components/HomeHero'
...
export const HomePage = (props) => {
  ...
  const getPage = async () => {
    ...
    try {
      ...
      const { content: { error, result } } = await ordering.pages('starbuckSHomeContent').get({ cancelToken: source })
