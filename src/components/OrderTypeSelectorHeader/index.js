...
export const OrderTypeSelectorHeader = (props) => {
  ...
  const orderTypeProps = {
    ...
    orderTypes: props.orderTypes || [
      ...
      {
        value: 5,
        content: <Option><FaCarSide className='order-type-icon' /><ContentOption>{t('DRIVE_THRU', 'Drive thru')}</ContentOption></Option>,
        showOnSelected: <Option><FaCarSide className='order-type-icon' /><SelectedOption>{t('DRIVE_THRU', 'Drive thru')}</SelectedOption></Option>
      }
    ]
  }
