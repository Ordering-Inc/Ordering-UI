...
import { VaXMiCuentaContainer, ProductContainer } from './styles'
  ...
  return (
    <VaXMiCuentaContainer>
      <div>
        ...
        <p>{t('VA_POR_MI_CUENTA','VA_POR_MI_CUENTA')} <a href="{t('VA_POR_MI_CUENTA_, URL','VA_POR_MI_CUENTA')}" target="_blank"> {t('VA_POR_MI_CUENTA_URL_NAME','VA_POR_MI_CUENTA_URL_NAME')}</a></p>
        <div>
