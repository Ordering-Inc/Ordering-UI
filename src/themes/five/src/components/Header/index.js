...
import { useSession, useLanguage, useOrder, useEvent, useConfig, useCustomer, useUtils, useDefaultTheme } from 'ordering-components'
      ...
      <HeaderContainer>
        <InnerHeader>
          <LeftHeader id='left-side'>
            ...
            >
              <img alt='Logotype' width='170px' height='45px' src={orderingTheme?.images?.components?.logo?.components?.image || theme?.images?.logos?.logotype} loading='lazy' />
              <img alt='Isotype' width='35px' height='45px' src={orderingTheme?.images?.components?.logo?.components?.image || (isHome ? theme?.images?.logos?.isotypeInvert : theme?.images?.logos?.isotype)} loading='lazy' />
            </LogoHeader>
          </LeftHeader>
