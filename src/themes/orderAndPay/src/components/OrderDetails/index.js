...
const OrderDetailsUI = (props) => {
  ...
  return (
    <>
      ...
      <Container>
        <ModalIcon>
          <BsArrowLeft size={20} onClick={() => handleRedirect('ordertypes')} color={theme.colors.arrowColor} />
          <ActionsBlock>
