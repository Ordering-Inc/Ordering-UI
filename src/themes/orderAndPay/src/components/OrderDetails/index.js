...
const OrderDetailsUI = (props) => {
  ...
  return (
    <>
      ...
      <Container>
        <ModalIcon>
          <BsArrowLeft size={20} onClick={() => handleRedirect('ordertypes')} />
          <ActionsBlock>
            <MessagesIcon onClick={() => handleOpenMessages({ driver: false, business: true })}>
              ...
              <IconsContainer>
                <svg onClick={() => handleRedirect('orders')} width='24' height='24' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
